...
export class GoblinScene extends BaseContent {
    ...
    public goblinRapesPlayer(): void {
        ...
        if (
            ...
            if (this.player.hasVagina()) {
                ...
                this.outx(
                    `Your body is already hot and your [nipples] harden involuntarily in response to the tiny slut's totally understandable display of desire. Your [vagina] leaks enough girl-juice to form a puddle beneath you, doing its best to show your fellow slut how ready you are. You 'subtly' (at least in your little mind) push your chest forward, making your [nipples] easy targets for the goblin. She grabs hold of your breasts`,
                );
                // --[If nipplecunts]
                ...
                this.outx(
                    `Your green slut counterpart stands up and steps over your crotch, positioning herself perpendicular to you. The warm wetness of her dripping cunt splashes your thighs when she works the free end of the double-dong into her own slick twat. Your pussy squelches against hers wetly as they meet in the middle, your [clit] pressed on by her nether lips. The goblin twists, grinding and scissoring her thighs, the hard bud of her clit rubbing against your [clit] again and again.\n\n`,
                    false,
                );
        ...
        this.outx(
            `Your [nipples] poke upwards, giving the goblin easy targets.  She grabs hold of them `,
        );
        if (this.player.hasFuckableNipples())
            this.outx(
        ...
        if (
            ...
            if (this.player.cockArea(0) > this.monster.vaginalCapacity()) {
                ...
                if (this.player.hasVagina()) this.outx(`caressing your [clit]`);
            ...
            // [DICK FITS]
                ...
                this.outx(
                    `The goblin-girl doesn't waste time with any more foreplay, she just arches her back like a cat about to get the cream, and slides her plush ass towards your [cock] with deliberate slowness.  Her eyes watch you with an intent expression as the slightly parted lips of her sex brush against your `,
                );
                ...
                if (this.player.balls > 0)
                    this.outx(
                        `cup your [balls] in one hand, squeezing gently as the drug begins to affect them`,
                    );
                else
                    this.outx(
    ...
    private gobboButtSecks(): void {
        ...
        this.outx(
            `As you pick up your [armor] and begin to get dressed, you glance at the goblin. Her hands began to dig in her now stretched out anus, desperately trying to gather up the cum you deposited in her. Smirking, you walk away nonchalantly, quite pleased with yourself.`,
        );
        this.cleanupAfterCombat();
        this.player.orgasm();
    }
    ...
    private rapeAGoblinCorruptTooBig(): void {
        ...
        if (this.player.cockTotal() > 2)
            this.outx(
                `Your remaining [cocks] blast geysers into the air, coating you both in your spunk. `,
            );
        if (this.player.cockTotal() == 2)
            this.outx(
