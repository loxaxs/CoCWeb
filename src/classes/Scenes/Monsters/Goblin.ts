...
export class Goblin extends Monster {
    protected goblinDrugAttack(): void {
        ...
        // Drink blue pots
            ...
            if (this.short == "Tamani's daughters") {
                this.outx("Tamani pulls out a blue vial and uncaps it, then douses the mob with the contents.");
                if (this.HPRatio() < 1) {
                    this.outx("  Though less effective than ingesting it, the potion looks to have helped the goblins recover from their wounds!\n");
                    this.addHP(80);
    ...
    protected goblinTeaseAttack(): void {
        ...
        this.outx("  The display distracts you long enough to prevent you from taking advantage of her awkward pose, leaving you more than a little flushed.\n\n");
        this.combatRoundOver();
    }
    ...
    public won(hpVictory: boolean, pcCameWorms: boolean): void {
        if (this.player.gender == 0) {
            this.outx("You collapse in front of the goblin, too wounded to fight.  She giggles and takes out a tube of lipstick smearing it whorishly on your face.  You pass into unconsciousness immediately.  It must have been drugged.");
