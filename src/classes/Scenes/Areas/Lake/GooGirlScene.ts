...
export class GooGirlScene extends AbstractLakeContent {
    ...
    public encounterGooGirl(): void {
        ...
        this.outx("As you walk around the lake, you notice a pale red light pulsing in the ");
    ...
    private genderlessLoseToGooGal(): void {
        this.outx("", true);
        this.outx(
            `You stumble, nearly falling to your knees and the slime recognizes her victory with a smile that nearly bisects her face. Clapping her hands in a wet splash, she oozes up to you and wraps her dripping, puddle-like lower body around yours, quickly stripping your [armor] off. There's no strength left in your limbs to resist, the goo-girl's insistent tugging guides you into the lapping waves of the lake. The cool water eases the excited heat of the girl's slimy embrace and you barely notice the depth until she's dragged you up to your chin. A surge of panic thrills up your spine, but she seems comfortable enough here, so she halts to investigate her prize.\n\n`,
            false,
        );
    ...
    private hermLoseToGooGal(): void {
        ...
        this.outx(
            ` in rippling walls of needy slime. Coils of hot and cold run up and down your ${this.cockDescript(
                x,
            )}, as playful tongues part your labia and trace every petal-like fold of your [vagina], filling you to your brim with gooey, thirsty ooze.\n\n`,
            false,
        );
    ...
    private femaleLoseToGooGal(): void {
        this.outx("", true);
        this.outx(
            `You sway, finding it difficult to maintain your balance. When you fall, your [butt] splashes wetly in the enveloping folds of the goo-girl's eager slime. You weakly hold your hand up to keep her back, but the wide-eyed victor disregards the gesture with playful disdain. She slithers against you, moist muck slurping at your flesh with a hungry heat. Her semi-solid hands take yours, pulling your arms apart to bare your chest. She cranes her dripping head around your shoulders, skillfully removing your [armor] with only her mouth. Your [chest] heave as the irrepressible heat of the slime sears your [nipples] until beads of sweat well up on your [skin] and trickle down your curves, leaving a wet sheen over your body.\n\n`,
            false,
        );
        ...
        if (this.player.pregnancyIncubation <= 280 && this.player.pregnancyIncubation >= 1) {
            this.outx(
                `The fluid woman squeezes her goopy breasts against yours and the globes jiggle with their liquid weight. The ${this.gooColor()} girl wriggles against you with an ecstatic expression, delighting in the quivering vibrations of your body. She presses her palms to your breasts and the warm goo engulfs your [nipple] with a wet plop. She plays with your tits, rolling them in her hands while the slurping goop of her body sucks at your swollen mammaries. She bends down to pepper your pulsing tit-flesh with tiny, moist kisses that leave ${this.gooColor()} lip prints on your [skin]. Rocking her body against yours, the girl's expression mimicks the helpless, agonized bliss of your face, her cheeks even flushing indigo to imitate your blush. She darts in and gives you a deep, full-bodied kiss of pregnant joy and your ${this.player.allBreastsDescript()} burst with creamy milk, even as your climax leaves your body as quivering as the goo-girl's. Feeding on your sexual release, she arches her back and her hearts flicker wildly, her body losing some of its focus as it appears to melt under her orgasmic heat.\n\n`,
                false,
            );
    ...
    private gooMaleRape(type = 1): void {
        ...
        if (this.player.cocks[x].cockLength < 24) {
            ...
            this.outx(
                `Noticing your hardening length, the goo-girl claps her hands in gushing pleasure and gently pushes you back onto your [butt]. Rubbing her moist cheek against yours, she slides down your [chest] and perches over your groin. Slowly, she moves back and forth, stroking your shaft with the perky wetness of her stiff nipples. She hovers over your manhood for a moment before dropping down, her sloping cleavage stroking your cock between her slimy pillows with a slurping squelch. Pressing her balled-up fists to either side, she squeezes your ${this.cockDescript(
                    x,
    ...
    private victoryHermSex(): void {
        ...
        this.outx(
            `Quickly stripping, you let your [cocks] slap against her turbulent membrane, the warm muck gurgling wetly at your turgid stiffness. Sinking your fingers into the girl's yielding breasts, you push forward, pulsing flesh sliding into the ${this.gooColor2()} depths of her expanded cleavage. The goo-girl's chest sucks eagerly at you, pliant slime drooling warm ${this.gooColor5()} beads of unnecessary lubrication as you pick up your pace. Staring at your [cocks] moving in and out of the girl's chest through her transparent skin, you are surprised to see her body shifting further under your pounding. A vertical slit opens between her breasts and her membrane quickly folds itself in delicate petals around the edges. Your next thrust pushes into the new cavity and the organic texture confirms your suspicion: she's created a vagina between her breasts for you to fuck!\n\n`,
            false,
        );
