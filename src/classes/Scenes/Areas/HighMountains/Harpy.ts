...
export class Harpy extends Monster {
    ...
    protected harpyUberCharge(): void {
        ...
        if (this.findStatusAffect(StatusAffects.Uber) < 0) {
            ...
            this.outx("Flapping her wings frantically, she flies away from you and gains height, hanging in the light before you.  She lets out a shrill and terrifying cry, narrowing her eyes as she focuses in on you!");
        }
    ...
    protected outputPlayerDodged(dodge: number): void {
        this.outx("With another deranged cry the harpy dives at you, swinging her razor-sharp talons through the air with the grace of a ballerina. Your quick reflexes allow you to dodge every vicious slash she makes at you.\n");
    }
