...
export class MinotaurMobScene extends BaseContent implements TimeAwareInterface {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00325] == 1) {
            ...
            if (!this.player.minotaurAddicted()) {
                ...
                if (this.player.cor < 33)
                    ...
                    this.outx("indulged yourself in their glorious cum more than a few times");
                else
                    this.outx("never felt like turning down a fuck from one of these glorious cum-dispensing fuck-beasts");
                this.outx(", these brutes will find you no easy prey.  Trembling slightly from the adrenaline now coursing through your veins, you hold fast, but they merely stare at you, not even brandishing weapons.  Irritated, you bark out a challenge, hoping to goad them into making a foolish mistake.\n\n");
                ...
                this.outx("the minotaurs you've birthed match these minotaurs' coats perfectly – these bull-men must be your progeny, all grown up.  The small one haltingly asks, \"<i>S-since she looks brain dead... will you guys let me use her cunt this time?  I never get to have any pussy!</i>\"\n\n");

                this.outx("You can't help but laugh with a mixture of maternal pride and rational worry.  What do your offspring have planned for you?  Judging by the three stiffening loincloths, they won't hold back much longer.  What will you do?");
            ...
            // (Addicted)
                ...
                this.outx("The next largest sibling smirks and remarks, \"<i>You would think she'd at least know her children when she met them.  Maybe she's craving cum too much to remember how to talk?  Is that what it is?  Is Mommy a cum-craving whore?</i>\"\n\n");

                this.outx("You gape, the desire to satiate your cravings replaced momentarily by the raw shock of the realization.\n\n");

                this.outx("Now that you look at think about it, however, the fur patterns of these minotaurs <b>do</b> match ");
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] > 3) this.outx("some of ");
                this.outx("those of your offspring perfectly... these minotaurs must be your progeny, all grown up.  The small one asks, \"<i>S-since she's already so cum-crazy, can I use her cunt this time?  She's probably all worn out from birthing us, so I bet it's her worst hole.  You guys don't mind, right?</i>\"\n\n");

                this.outx("Judging by the three stiffening loincloths and subsequent moistening of bulges, you'll have a very hard time turning down their offer.  ");
                if (this.player.cor < 33)
                    this.outx("You wouldn't fuck your own offspring just for another hit of cum... would you?");
                else if (this.player.cor < 66)
                    this.outx("You're not sure how to feel about this morally, but you can't keep from licking your lips, fantasizing about the fix these wonderful kids of yours are so willing to give you.");
                else
                    this.outx("Who cares if they're your offspring?  They're all grown up and they smell so... appetizing.");
                // [Fight] [Submit] [Run]
                this.simpleChoices(
                    "Fight",
                    this.fightOTaurs,
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] < 20) {
                ...
                if (!this.player.minotaurAddicted()) {
                    ...
                    if (
                        ...
                        this.outx("Pregnant with another brother for us, and already you come back for more?");
                    else if (
                        this.player.pregnancyIncubation > 0 &&
                        this.player.pregnancyIncubation <= 216
                    )
                        this.outx("Huh... Looks like Mommy couldn't keep her legs closed, and she got knocked up by some vermin.  You're such a disappointment to your beloved family.  Don't worry, though, mom, we'll still fuck you.");
                    else
                        this.outx("Hey mom, come back so we could all have another whack at you?  We could use another brother.");
                    this.outx('</i>"\n\n', false);

                    this.outx("\"<i>Nah, she's just back to finish getting addicted, aren't you mother-dear?  You came back to visit your sons and guzzle our cum until you're scooping the dregs of it from your ");
                    if (
                        this.player.pregnancyIncubation == 0 ||
                        this.player.pregnancyIncubation > 216
                    )
                    ...
                    this.outx("The runt of the litter lurks in the back, stroking himself while whining and plaintively muttering for his turn.  It would be pathetic if you couldn't smell the pre-cum he's dripping from all the way over here.\n\n");
                ...
                // [Addicted Repeat]
                    ...
                    this.outx("  You absentmindedly tweak your nipple and lick your lips in anticipation.\n\n");
                    ...
                    if (
                        ...
                        this.outx("Pregnant with another brother for us, and you're already back for another fix?  Why even leave in the first place?");
                    else if (
                        this.player.pregnancyIncubation > 0 &&
                        this.player.pregnancyIncubation <= 216
                    )
                        this.outx("Huh... you couldn't keep your legs closed, eh, mom?  Looks like you're all knocked up with vermin, too!  You're a disappointment to our family... don't worry, though, we'll still give you a fix.");
                    else
                        this.outx("Hey, mom!  You come back so we could have another go at knocking you up?  Heh.  Knowing you, you're probably just here for another cum fix.");
                    this.outx('</i>"\n\n', false);
                    ...
                    this.outx("The runt of the litter, the 'minitaur', lurks in the back of the group, stroking himself and protesting timidly about how it was 'his turn'.  He leans around his two giant brothers and whines, \"<i>Mom, can I use your pussy?  I'm sooo pent-up and my ass is still sore from big bro!</i>\"\n\n");

                    if (this.player.minotaurNeed()) {
                        this.outx("Your mind is already fogging under the intense need of your addiction, and you do the only thing a junkie like you can do in this situation – drop down on all fours and get ready to be used.");
                        // Same as 'submit'
                        this.doNext(this.submitToMinotaurMob);
                        return;
                    }
                    this.outx("Your mind is fogging from the scent in the air, but thankfully, you aren't in withdrawal right now.  You can try to resist and maybe even turn the tables on your brood, or you can run.");
                }
                // [Fight] [Submit] [Run]
                this.simpleChoices(
                    "Fight",
            ...
            // Tribe sized
                ...
                if (!this.player.minotaurAddicted()) {
                    ...
                    if (
                        ...
                        this.outx("Come back to see some real studs after letting a weakling knock you up?");
                    this.outx("</i>\"  Your cheeks color from the lewd suggestions, his words bringing up the pleasurable memories of the numerous, cunt-filling minotaur-breedings you've been subjected to.\n\n");
                    ...
                    this.outx("  Many of the loincloths are wet, practically dripping with the minotaurs' copious pre-cum.  You can see the curves and swells of their huge, bloated balls - it looks like some of these poor guys have saved up quite a big load for you.  A fantasy of losing yourself in a sea of minotaur spooge crosses your mind...\n\n");

                    this.outx("No! ");
                    if (this.player.cor < 33)
                        this.outx("You can't think that way! Sure, you've birthed minotaurs enough to create this huge tribe of horny monsters, but you're a champion!");
                    else if (this.player.cor < 66)
                        this.outx("You shouldn't think that way! Sure, you've had enough minotaurs inside you to spawn this tribe of muscular beast-men, but you've got a mission to focus on.");
                    else
                        this.outx("You shouldn't think that way! There's a whole bevy of other creatures out there waiting to be fucked over, and if your boys want a piece of you, they're the ones who should be kneeling down and getting ready to be fucked!");
                    this.outx("  What do you do?");
                }
                // [Repeat Tribe-Size Addict]
                    ...
                    if (
                        ...
                        this.outx("Come for a baby? Or do you just want to be spunk-stuffed?");
                    else if (this.player.pregnancyType == PregnancyStore.PREGNANCY_MINOTAUR)
                        this.outx("Come back for some more spunk? I bet your next son comes out as a spooge-slurping minitaur.  We could use another cock-sleeve around here.");
                    else
                        this.outx("Come back to see some real studs after letting a weakling knock you up?  Don't fret, we'll make you forget all about it.");
                    this.outx(
                    ...
                    this.outx("Many of the loincloths are likewise stained, practically dripping with the minotaur's copious pre-loads.  You can see the curve and swell of their huge, bloated balls.  It looks like some of these poor guys have saved up quite a big load for you.  You fantazise about being afloat in an ocean of minotaur spooge...Yes!  ");
                    if (this.player.minotaurNeed()) {
                        this.outx("This is perfect... you need it so bad!  You drop down on all fours and wiggle your child-bearing hips, hoping they'll hurry and cum inside you.");
                        // SUBMIT!
                        this.doNext(this.submitToMinotaurMob);
                        return;
                    }
                    this.outx("This is glorious – so many horny, willing boys, all here for you to squeeze dry.  Even if you wanted to leave, you'd have to fight them to make an opening.  It'd be better to just beat them into submission and take your time savoring their wondrous spunk.");
                }
                // [Fight] [Submit]
                this.simpleChoices(
                    "Fight",
    ...
    private negotiate(): void {
        this.outx("", true);
        this.spriteSelect(94);
        this.outx("You calm down and warn them that you're no pushover, and you will defend yourself if necessary.  Your outburst shocks them, and they even seem a bit worried by your confidence and poise.\n\n");

        this.outx("The second largest smirks and retorts, \"<i>Chill out, Mom... it'll be fine.  I know what your problem is.  You just haven't had enough cum yet... trust me, you'll love it!  Once we've each blown a few loads in your holes, you won't be able to get enough!  Promise!!</i>\"\n\n");
        ...
        this.outx("The meek, quiet 'minitaur' speaks last. \"<i>P-Please mom?  I've never cum in a real pussy before...</i>\"\n\n");
    ...
    public minotaurDeFeet(): void {
        ...
        // (Lust)
            ...
            this.outx("The beast-men remove their terribly-tended loincloths and discard them, though one smears his over your face before he tosses it aside, the musky aroma sending your body into overdrive.\n\n");
        }
    ...
    private nonAddictMinotaurGangBang(): void {
        this.spriteSelect(94);
        this.outx("The minotaurs step closer, their hooves kicking up small clouds of dust as they approach your prone body.  You lift your head, nose twitching, and breathe their scent deeply while casting a coy look at the closest of the mob.  He smiles and squeezes his fingers around your jaw, pulling your mouth into a pouty 'o'.  His other hand holds the heavy mass of his stiff maleness - a turgid, flared shaft over two feet long with three prominent ridges along its length.  You shiver and lick your lips unconsciously, tasting the sweet smell of his pre in the air as it inches closer.\n\n");

        if (this.player.isTaur()) {
            this.outx("A sudden, forceful push rolls your equine body onto its flank, and a larger member is pressed against your clutching ");
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] >= 10)
            this.outx("The assembled beasts snicker at the noise, stroking themselves slowly while awaiting a chance at your hungry holes.");
        else
            this.outx("The minitaur giggles at the noise, stroking himself and mewling while he waits permission to join.");
        this.outx("  You can do naught but gurgle as the dual minotaur dicks each push deeper and completely, utterly spit-roasting you on their incestuous hardnesses.\n\n");
        ...
        this.outx("Your bovine masters begin to saw their throbbing members back and forth with long, orifice-scraping strokes.  It should be painful, but it only stirs the coals of your aphrodisiac-fueled fire. Your pussy ");
        if (this.player.wetness() >= 5)
            this.outx("gushes everywhere with each thrust, puddling your lubricants on the ground");
        else if (this.player.wetness() >= 3)
            this.outx("drools a thick stream of lubricants to puddle on the ground with each thrust.");
        else
            this.outx("drips lubricant with every thrust, leaving tiny blotches of wetness on the ground.");
        this.outx("  Bouncing between them like a child's ball, your body is battered, abused, and used for nothing more than a few minute's pleasure.  Every time the throat-obstructing mass pulls from your mouth you take another deep breath, staying conscious, but becoming more aroused by the omnipresent stench of the horny beasts.\n\n");

        this.outx("The minotaur occupying your mouth grabs hold of your ");
        if (this.player.horns > 0) this.outx("horns ");
        else this.outx("head ");
        this.outx("and roughly buries his cock in your mouth, all the way to the hilt.  His pre-cum stops, and the balls on your chin begin to bounce as the beast's animalistic, three-ribbed member starts to widen inside you.  Your jaw stretches slightly, and you feel a huge wad of cum distend the urethra along the bottom of his shaft.  Working towards your belly, the mass bursts from his tip explosively, making your gut gurgle audibly as it receives its first injection of minotaur spunk.\n\n");

        this.outx("Expanding in the moment of penultimate pleasure, the minotaur's tip flares wide, effectively sealing your esophagus shut.  The furry sack bobs on your chin, the heavy balls inside slowly shrinking as they empty their lust-inducing, thought-removing cargo into your deepest recesses");
        if (this.player.cor >= 66) this.outx(".  You couldn't be happier about it");
        this.outx(".   The bulges of cum squeezing past your thrashing, excited tongue slowly grow smaller and smaller as the spoogey goodness is inexorably emptied from the poor, pumped-up testes on your chin.  They give a tiny shudder and stop, and the minotaur pulls back at last, slowly softening to ease his passage from your abused throat hole.\n\n");
        ...
        this.outx(" as he laughs, \"<i>You can have Mom's backdoor.  I went ahead and opened it for you.</i>\"  A crestfallen look spreads over the minitaur's face, but it doesn't stop him for walking up behind you to line his smaller shaft up with your gaping, sloppy asshole.\n\n");

        this.outx("The rock-solid mass of muscle holding you aloft softens, and your body weight drags you down.  Your juicy twat and abused anus throb, impaled on your own offspring's penises.  ");
        this.player.cuntChange(60, true, false, true);
        this.outx("They part your flesh with ease, sheathing themselves deeply in your body and rubbing against each other through the narrow divide inside you.  Your asshole tingles, actually finding more pleasure from the act than your suddenly-stretched vagina thanks to the more comfortable pole residing in its depths.  They go deeper and deeper, until the stud supporting you is pushing on your distended cervix while his sheath bunches up against your outer lips.\n\n");
        ...
        if (this.player.pregnancyIncubation == 0 || this.player.pregnancyIncubation > 216)
            ...
            this.outx("I hope you come back after you pop out this vermin so we can give you a real baby!");
        this.outx(
        ...
        this.outx("You black out at that point, but when you wake up soaked in cum with a bottle of it next to you, you know it was a good night.");
    ...
    private loseToMinoMobVeryPregnant(): void {
        ...
        if (this.player.pregnancyType != PregnancyStore.PREGNANCY_MINOTAUR)
            this.outx("She doesn't know how to keep her hungry twat closed.  You can see the vermin squirming in her belly.  Disgusting.");
        else this.outx("I can feel our little brother.  It won't be long now.");
        this.outx("  Since your womb is full you'll have to take care of us with your other holes.  ...Don't look at me like that Mom - it's not my fault you're such a slut.</i>\"\n\n");
        ...
        if (
            ...
            this.outx("  Even your tail reaches up to curl around a third, stroking the thick meat.");
        this.outx("\n\n");
        ...
        this.outx("\"<i>Gods and Demons Mom, you're such a slut.  Look at you, knocked up and pregnant, nipples ready to spew milk, and you're covered in one of your sons' cum while you suck off the next.  You greedy fuck-slut.  ");
        if (this.player.pregnancyType == PregnancyStore.PREGNANCY_MINOTAUR)
            this.outx("That baby is probably mine too.  You let your son father his brother.");
        else
            this.outx("That baby isn't even the right species.  You probably get knocked up by every male you meet, but you always come back to suck off your sons.");
        this.outx("  How does that make you feel, whore?</i>\" asks the mouth-filling dick's owner.\n\n");
        ...
        this.outx(" and pulls you back, your tongue dragging over the underside of his shaft.  Then, with an abrupt shift, he plunges back in.  Once he bottoms out, he once more reverses direction - never stopping, never slowing.  He face-fucks you hard and fast while your ass is repeatedly smacked.");
        this.outx("\n\n");
        ...
        // (Long)
            ...
            this.outx("  Look at her, she's smiling with a dick in her mouth while she passes out.  Mom's the best.</i>\"");
        }
        this.player.orgasm();
        this.dynStats("spe", -0.5, "int", -0.5, "lib", 0.5, "sen", 0.5, "cor", 1);
        this.player.slimeFeed();
    ...
    private analSpearSemiPregMinotaurGangbang(): void {
        ...
        this.outx("  Soon, the turgid length of his horse-like cock is prodding your pregnant tummy, lubing it with narcotic spooge that you find yourself wishing was in your mouth or pussy.\n\n");

        this.outx("A nervous voice interrupts the brute's groping.  \"<i>Umm, g-g-guys... we should be careful with her.  You guys want ");
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] >= 20)
        ...
        if (!this.player.minotaurAddicted())
            this.outx("We've got to get mom so high on us that she'll float back to her camp and come crawling back to us tomorrow.");
        ...
        if (this.player.hasFuckableNipples()) {
            ...
            this.outx("Unfortunately, you're not the only one who can hear his rapt praise now.  The beast railing your mouth looks down and meets the eyes of the minitaur just as his head lolls back in pleasure.  Your eyes roll when you feel his cock jam further into your nipple as he starts in panic, but his big brother just ");
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] < 7)
                this.outx("shakes his head.  \"<i>You're only saving up trouble for later, little cunt.  Your hole after Mom's, remember.</i>\"  The minitaur wistfully withdraws his cock and crawls a few paces off, where he sits in a sulk.");
            else
                this.outx("nods his head toward one of the idle members of the tribe, who pulls the runt out of your nipplehole with a 'pop' and carries him off, the line of horny minotaurs parting and then forming up again after he passes.  From behind them you can hear squeals of agony and then ecstasy as your smallest son joins you in your state of overfucked, drugged euphoria.");
            this.outx("\n\n");
        }
        ...
        if (this.player.biggestTitSize() >= 3 && this.player.biggestLactation() >= 1)
            ...
            this.outx(", your hard, aching nipples sucked and licked as they sway beneath you");
        this.outx(
        ...
        this.outx(".  It feels so good that you start to shake and spasm, cumming and clenching from the spunky injection.\n\n");
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] >= 5)
            this.outx(", but you're positioned with your ass in the air.  A voice calls out, \"<i>Okay, Mom's pretty out of it.  One at a time and don't damage her, okay?</i>\"\n\nGiggling dreamily, you're fucked repeatedly, spunk squirting from your anus with every thrust.  You pass out like that, feeling quite satisfied.");
        else
            this.outx(".  They step back and admire their handiwork while you float through your narcotic-infused haze.");
        this.player.orgasm();
        this.dynStats("spe", -0.5, "int", -0.5, "lib", 0.5, "sen", 0.5, "cor", 1);
        this.player.slimeFeed();
        this.player.minoCumAddiction(15);
    ...
    private victoryMinotaurGangTitFuck(): void {
        ...
        if (this.player.minotaurAddicted())
            this.outx("Of course it helps that pleasing them will give you exactly what you want - more of that delicious, wondrous cock-cream.  ");
        this.outx("\"<i>Fantastic.  You're good boys, I know you are.  Now come over here.  Yes, you too - all of you come to mommy.  I'm going to punish the lot of you.</i>\"\n\n");
        ...
        this.outx("There isn't even time to recover.  Before the first stud finishes soaking you, the second explodes into your neck.  Runnels of goo wash down the curvature of your mammaries, soaking you down to the abdomen in a creamy, seemingly endless cataract of spooge.  From time to time you lean down and lap at the fountaining spunk, eyes crossed from your slowly dimming mental capacity.  Nevertheless, you manage to keep your hands busy bouncing your tits up and down to prolong the cum-fountains. It isn't until the soft members are pulled from your motherly embrace that you realize they finished cumming moments ago.\n\n");

        this.outx("You lick at your lips and sway on your feet, feeling positively out-of-your-mind with artificial happiness.  ");
        // (FORK: Small or large)
        // (LARGE)
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] >= 10) {
            this.outx(
            ...
            this.outx("\"<i>Good boys.  Now give Mommy more cum... she's ");
            if (
        ...
        // (SMALL)
            ...
            this.outx(" left for you to milk.  You remember you were punishing them, and with your drug-dulled mind, you're determined to finish it.  The fact that the act you're about to engage in is the farthest thing possible from punishment does not disturb your serene concentration in the slightest.  ");
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] == 3)
                this.outx("You grab the minitaur's cock and drag the shy beast-man over your cum-slicked tits, wasting no time in burying the shaft in mommy's mammaries, where it belongs.");
            else {
                this.outx("You grab the minitaur and ");
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] == 4)
                    this.outx("the remaining brother");
                else this.outx("one of the remaining brothers");
                this.outx(", pulling them hard towards your cum-slicked tits.  You waste no time burying their twin members in the cum-slicked crevasse that is their mommy's mammaries, right where they belong.");
            }
            this.outx("  \"<i>Good boys.  Now give Mommy more cum... she's ");
            if (
                this.player.findPerk(PerkLib.BimboBrains) >= 0 ||
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] > 3)
                this.outx("His glaze spurts up along the opening created by his larger brother's shaft, and soon he too is cumming, obediently orgasming for you.  ");
            this.outx(
            ...
            if (!this.player.minotaurAddicted())
                this.outx("Maybe we can get Mom completely hooked.  Then we won't have to fight her?");
            else
                this.outx("That'll be a nice snack for her later.  We wouldn't want her to lose control around lesser species.");
            this.outx('</i>"\n\n', false);

            this.outx("You gather up a few more mouthfuls to swallow before stumbling to your feet.  There's a soup of semen swimming around your brain making it difficult to think, let alone walk!  Absentmindedly, you pick up the cum-filled jar.  You wouldn't want to forget that.  ");
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] < 5)
                this.outx("The minotaurs let you get dressed while they sigh happily, clearly pleased with the outcome.");
            else {
                this.outx("Before you get far, a strong arm grabs you.  Oh yeah... another son that needs punished.  You sink to your knees and tend to him");
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] > 5) {
                ...
                this.outx(" by the time you manage to leave.  You nearly forget your equipment, but grab it at the last second.");
            }
        }
        // Force cum bottle loot!
        this.flags[kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.MINOCUM.id;
    ...
    private victoryAllThePenetrationsMinotaurGangBang(): void {
        ...
        if (this.monster.lust > 99)
            this.outx(" nearly instantly, too aroused to turn down the idea of their mother doing ANYTHING with their hard shafts.");
        else
            this.outx(" somewhat sluggishly as they work to get nude for you, despite their wounds.  As they finish, they start to move a bit faster, recovering from the battle quicker than you would have thought.");
        this.outx("  You saunter over to the closest cock and admire the twitching hardness of it, caressing the somewhat equine shaft with gentle touches as you position yourself squarely above it.\n\n");

        this.outx("It prods at your vulva as you sink down, smearing your outer lips with fragrant minotaur 'honey'.  The flared tip barely gains any traction at the gateway to your love canal.  You reach down and pull yourself wide, opening up as much as possible for your offspring's wonderful cock.  ");
        ...
        this.outx("  It pulsates wetly inside you with each beat of the minotaur's hammering heart.");
        ...
        this.outx("  Balls gently come to rest against your taint.  You relish the feeling of being so exquisitely stuffed, those thick, ribbed shafts rubbing against each other through your holes, but something's missing.");
        this.player.buttChange(60, true, true, false);
        this.outx("\n\n");
        ...
        if (this.player.hasFuckableNipples() && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] > 4) {
            ...
            this.outx(" your tits, slipping a few digits in to explore the depths of your chest-pussies.  ");
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] == 4)
                this.outx("He licks his fingers clean, and a moment later, a cock is spearing one of your nipples, disappearing deep into the tingling passages concealed within your chest.\n\n");
            else
                this.outx("They lick their fingers clean, and a moment later, cocks are spearing your nipples, disappearing deep into the tingling passages concealed within your chest.\n\n");
        }
        // Dicks)
        if (this.player.hasCock())
            this.outx(
        ...
        this.outx("That's more like it - now that you're completely impaled in every way, the real fun can start!  You increase the speed of your body's movements, reveling in the absolute dominance and control you hold over your drug-dispensing offspring.  They leak and dribble as you fuck them hard and fast, occasionally reaching out to slap or spank one of them when they start to move.  You ride them like a set of living dildos, squelching noisily from every hole as you leak lube, spit, and pre-cum in equal measure. It's so hot and nasty");
        if (this.player.cor < 33)
            this.outx(" that you cringe a little when you realize you're having an incestuous orgy, but the rising tide of minotaur-drug in your bloodstream washes the errant thought away.");
        else
            this.outx(" that you can barely hang on to your sanity, but it feels like all the minotaur-drug leaking into your bloodstream might wash away even that.");
        this.outx("\n\n");

        this.outx("You hum in pleasure around the mass of meat in your mouth as the complete penetration of your body pushes you past your endurance and into the realm of bliss.  The hum rises in pitch and volume, turning into a squealing moan of pleasure.  Your body shakes, your pussy clenches, ");
        if (this.player.hasFuckableNipples() && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] > 4)
            this.outx("your nipples squirt, ");
        this.outx("and your ass squeezes down on the minotaur penis inside it all at once.  Overwhelmed by their slutty mother's thrashing form and constricting holes, ");
        this.outx("your sons grab you and take control, fucking you wildly.  You bounce around like a child's toy, utterly at the mercy of your muscular offspring.\n\n");
        ...
        this.outx("incredible force.  You can feel the four balls behind you shrinking as their cargo empties into your pussy and ass, stuffing your hind-end.\n\n");
        ...
        if (this.player.hasFuckableNipples() && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] > 4) {
            ...
            this.outx(", bloating your breasts up a whole bra-size from the cum injection.  ");
        }
        this.outx("All of them pull out at once, leaving you to rub your distended belly and moan.  The ");
        ...
        this.outx("You wobble a little, but you manage to make it up.  The defeated minotaurs titter at their handiwork, now dripping from every hole on your body.  You put an end to that by cracking your knuckles and glaring at them with an expression of absolute brutality.  The beast-men turn tail and flee, not daring to risk their mother's wrath.  Once they've gone, you collapse into the cummy mud-puddle you've made underneath yourself and giggle madly!  What silly fools you have for sons!\n\n");

        this.outx("After getting dressed, you idly scoop a handful of cum from your sodden box and devour it - the perfect snack for the long walk home.");
    ...
    private forceMinitaurToGiveOral(choice = 0): void {
        ...
        this.outx("The tiny, feminine beast-man looks up at you hopefully.  You crush his hopes by telling him to crawl to you.  If he wanted your pussy, he could have done better by asking.  Running around with that band of brutes didn't score him any points in your book, and you make a point of telling him so.  He whines, \"<i>I-I don't have a choice Mom!  They bully me and make me suck them off all the time.  And if we can't find someone to fuck, I end up having to t-take it in my butt.  It hurt at first... but now I get antsy when they don't let me suck them off every few hours.</i>\"\n\n");

        this.outx("The pathetic minitaur is hopelessly addicted to his brothers' cum.  You shrug, tired of his bitching and wanting the satisfaction you so desperately crave.  \"<i>Whining about your problems won't make them go away.  Now put that mouth to use and ");
        // (FORK BETWEEN CUNT/DICK VARIATIONS)
        // (CUNTPUSSIEFUCKER)
        if (choice == 0) {
            this.outx("start licking Momma's pussy.</i>\"  As if to emphasize your point, you ");
            if (this.player.isTaur()) {
                this.outx("turn ");
            ...
            if (this.player.isTaur())
                this.outx("disappearing under your hind-legs as he attends to his newly commanded duty.");
            else
                this.outx("looking up at you longingly as he leans in towards your entrance.");
            this.outx("  He opens his mouth and hesitantly extends his tongue towards your womanhood.  It's clear he doesn't have much experience providing oral to the fairer sex.  Since you don't have much intention of staying in the mountains long, you grab him by his short little horns and pull him against your gash.\n\n");
            ...
            if (this.player.clitLength < 3)
                this.outx(", even sucking your clit into his mouth and running his tongue along its length.");
            ...
            if (this.player.clitLength >= 6)
                this.outx("He jacks your huge clit like a cock, and the incredible stimulation is too much for you to take.");
            else
                this.outx("He sucks and licks your pussy and clit simultaneously, displaying hidden talent with his bovine tongue.  It's just too much for you to take!");
            this.outx("  You cum - hard, into the cow-boy's muzzle.  He laps at your juices enthusiastically - a natural born cunt-licker.");
            if (this.player.wetness() >= 5)
                this.outx("  The wave of squirting fluids drips from his shaggy chin and runs down his chest.");
            else if (this.player.wetness() >= 4)
                this.outx("  The stream of dribbling fluids drips from his shaggy chin to run down his chest.");
            else if (this.player.wetness() >= 3)
                this.outx("  The dribbling fluid runs down his shaggy chin and drips towards the ground.");
            else if (this.player.wetness() >= 2)
                this.outx("  Some of the fluids escape his mouth to run down his shaggy chin.");
            else
                this.outx("  All of your moistness is collected on his tongue and sucked into his mouth.");
            this.outx("  Your quivering cunt tries to milk the poor boy's tongue like a cock, actually pulling him harder against your fem-cum-slicked nether-lips while you climax.");
            if (this.player.hasCock())
                this.outx(
        ...
        // (PENISCOCKSUCKERFUCK)
            ...
            this.outx(" before his eyes, and the minotaur licks his lips reflexively, clearly enjoying the thought of fellating you.\n\n");
            ...
            this.outx("His circling, wiggling tongue slides up and down your length as he sucks on the tip, giving you a wondrous tongue-fuck");
            ...
            this.outx(".");
            if (this.player.hasVagina())
                this.outx("  You begin to cum into your son's mouth, your pussy hugging his finger tightly inside its depths.");
            this.outx("\n\n");

            this.outx("Your jism ");
            if (this.player.cumQ() < 100)
                this.outx("squirts into his mouth repeatedly, puddling on his tongue before he noisily swallows it.");
            else if (this.player.cumQ() <= 250)
                this.outx("squirts into his mouth over and over, puddling on his tongue and forcing his cheeks to bulge slightly before he swallows.");
            else if (this.player.cumQ() <= 1000)
                this.outx("spurts into his mouth, filling it with the first burst alone.  He swallows it just in time for the next, and he gulps noisily to keep up with your orgasm.");
            else {
                this.outx("blasts into his mouth and dribbles from the corners of his lips as his throat noisily attempts to gulp down the huge semen-flow.");
                if (this.player.cumQ() >= 2000)
                    this.outx("  Spunk runs from his nostrils as he utterly fails.");
            }
            this.outx("  He pulls back before you finish and lets the last few waves of semen of take him in the face.");
            ...
            this.outx("  The minitaur actually looks kind of cute with spooge puddled on his nose.\n\n");
        }
    ...
    private victoryBJNippleFuckMinotaurGang(): void {
        ...
        this.outx("\"<i>Because, dear boy, I needed to show you rebellious fools who's in charge around here.  Now that you've been put in your place, it's time you gave Mom a little sugar,</i>\" you explain as you wiggle seductively.\n\n");
        ...
        this.outx("  The pair look at you with ravenous eyes as you continue to toy with the nipple openings, slowly stretching them as they get wetter and wetter.\n\n");
        ...
        this.outx("The sensation of those hot minotaur pricks stuffing your nipples as wide as a well-fucked pussy is heavenly.  You rock in place from the sloppy, pre-spurting penetration, watching ");
        ...
        this.outx(" of the nearly-equine cocks disappear inside you with rapt fascination.  The thick, hot members pulsate inside the bottom of your tits and nearly knock you to the ground from the pleasure.  You grab your boys' balls in that moment, squeezing them softly to egg them on.  In response, the minotaurs both pull their cocks back, dragging their flares back out of your jugs before they penetrate you all over again.\n\n");

        this.outx("You moan like a slut and caress your sons' gargantuan testes, loving every moment of it.  To your surprise, the two happily rutting minotaurs are parted by a third shaggy form.  The minitaur emerges from between them");
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] >= 7)
        ...
        this.outx("You stand up straight and stretch, cum pouring from your nipples.  The assembled minotaurs ");
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00326] < 5)
            this.outx("relax and fan themselves while giving you lusty looks");
        else
            this.outx("stare gloomily at the lucky three before turning to regard your form again with unrepentant lust");
        this.outx(
    ...
    private minotaurGangBadEnd(): void {
        ...
        if (this.player.hasFuckableNipples())
            this.outx("slide inside your nipple-cunts and finger your chest pussies in a small approximation of what's happening below.");
        else if (this.player.biggestLactation() >= 1)
            this.outx("tug and pull at your drippy nipples, releasing thick flows of creamy milk.");
    ...
    private minotaurGangBadEnd2(): void {
        ...
        if (this.player.wetness() >= 5)
            this.outx("Sure, you were a squirter before, but now, you'll squirt a half-dozen times even before you orgasm.");
        else
            this.outx("Sure, you could get plenty wet before, but now, you'll be squirting and drizzling before you even orgasm.");
        this.outx("  The quim-soaked cock pulls out long enough to leave you wanting, then slides back home, setting a nice, fast pace for your fuck.\n\n");

        this.outx("You purr around the thick, throat-stretching tool, enjoying your violent penetration.  The twin pillars of lust tremble in both ends of your body, and encouraged by how easily they seem to be getting off, you start tilting your head left and right, rotating your pre-cum-soaked esophagus around the beast-cock.  It stretches wide and explodes, too pent up to last long in such a tight orifice.  Mercifully, the flare is so far down your throat that you don't even have to swallow.  It just burbles the copious load straight into your belly.  You're a little disappointed you're not getting to taste it on your tongue, but there's always the next stud in line.\n\n");
        ...
        this.outx("He's pulled back and replaced, and you wonder which of your boys is getting sloppy seconds.  Who cares, as long as you get to feel him cum in you until you go dizzy!");
        this.player.orgasm();
    ...
    private disciplineEldestMinotaurSon(): void {
        ...
        this.outx("Dissatisfied with your son's response, you promptly smack the taste out of his mouth, reminding him who has the real power.  The force of the smack causes him to simper like the minitaur he no doubt abuses routinely.  Sometimes a mother has to give her son some tough love.\n\n");
        ...
        this.outx("\"<i>Your dick isn't getting any of mommy's pussy,</i>\" you coo to him, causing him to sink into despair.\n\n");
