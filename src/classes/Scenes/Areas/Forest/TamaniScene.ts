...
export class TamaniScene extends BaseContent implements TimeAwareInterface {
    ...
    */
    ...
    private tamaniFemaleYes(): void {
        ...
        this.outx("She pulls out a long pink dick and tosses it to you.  You catch it and it flops around, nearly slapping you in the cheek.  ");
    ...
    private tamaniFemaleNo(): void {
        this.spriteSelect(56);
        this.outx("", true);
        this.outx("The goblin harrumphs, \"<i>We'll see about that slut.  I'll be knocked up from every monster and stud this side of the mountain.  Hell, just grow one dick, and see how fast Tamani's legs get wrapped around you!</i>\"\n\n");
        this.outx("She flounces off, clearly planning on fucking everything capable of producing sperm on her way home.  ");
    ...
    private tamaniFirstTimeConsentual(): void {
        ...
        this.outx(".  She wraps her tiny arms around your neck and kisses you passionately, letting her tongue slither through your lips.   The two of you french kiss hard, virtually tongue-fucking each other.\n\n");
        this.outx("She breaks the kiss and smiles, licking the shining purple lipstick she wears as she whispers in your ear, \"<i>Mmmhmm, I knew your juicy cock just couldn't resist a wet and ready pussy like mine.  I made sure to lace my lipstick with fertility enhancing chemicals too, so we'll be nice and messy.</i>\"\n\n");
        this.outx(
        ...
        if (this.player.balls > 0)
            ...
            this.outx("Something inside you swells up with seed, spurring your desire to new heights.");
    ...
    private tamaniMaleRepeatEncounter(): void {
        ...
        // (ELSE)
            ...
            this.outx("While exploring, you're startled by the feeling of tiny hands stroking the insides of your thighs.  You look down and find Tamani the goblin there, grinning with desire, \"<i>Ready to stuff me with cum?  I'm not taking no for an answer this time.</i>\"\n\n");
    ...
    public tamaniSexLetHer(): void {
        ...
        if (this.getGame().inCombat) {
            ...
            if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                if (this.player.HP < 1)
                    this.outx("You stumble, hooves weaving drunkenly as you try to keep your feet.  ");
                else
                    this.outx(
            ...
            // Not taur
                ...
                if (this.player.HP < 1)
                    this.outx("You collapse, unable to fight back any longer.  For her part, Tamani seems disappointed with the outcome, but approaches your prone form in spite of your sorry appearance.");
                else
                    this.outx("You tear off your clothes in a frenzy of lust and stagger towards Tamani, openly fondling your groin.   She smirks and pushes you hard, throwing you off balance and onto your back.");
                this.outx(
        ...
        // Voluntary submission
            ...
            if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                ...
                this.outx("You meekly undress and ask Tamani how she would like to take you today.  She titters and gives your ");
                ...
                this.outx(" a quick kiss before pushing hard against you, shoving you onto the ground and flashing a brilliant smile.\n\n");
                this.outx(
        ...
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
            ...
            this.outx("Such is your arousal you find you can support her easily, but the sensation makes you cringe, particularly as Tamani sets about her work in earnest. Hanging onto your stomach she slathers your head with attention, her tingling lips and wet tongue all over your tip until you can barely stand it, beading pre-cum into her hungry mouth.\n\n");
            ...
            if (this.player.cocks[0].cockLength <= 18) {
                ...
                // No balls:
                if (this.player.balls == 0)
                    this.outx("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics.\n\n");
                else
                    this.outx(
            ...
            // If >18 Inches
                ...
                // High cum:
                    ...
                    this.outx("With a bellowing roar, you cum with mind blowing force. Your churning balls blast out a river of gooey fluid, the first glorious arc of which flies straight past your human front and paints the tree in front of you. Totally insensate, you can do nothing for entire minutes but stand there and cum, over and over again, sweat dripping off your frame, until the entire area underneath you is covered with your spooge.\n\n");

                    this.outx("When you finally come to your senses, you wearily but with intense satisfaction clop around to take in the lake of jizz you have created. ");
                    if (this.player.balls > 0)
                        this.outx(
                            `Your ${this.ballsDescriptLight()} ache and you feel very thirsty indeed.`
                        );
                    else this.outx("You feel very thirsty indeed.");
                    this.outx(" It's only when you manage to drag your mind away from your own privations that you suddenly wonder where Tamani went. She isn't still attached to you, is she? It is then that a small lump in the center of the vast puddle in front of you stands up and begins to happily wipe herself down, taking care to stuff as much of the seed plastering her into herself as she can.\n\n");
            ...
            this.outx("After a little while you redress, but the scent of horny goblin stays with you for hours.");
            // Combat end:
            if (this.getGame().inCombat) {
                this.outx("  After the stress and strain of a lost fight and the stress of having your seed so expertly stolen, you lie down on your flank and go to sleep.");
        ...
        // Not-taurs
            ...
            if (this.player.cockArea(0) <= 90) {
                ...
                if (this.player.cocks[0].cockLength >= 12)
                    this.outx("Her body visibly stretches around you, and you silently thank whatever gods or demons adapted goblins to be able to fulfill this role.  ");
                this.outx("Moaning like a whore, she easily slips the rest of the way down, bottoming out her sopping-wet fuck-tunnel.\n\n");
                ...
                if (this.player.balls > 0)
                    ...
                    this.outx("Your body's internal muscles twitch, pushing a jet of hot cum into the goblin.");
                this.outx("  Tamani wriggles happily, giving your nipples one last tweak before releasing them to play with her own.  Rope after rope of your goopey jism paints the inside of her canal, and the happy slut only begs for more the whole time.");
                ...
                if (this.player.cumQ() >= 500)
                    this.outx("  Your body fulfills her requests and more, stuffing her until she's positively pregnant and your spunk is squirting from her entrance with each wave of sticky spooge.");
                else
                    this.outx("  Sadly, you only manage a few more spurts before your orgasm ends.");
                ...
                // (Noncombat end:
                    ...
                    this.outx("You lie there, recovering from the intense sex.  After a little while you manage to get up and redress, but the scent of horny goblin stays with you for hours.");
                    this.player.orgasm();
                    this.dynStats("lus", +10);
                    this.doNext(this.camp.returnToCampUseOneHour);
                }
            ...
            // (Doesnt fit)
                ...
                this.outx("Tamani turns about, dragging her wet gash across you and giving you a nice view of her plump butt-cheeks.  She looks over her shoulder and sucks on one of her lacquered fingernails, looking equal parts mischievous and sexy.   You rock your hips under her until she gives your ");
                ...
                if (this.player.hasVagina()) {
                    ...
                    this.outx("Your walls squeeze tightly around it in an unconscious milking motion as your body reacts to it as if it were a real dick.");
                } else {
                    this.player.buttChange(this.player.analCapacity() * 0.95, true);
                    this.outx("Your body clamps down around it, resisting the strange intrusion as it swells up to fill you, pressing tightly against your prostate.");
                }
                this.outx(
                ...
                if (this.player.cumQ() >= 250) {
                    this.outx("You cum harder and harder, pushing her back a bit and splattering her belly with white cream.  She moans, rubbing it into her skin and twat");
                    if (this.player.cumQ() >= 500)
                        this.outx(" as you keep cumming, splattering her tits and face, soaking the little goblin slut");
                    this.outx(".  ");
                }
                this.outx(
    ...
    public tamaniSexLost(): void {
        ...
        this.outx("\"<i>You were such a naughty boy, teasing me with that juicy dick and then pretending like you didn't want this.  I'll have to punish you for being bad, that's all there is to it,</i>\" she explains, pushing your hands away and fitting the ring around your flare.  ");
        if (this.player.cocks[0].cockThickness >= 5)
            this.outx("Impossibly, despite your titanic girth, the ring somehow expands to squeeze onto you, though it's painfully tight.\n\n");
        else
            this.outx(
        ...
        this.outx("The spanking doesn't let up until your ass is cherry-red and tender.  Tamani gently pats it, making you wince in displeasure, and giggles, pleased with herself, \"<i>Hehe, do you think I've punished you enough?  I'm sure you do, but what I really want to know is – have you learned your lesson?  I need to make sure you'll be a good boy and jump right into my honeypot next time I ask.  I hate wasting time fighting when we could be making love and breeding.</i>\"\n\n");
        this.outx(
        ...
        this.outx("You NEED to cum.  Her hands... they keep stroking you, and each time your body begins to orgasm it's held back, trapped within you painfully.  ");
        ...
        if (this.player.cor < 50)
            ...
            this.outx("  Being denied like this was kind of fun, but you REALLY need to get off now, so you'll say what she wants you to say.\n\n");

        this.outx("\"<i>Mistress Tamani, I'm so sorry!  Milk my cock dry any time you want!  Puhleeeeeaaaaase let me cum!  Please, I'm so fucking horny, I'll do what you want, just give me release!</i>\" you beg, ");
        if (this.player.cor > 50)
        ...
        if (this.player.cumQ() >= 250)
            this.outx("  The bottle quickly overflows, but Tamani happily sets it aside and slides her own cunt under you, letting you pump the rest of your seed into her fertile womb.");
        if (this.player.cumQ() >= 500)
            this.outx("  She coos happily when you still manage to pump enough jism into her to bloat her belly, but even with your impressive fertility, the orgasm has to end.");
        this.outx("\n\n");

        this.outx("Tamani removes the ring once you have finished.  She seals the bottle and places it in her pouch as you drop to the ground, exhausted.  All you can do is watch as she walks away, her ass swaying confidently from side to side.  Your last thought before you pass out is how much easier it would've been to just fuck her.");
        this.player.orgasm();
        this.dynStats("lib", 0.5, "sen", -1, "cor", 0.5);
        this.cleanupAfterCombat();
    }
    ...
    public tamaniSexWon(): void {
        ...
        if (this.player.cockArea(x) <= 90) {
            ...
            this.outx(".  You don't allow her any say in the matter, pushing forward as you feel the small girl's flesh yield around ");
            if (this.player.totalCocks() > 1) this.outx("each of ");
            this.outx("your girth");
            if (this.player.totalCocks() > 1) this.outx("s");
            this.outx(".  She squeals happily, clearly getting what she desires.  For a moment you feel disappointed in yourself, but the sensations of her tight hole");
            if (this.player.totalCocks() > 1) this.outx("s");
            this.outx(" clenching and squeezing around you quickly washes it away.\n\n");

            this.outx("You rock back and forth methodically, treating Tamani like a tight cock-sleeve.  The goblin slut's hands rub her belly, not even attempting to pull her face out of the mud as she moans and giggles like a whore.  You keep working her cunt like a ");
            if (this.player.gender == 1) this.outx("man");
            else this.outx("herm");
            this.outx(" possessed, sawing in and out with brutal efficiency, the wet squelches of the slut's juices driving you to piston back and forth with even greater force.  She gurgles happily, her ");
            ...
            if (this.player.totalCocks() > 1) {
                ...
                if (this.player.cumQ() >= 250)
                    this.outx("  She pants, turning her head in the mud to watch as her belly visibly inflates, stuffed totally full of cum. ");
                if (this.player.cumQ() >= 500)
                    this.outx("  In no time at all a river of jism pours from her, pooling below as you overwhelm her body's capacity to store spunk.");
            } else {
                this.outx(
            ...
            this.outx("She doesn't give you a chance to answer as she wobbles off, jiggling pleasantly in all the right places, \"<i>Of course you do.  I'll be back for the rest later!</i>\"\n\n");
            this.player.orgasm();
        ...
        // Too big? Jerk off with feet and bukkake
            ...
            this.outx("You throw Tamani on her back, too drunk on desire to care how it feels for the tiny slut.  There's no way she could ever take ");
            ...
            if (this.player.cumQ() >= 500)
                this.outx("  She sputters, blowing some of the caked up semen off her face so she can breathe.  The slut gathers up the goopy mess as you continue to paint her, alternatively devouring it with her mouth and shoveling drippy handfuls into her eager cunt.");
            this.outx("\n\n");
            ...
            this.outx("She doesn't give you a chance to answer as she staggers up and strikes a sexy pose, \"<i>Of course you do.  I'll be back for the rest later!</i>\"\n\n");

            this.outx("Tamani wiggles in the sexiest way as she leaves, arousing your body all over again...");
            this.player.orgasm();
    ...
    private tamaniPregnantRefusal(): void {
        this.spriteSelect(56);
        this.outx("", true);
        this.outx("She bursts into tears and waddles away crying.  You aren't sure if you should feel bad or not.");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private tamaniPregnantFuck(): void {
        ...
        if (this.flags[kFLAGS.TAMANI_TIMES_IMPREGNATED] > 6)
            this.outx("  They're almost too big for you to handle; they probably make it hard for the poor girl to walk.");
        this.outx("\n\n");
        ...
        this.outx("Her pregnancy swollen belly and growing breasts rub along your shaft as she kisses and squeezes it.  You're so turned on it hurts, and you KNOW it's from whatever she put in her lipstick this time.  You beg her, \"<i>Please, fuck me, I'm so horny it hurts!</i>\"\n\n");
        ...
        if (this.player.cockArea(0) <= 50) {
            ...
            this.outx("For her part, Tamani staggers to her feet, letting you flop free as a river of your cum pours between her legs, soaking your lower body.  She staggers over to your face, pleasure-drunk, and leans down to give you another sloppy kiss.\n\n");
        ...
        // (Doesn't Fit)
            ...
            this.outx("Tamani comes over to you and gives you a sloppy goodbye kiss, sending an immediate surge of hardness and desire to your groin.  She looks back and giggles, then waddles off, patting her pouches and dripping with your spooge.");
            this.player.orgasm();
        }
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private tamaniPoopsOutBabies(): void {
        this.spriteSelect(56);
        this.outx("", true);
        this.outx("You hear orgiastic screams in the distance as you explore.  You turn to investigate, and as you go, they become even louder and higher pitched.  You crest a rise and find Tamani ");
        ...
        if (this.flags[kFLAGS.TAMANI_PREGNANCY_COUNT] == 2) {
            this.outx("The twins drink deeply, growing taller before your eyes as Tamani comes out of her pregnancy induced orgasms.");
        } else {
            this.outx("The goblin children drink deeply, squabbling for a chance at suckling the nipples as their mother recovers from her birthing-induced orgasms.");
        }
        this.outx(
        ...
        this.outx("Tamani sighs and relaxes, enjoying the breastfeeding and waving you away.  You shrug and head back to camp, more than a little aroused.");
    ...
    public getRapedByTamaniYouHypnoSlut(): void {
        ...
        // [FITS]
        if (primary >= 0) {
            this.outx("Tamani is completely right.  You grab her ass, feeling your fingers sink in to her supple flesh as you pull her back towards your ");
            ...
            this.outx("You wait a second, adjusting to the feeling of being completely contained by such a warm, wet hole before you slowly push her away.  The slick walls of her tunnel clench around you as you pull her back, massaging the parts of you still inside her.  ");
            if (cocks > 1) {
                ...
                this.outx("She moans and pants, babbling about how good you are to her the whole time.");
            this.outx(
            ...
            this.outx("  The second thrust is even better than the first.  It's slippery, hot, and passionate, and the idea of slowing down or stopping for any reason is inconceivable.  Tamani pants with each thrust, pawing at her bouncing breasts, grabbing one by the nipple with a free hand and moaning loudly");
            if (cocks > 0) this.outx(` around your ${this.cockDescript(secondary)}`);
            this.outx(". Her tiny form jiggles, ");
            if (this.player.tallness > 55)
                this.outx("lifting off the ground as you get into it, giving yourself over to her sex.");
            ...
            this.outx("Taking that as an opportunity, you pick up the pace, plunging yourself in and out of her with a renewed, almost vicious vigor.  The wet slaps of your juice-");
            ...
            if (this.player.hasKnot(primary))
                ...
                this.outx("Your tentacle-cock's tip widens, becoming mushroom-like inside Tamani's womb");
            else
                this.outx("Your sensitive head swells slightly in time with the contractions of your orgasm");
            this.outx(" as you begin to fill your wife's womb with seed.   The orgasm is intense");
            if (this.player.cumQ() < 50)
                this.outx(", but brief, and after a few moments of spasming pleasure, the flood of cum slows to a trickle.");
            else if (this.player.cumQ() < 300)
                this.outx(" and voluminous, forcing more and more seed into Tamani's uterus until she sloshes with each new squirt.  After a few long moments of spasming pleasure, the flood of cum slows to a trickle.");
            else {
                this.outx(" and massive, squirting thick gouts of semen directly into Tamani's waiting womb until each new explosion of spunk makes her slosh.  She moans, her belly bloating slightly until she's unable to take any more.");
                if (this.player.cumQ() < 1000)
                    this.outx("  Though your orgasm tapers off, the additional seed squirts from between her thighs, trickling down to a slow drip of viscous white goo.");
                else
                    this.outx("  Trapped inside her and cumming as hard as ever, you raise the pressure inside the goblin until your seed is washing out of her cunt around you, puddling on the ground.");
                if (this.player.cumQ() >= 1000 && this.player.cumQ() < 4000)
                    this.outx("  It does eventually end, but not until a sizable puddle has formed between the pair of you.");
                else
                    this.outx("  It lasts seemingly forever, and by the time you're done, the two of you are standing in a puddle inches deep.");
            }
            if (cocks > 1) {
                this.outx("  During it all Tamani's throat works to swallow every drop");
                if (this.player.cumQ() > 300) {
                    this.outx(", but before long she's failing, with cum leaking out from the corners of her mouth.");
                    if (this.player.cumQ() > 600)
                        this.outx("  A few seconds later she pulls back coughing, and the perky goblin takes the rest of your load in her face.");
                } else this.outx(".");
            }
            this.outx("\n\n");

            this.outx("Joined at the hips, the two of you manage to stay upright, each leaning into the other");
            ...
            this.outx("A surge of pride spreads through you at her praise, and you lean down to give your wife a long french kiss before heading back to camp.  On the way back your head slowly clears, and you wonder what came over you back there?!");
            this.tamaniKnockUp();
            this.player.orgasm();
        ...
        // [DOESNT FIT]
            ...
            this.outx("A surge of pride spreads through you at her praise, and you get up to give your wife a long french kiss before heading back to camp.  On the way back your head slowly clears, and you wonder what came over you back there?!");
            this.tamaniKnockUp();
            this.player.orgasm();
            this.dynStats("int", -0.5, "sen", -1);
        }
