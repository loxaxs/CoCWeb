...
export class Faerie extends BaseContent {
    ...
    public encounterFaerie(): void {
        ...
        if (this.player.cockTotal() > 0 && (!this.player.hasVagina() || Faerie.rand(2) == 0)) {
            ...
            if (this.player.lust >= 90) {
                ...
                this.outx(", too large for her tiny frame... the depraved image overwhelms your mind's eye and you find yourself shooting all over the ground furiously.");
                this.player.orgasm();
            } else
        ...
        this.outx("The faerie slows the beating of her wings and hovers towards you. You dismiss your fearful notions, certain a small faerie is quite harmless to you.\n\n");
    ...
    private faerieRAEP(): void {
        ...
        // Non-Taurs
            ...
            if (this.player.statusAffectv1(StatusAffects.FaerieFemFuck) < 4)
                this.outx("Her mood immediately shifts from panic to desire, and she licks her lips hungrily, locking her eyes onto your feminine folds.");
            else
                this.outx("Her eyes open wide, like a junkie seeing a fix.  She licks her lips hungrily and humps the inside of your hand, ready for action.");
            this.outx("  You release the faerie, letting the pussy-entranced fae buzz down to your sensitive nether-regions.  She lands softly, her tiny feet and hands prancing over your vulva.  You gasp in delight, ");
        ...
        // [FIRST TIME]
        if (this.player.statusAffectv1(StatusAffects.FaerieFemFuck) == 1) {
            this.outx("Lying in the forest loam as you recover, you watch as the faerie stumbles out of your groin, holding her head and giggling nonstop.  She tries to put on a serious face but it's instantly overpowered by another fit of laughter, \"<i>Hehe, did you know I'd get stoned off your girlcum?  Omigod I've never been this -heheheheheh- high before!  Like I can see EVERYTHING.  Puuhleeeease don't make me do this again...</i>\"\n\n");
        ...
        // [REPEAT LOW]
            ...
            this.outx("The little woman spins around happily, proclaiming, \"<i>The colors are like, so bright!  Oh gosh, I'm hungry!  See you and your clit later, just don't let me fall in your snatch, it fucks me up so much.  I don't think I can handle much more or I'll be crawling between your legs every chance I get!</i>\"\n\n");
            this.outx('She flits away, calling out, "<i>Bye sweetie!</i>"', false);
        }
        // [SLUTTIN IT UP]
        else {
            this.outx("The faerie stumbles out of your snatch, giggling and scooping the slippery girl-goo off her body, licking it up.  She crawls up your body to your lips, giving you a cunt-flavored kiss and babbling happily, \"<i>Mmm your cunt makes me so warm and giggly!  I'm so fucking stoned!  Gawddess, I'm hungry too – I'm gonna grab some food, and then come back for another dip in your honeypot, ok?</i>\"\n\n");
            this.outx("She flits away, a little unsteady and reeking of female sex and desire.");
        }
        this.player.orgasm();
    ...
    private faerieDoNothing(): void {
        ...
        if (this.player.nippleLength >= 1) {
            ...
            this.outx("A few blissful moments later, she shudders and you feel her uncontrolled spasms around your nipple.  ");
            if (this.player.hasVagina()) this.outx("You join her shortly after.  ");
            this.outx("The faerie goes limp and spirals to the ground, crashing gently and still twitching in the afterglow. Stepping back carefully, you leave her.");
        ...
        if (
            ...
            this.outx("A smile crosses her face and she flutters down to your crotch. She starts by scissoring you despite the size difference, driving your clit into her despite its erect state. Compared to her, it looks massive. She swings one leg over it and starts impaling herself on it. Your taut clitoris barely fits inside her, and the tight confines on your sensitive nub are enough to make you weak in the knees. Staggering to the ground, you grab hold of her frail body in your fist and thrust her roughly on your engorged button. She wails in both pain and pleasure, being crushed and stretched open at once. Her cries of pain combined with the intense stimulation on your most sensitive part bring you to a quick orgasm.\n\n");
            if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING)
                this.outx("You drench the poor faerie completely in your female juices, soaking her hair and body. Overwhelmed and spent, you drop her to the ground and catch your breath. She licks up what's around her face, but is too weak to do anything else but lie in the dirt.\n\n");
            else
                this.outx("Shuddering, you maintain your composure and keep going, trying to ride the high for another. Eventually you look down and you can see the faerie's eyes have glazed over and rolled to the back of her head. Her cunt has started clamping down on you a lot harder, evidence of her state of near-constant orgasm. The random clenching brings you off again very quickly and you have an intense orgasm, joining your fae cohort.\n\n");
            this.outx("Time skips a beat and you eventually come down, gently relaxing your grip and disengaging the worn out faerie from your softening female parts. The faerie regains consciousness slowly and thanks you before flying off.");
            this.player.orgasm();
            this.dynStats("lib", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
            return;
    ...
    private letFaerieGo(): void {
        this.spriteSelect(17);
        this.outx("", true);
        this.outx("You apologize and release her, letting her fly away on gossamer wings.  She thanks you, buzzing up to your lips and planting a chaste kiss on your mouth.  She zips away into the woods without a glance back...");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private faerieCaptureHJ(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.FaerieFucked) < 15) {
            this.outx("You hold her tightly and scold her, \"<i>If you don't like hard cocks, you shouldn't be dressed up like a such a slut, flying around and teasing me like that.  You should be ashamed of yourself.  Now you've got me all worked up - so you better make it up to me and take care of my little 'problem'</i>.\"\n\n");
            this.outx("She looks up at you and gulps before nodding silently, unwilling or unable to resist your command.   ");
        }
        this.outx(
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.balls == 0)
                this.outx("Your tiny globules of semen go straight into her open mouth and she sucks them down gleefully before falling with a splat onto the pre soaked ground.\n\n");
            else {
                // [Small amount of cum:
                if (this.player.cumQ() < 50)
                    this.outx("Your semen splashes straight into her face and she's quick to suck it up. She falls with a splat onto the pre soaked ground while your member drips periodic droplets of cum onto her head.\n\n");
                // [Normal amount of cum:
            ...
            this.outx("The faerie takes off, still dripping, and flying in something less than a straight line...");
        }
        // Non-taurs
        else {
            this.outx("The faerie reaches your swollen member and ");
            if (this.player.hasKnot(0))
                this.outx("climbs atop your knot, wrapping her legs around the narrower shaft to hold on.  You can feel her cheeks resting atop the 'bulb' of your canine anatomy, teasing you with feminine features you're far too large to penetrate.  ");
                ...
                this.outx("climbs on to your hardness, wrapping her legs tightly around it as she secures a perch against you.   You can feel her wet gash rubbing against your sensitive skin, teasing you with a tiny cunt you'll never be able to penetrate.  ");
            this.outx(
            ...
            if (this.player.cumQ() > 250) {
                ...
                if (this.player.cumQ() > 500)
                    this.outx("The proof of your release forms a puddle around you as your legs give out and y");
                else this.outx("Falling backwards as your legs give out, y");
            } else this.outx("Y");
            this.outx("ou watch your wet groin squirm as the faerie finishes releasing your built-up tension and crawls out.  She's covered from head to toe in sloppy white jism, and is noisily slurping it up.\n\n");
            this.outx("She rolls off of you, staggers, and plops down on her cute little ass next to you");
