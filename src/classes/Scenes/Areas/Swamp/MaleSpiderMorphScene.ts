...
export class MaleSpiderMorphScene extends BaseContent {
    ...
    public greetMaleSpiderMorph(): void {
        ...
        this.outx("A spider-morph drops out of a tree in front of you, hanging by a single thread of sparkling webbing.  His purple eyes gaze deeply into your own while he looks you up and down.  ");
        // DANGER MODE:
        if (MaleSpiderMorphScene.rand(2) == 0) {
            this.outx("A moment later, he flips down onto his feet and advances, touching his half-hard, foreskin-shrouded cock.  Judging from the glint in his eyes, he plans to force himself upon you!");
            // - auto fight
    ...
    private talkToSpiderBoy(): void {
        ...
        this.outx("He stands and gives you a bundle of pink fibers with a nervous bow.  You look down at the gossamer strands in your hands, and when you glance back up, he's gone.  ");
    ...
    public defeatSpiderBoy(): void {
        ...
        if (this.monster.lust > 99)
            this.outx("masturbating with furious abandon, working his ebon dick with such vigor that the spider's pre-cum-slicked dick-skin noisily slides itself back and forth over his fattened glans; it becomes apparent just how much foreskin he truly has at this point, as even with his frenzied rubbing his glans remains shrouded in the thick excess skin while his fist slaps lewdly against his groin.  Dribbles of pre-cum leak from between his fingers to spill on the ground.");
        else
            this.outx("wobbling back and forth as he tries to stay up and fight.  There's no way he can oppose you, as beaten as he is now.");
    ...
    private victoryButtFuck(): void {
        ...
        this.outx("You approach and turn the spider-boy around, pushing the spider's bulbous abdomen aside to give yourself a better view of the his tight, heart-shaped ass.  ");
        if (this.monster.lust > 99)
            this.outx("He's too distracted by his foreskin fondling to pay much attention to your anal-focused attentions.");
        else
            this.outx("He's too busy trying to stay upright to fight off your anal-focused attentions.");
        this.outx(
        ...
        this.outx("The arachnid finally realizes what you intend to do, and he whimpers plaintively, \"<i>P-please... don't put it there.  ");
        ...
        this.outx("You grab his balls and caress them in one hand while you take off your equipment with the other.  The hapless victim starts to relax from the attentions, and pre-cum begins to leak from inside his foreskin ");
        ...
        this.outx("Chuckling at his admission of enjoyment, you let go of the spider's twitching ball-sack and take advantage of your free hand to slap his pale white ass.  It leaves a red, hand-shaped mark on his perfect little hiney, a temporary reminder of your authority.  His abdomen rubs against your belly as you start to fuck him, the heavy organ swaying with the gentle sawing motions of two bodies locked in anal coitus.  You gradually increase the tempo and quickly reach a point where your hips are slapping against his butt with loud, echoing smacks.\n\n");
        this.outx("The arachnid male squirms under you, whimpering, \"<i>W-Why is it feeling so good?  It's-ooohh-making my dick so hot.  It feels like it's gonna explode!</i>\"\n\n");
        this.outx(
        ...
        if (this.player.cockTotal() == 2)
            this.outx("  The leftover dick spurts out its half of your load over his ass, making it look more pearly-white than ever before.");
        else if (this.player.cockTotal() > 2)
            this.outx("  The leftover dicks spurt out their portion of your load across his ass-cheeks, making them look more pearl-white than ever before.");
    ...
    private victoryFrotTheSpoidah(): void {
        ...
        this.outx("atop his miniature cock, you virtually bury it in a superior male's heavy penile flesh.  ");
        if (this.monster.lust > 99)
            this.outx("He pants in surprise and pleasure, clearly enjoying the weighty shaft rubbing against his drooping dick-skin");
        else
            this.outx("He gasps in surprise and slowly growing pleasure, clearly enjoying the weighty shaft rubbing against his drooping dick-skin");
        this.outx(
    ...
    private victoryCowgirlRidingOnSpiderBoi(): void {
        ...
        this.outx(".  Gently exploring his body, you run your hands over his chest, circle his tight, stiff nipples, and slide all ten fingers down his smooth skin toward his loins.  The effect of your touches soon becomes apparent, ");
        if (this.monster.HP < 1) this.outx("resulting in a stiff, pre-cum-dripping spider-cock.");
        else
            this.outx("resulting in the spider-cock's hood of excess, sensitive flesh overfilling with sticky, musky pre-cum.");
        this.outx("\n\n");

        this.outx("The arachnid male looks up at you with wide, open eyes and a lusty expression, begging with his eyes for you to take his slippery black cock inside you.  Lucky for him, that's exactly what you have planned.  You mount the male spider's lithe body with a smooth, sensuous motion, ");
    ...
    private spiderBoyLossMaleButtfuck(): void {
        ...
        if (this.player.HP < 1) {
            this.outx(" in a semi-conscious heap, unable to stand, barely able to flop onto your back and look up ");
        ...
        if (this.player.HP < 1) this.outx('and silently mouth, "<i>Please, no.</i>"', false);
            ...
            this.outx("and give a little nod, too intoxicated by arousal to decline any form of sex.");
        this.outx(
        ...
        if (this.player.analCapacity() < 40)
            this.outx("mercifully easy due to the mess of pre-cum and the forgiving foreskin that clings to his shaft.  It rolls further and further back as he pushes in until his glans is exposed to your clenching guts.");
        else
            this.outx(
        ...
        if (this.player.cor < 33)
            this.outx("You blush shamefully and nod, utterly humiliated by the quick little orgasm.");
        else if (this.player.cor < 66)
            this.outx("You blush shamefully and nod, humiliated and aroused by how quickly you just came.");
        else
            this.outx("You blush with arousal and humiliation, shaking your head up and down and hoping he'll hit that spot again.");
        this.outx(
        ...
        if (this.player.analCapacity() >= 40)
            this.outx("I just wish you were less loose, but I guess you must let anyone with a nice fat cock plug your ass every chance you get, huh?  ");
        this.outx("Just lie there and take it bitch, I'm not going to cum until you've painted your belly white.</i>\"\n\n");
        ...
        this.outx("Crossing your eyes, you grab the ground with both hands and struggle to hold on.  There's... too much... too much pleasure for you to think.  Muscles randomly seize and twitch throughout your body, and though the ");
        ...
        this.outx("  Your eyelids flutter and droop, your tongue lolls out of your mouth, and you start drooling all over yourself.  Zombie-like, your body keeps shaking, locked in orgasm, even after the spider dumps you in the dirt and walks away.");
        this.player.slimeFeed();
        this.player.orgasm();
        this.cleanupAfterCombat();
    }
    ...
    private loseToSpiderBoyVagFucked(): void {
        ...
        if (this.player.lust > 99)
            this.outx(", caressing yourself with reckless abandon while praying the sexy spider-boy will come violate you with his thick-skinned prick.");
        else
            this.outx(", clearly too injured and fatigued by the battle to make more than a few token movements.");
        this.outx(
        ...
        if (this.player.hasFuckableNipples())
            this.outx("into his mouth before plunging his tongue into the tit-pussy's passage");
        ...
        if (this.player.HP < 1)
            this.outx("Even though you're injured, his oral attentions make the nub get so hard and sensitive that you quickly forget your own pain.");
        else
            this.outx("Even though you tried to fight him, his oral attentions make your nub so hard and your horny body so eager that you quickly forget.");
        this.outx(
        ...
        this.outx(" moans of pleasure to his ministrations.  Helpless to do anything but grow more and more aroused, you give up entirely on resisting and let yourself be putty in his hands.\n\n");
        ...
        this.outx("You sigh and close your eyes, slowly slumping down while your hips keep twitching.  You've been sated, and though your body keeps hungering for more, you slip into unconsciousness.");
        this.player.slimeFeed();
        this.player.orgasm();
    ...
    public spiderPregVagBirth(): void {
        ...
        if (this.player.gender != 2)
            this.outx("spraying your cum all over the ground underneath you, each egg squeezing out and prolonging the intense feeling.\n\n");
        // [if female/genderless]
        else
            this.outx("spraying your juices all over the ground and mixing in with the green slime, soaking your legs, each egg you squeeze out only prolonging the intense feeling.\n\n");

        this.outx("After what seems like hours, you have lost count of the eggs pushed out, and you collapse from sexual exhaustion.\n\n");
        kGAMECLASS.timeQ += 2;
        this.outx("You awaken later on, a sticky feeling between your legs to go with your wet pussy");
        if (this.player.hasCock()) this.outx(" and raging hard on");
        this.outx(". Looking around, you notice the slimy pool appears to have dried up, but the broken eggshells show that you weren't just dreaming. Tiny dots in the dirt form a trail leading to the swamp, and you can only guess where your offspring went.\n");
        this.player.orgasm();
    }
}
