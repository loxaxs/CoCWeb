...
((Scenario 4, [Frot]))*/
            ...
            if (this.player.biggestTitSize() >= 2 && this.player.lib >= 50) {
                ...
                if (this.player.inte <= 30) {
                    ...
                    if (this.player.hasVagina())
                        this.outx(
                            `  When you witnessed him make that other beast submit with strength alone it created a demanding need in your [vagina] during the match, and the memory is doing much the same now.`,
                        );
                    // ((if player has cock(s))
                    if (this.player.hasCock())
                        this.outx(
                            `  You feel [eachcock] shift as you remember how hard you got from behind the tree, finding yourself absent mindedly stroking yourself with an open palm as pre-cum soaks through your clothing.`,
                        );
                    this.outx(
        ...
        // Not sure what determines this yet
            ...
            // ((androgynous or masculine and breasts <= A-cup))
                ...
                if (this.flags[kFLAGS.ROGAR_DIRT] == 2)
                    this.outx(
                        `"<i>[name], y'all took off on me real quick like,</i>" he says through a snicker.  The joke falls flat and the orc seems to blush lime green as you stare at him uncomprehendingly.  He rubs the back of his neck with a hand before continuing.  "<i>Sorry about that.  I was plumb tuckered out afterwards.</i>"\n\n`,
                        false,
                    );
    ...
    private waitForChunkyOrcLoe(): void {
        ...
        if (this.flags[kFLAGS.ROGAR_PHASE] == 0) {
            ...
            // ((If libido is 50 or more))
                ...
                if (this.player.hasVagina()) {
                    this.outx(
                        `  Your [vagina] starts to quiver as the warm water rolls over its lips, moistening in excitement as your skin is rubbed over by strong hands.  Your chest heaves as it relaxes to his touch, your [nipples] becoming stiff under his rubbing.`,
                    );
                    this.outx(
                        `  Even your [feet] and fingers curl as you smell the sweat and musk of Ro'gar's closeness, the animalistic scent arousing you.`,
                    );
    ...
    public rogarThirdPhase(): void {
        ...
        // ((androgynous or masculine and breasts <= A-cup))
            ...
            // else if Ro'roh Raggy < 1 and player height < 5 feet)
                ...
                this.outx(
                    `you gently tug on the figure's cloak, mentioning aloud that it seemed to have held up all right with your sewing job.  The figure's back straightens sharply and a deep snicker is heard.  "<i>Ya did a mighty fine job, [name].  Been waitin' for ya.</i>"  Ro'gar turns and grins at you.\n\n`,
                    false,
                );
            }
            // ((Paths combine here))
            ...
            // (else if Dirt Mc Girt = 2)
                ...
                if (this.player.gender == 2 || this.player.gender == 0) {
                    ...
                    this.outx(
                        `  ${this.SMultiCockDesc()} gets a caress from him as he explores, arousing it to mild stiffness.  "<i>[name],</i>" he grunts.  "<i>Ah hope ah'll be seein' more of ya.</i>"  Ro'gar breaks the contact and tips back the remains of his drink while you `,
                    );
                    if (this.player.cor < 50) this.outx("blush");
                    else this.outx("fantasize about those strong hands touching every part of you");
                    this.outx(
    ...
    public rogarPhaseFour(): void {
        ...
        if (this.player.biggestTitSize() >= 2 && this.flags[kFLAGS.ROGAR_WARNING] == 0) {
            ...
            if (this.player.biggestTitSize() >= 2) this.outx(` and your [chest]`);
            this.outx(
        ...
        // (andro or masculine with tits <= A)
            ...
            this.outx(
                `Ro'gar is tipping his drink back when he catches sight of you, and waves you over.  "<i>Ah, good ta see ya, [name]!`,
            );
            // [(Ro'roh Raggy = 1)
            if (this.flags[kFLAGS.ROGAR_WARNING] == 1) {
                this.outx(
    ...
    private loseButtGinity(): void {
        ...
        // (([Get Anal] Scenario 1b: Get fucked (normal)))
            ...
            // (else)
                ...
                this.outx(
                    `"<i>Enough horsin' around.</i>"  Ro'gar snarls as his arms quickly yank back, sneaking under your legs and hoisting you up as he gets to his feet.  You grip Ro'gar's shoulders tight as he lifts you with a strained grunt.  You delight with sharp little moans as he begins to fuck you skyward, bouncing you off of his hips with each slam of his cock into you.  Slowly Ro'gar steps towards a wall, taking his time to be sure not to drop you, and you soon feel the cool surface pressed to your back.  Caught between a cock and a hard place, you stare into Ro'gar's predatory gaze as he holds you hoisted in the air and pinned, making you feel vulnerable.  The orc takes advantage of you and begins to abuse your [asshole], making your head tilt back to moan out helplessly.`,
                );
                this.outx(
                ...
                if (this.player.balls > 0)
                    this.outx(
                        `  You feel your [balls] pull up tight in your sack as your labored breath comes out in pants.`,
                    );
                this.outx(
    ...
    private fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim(): void {
        ...
        if (this.player.cor > 70 && this.player.hasVagina())
            this.outx(
                `Ro'gar flicks his tongue toward your [cocks], but you have a better idea and nudge him lower to guide him to your [vagina].  His eyes look up at you in confusion.  You can tell he'd rather not have his face buried there by the way he moves his mouth away, but you urge him on; telling him to get licking, you push your hips down over his face.  With his head caught between your legs and the bed his mouth presses to your [vagina]without a choice.  His whimpers of displeasure bring a grin to your face as you rub over his mouth with your netherlips.  He reluctantly flicks his tongue out to lap over your mound.  You shiver at the attention, growing moist and slick as you drip over Ro'gar's mouth.  The orc gives a whine of disgust as you rudely force him to pleasure your pussy, and you let out a loud moan as his unwilling licks turn you on; excited, you stroke your [cock].  Ro'gar focuses his attention on that instead, watching you grow stiff and swollen, his eyes following your pumping hand.  You generously rub the slick, drooling pre-cum over [eachcock], your vaginal walls clenching around his tongue as you pleasure yourself, working the goo over your flesh with your hand.  You look down and grin devilishly at him.\n\n`,
                false,
            );
        // (If player doesn't have vagina but has 70+ corruption)
        else if (this.player.cor > 70)
            this.outx(
                `Ro'gar flicks his tongue over your [cocks], but you have a better idea and nudge him lower to guide him to your [asshole] .  With a lusty growl Ro'gar attacks your pucker, tongue swirling over the surface and coaxing a pleased moan from your lips.  You grow stiff with arousal, bringing a hand down your shaft to answer your burning lust with a few teasing strokes.  You smear the pre-cum pouring out of your [cocks] into an even coating of spunk as you work your hand.  Ro'gar looks over at the pumping hand and soon becomes distracted from his work, his tongue pressed lazily against your [asshole].  You look down and grin devilishly at him.\n\n`,
                false,
            );

        this.outx(
            `Pulling back off of Ro'gar's face, you feel your entire body twitch in anticipation.  You press your [hips] against his muscled ass, lining your aroused member up against his tight rear while your hands grope over the firm muscled cheeks, spreading them apart eagerly.\n\n`,
            false,
        );
        ...
        // ((else If smallest cock is over 18 inches))
            ...
            // (else If single cock)
                ...
                this.outx(
                    `Your [cocks] bucks against Ro'gar's orcish pride.  The pair of hard cocks press tightly together as you dwarf Ro'gar in size.  You hump his orc sex with your [cocks] and grunt in strain; your hands reach down to grip the pair of manhoods tightly, jerking them fast with squeezed pumps.`,
                );
            // (If player has balls)
            if (this.player.balls > 0)
                this.outx(
        ...
        // ((If cock is between 18 and 4 inches))
            ...
            // (If horse cock)
                ...
                this.outx(
                    `  The flared head of your [cock] nestles in Ro'gar's hole.  His breath quickens as you push in, the girthy, flared head stretching Ro'gar's insides impossibly.  You simply thrust and buck you way deeper within the green pucker to force more of your lengthy shaft past that olive rosebud each time.\n\n`,
                    false,
                );
            // (If dog cock)
            ...
            if (this.player.cockTotal() > 1)
                this.outx(
                    `  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro'gar's body.  In seconds he resembles a well-paid whore beneath your [cocks].`,
                );
            this.outx("\n\n");
        }
        // end right fit path
    ...
    private frotWithRogar(): void {
        ...
        // (If single cock)
            ...
            this.outx(
                `Your cock presses tight against Ro'gar's fat orc cock. He growls low as he grinds himself over you, his thick, globbing pre-cum drooling onto your [cocks].  Muffled groans escape Ro'gar's mouth as you kiss him roughly, tongues locked all the while in writhing combat.  `,
            );
            // [(If player has balls)
            if (this.player.balls > 0)
    ...
    private kinkyWithDaOrc(): void {
        ...
        this.outx(
            `  Fingers and [feet] curl in pleasure as your boycunt is forced open by Ro'gar's steady coaxing.`,
        );
        this.outx(
    ...
    private rubdubWithDaOrcWithoutDucky(): void {
        ...
        this.outx(
            `"<i>I purchased these oils to relax my muscles after spending so much time in the gym.</i>" Your orc lover motions to a few bottle of oils on his night stand. "<i>How about you give me a hand... or two.</i>" Ro'gar grins at you, his eyebrows twitching suggestively. You need no further provocation as you strip from your [armor], you let it fall into a pile on the floor as you make for the bottle. Ro'gar grins and rolls onto his stomach.\n\n`,
            false,
        );
        this.outx(
        ...
        this.outx(
            `Without any hesitation you straddle the orc's hips again, his engorged orc cock brushing against the bare skin of your [butt]. Your hands get to work smearing the relaxing oil over Ro'gar's body. The orc stares at you with a lurid gaze as you massage his bulging pectorals, teasing his darkened nipples with your fingers. You grin feeling Ro'gar's thick cock pressing more against your [butt] as his chest rumbles under your hands.\n\n`,
            false,
        );
        this.outx(
            `"<i>You're good at this [name], have you done this before?</i>" Ro'gar purrs as you work over his abdominals, tracing over every gap with your fingertips, the oils glistening over your lover's body. Ro'gar's hips buck gently, bumping your [butt] with his throbbing cock with a chuckle, his mouth curls into a coy smile. You watch as Ro'gar reaches his arms back, resting his head on his hands as he bares his underarm and pits.\n\n`,
            false,
        );
