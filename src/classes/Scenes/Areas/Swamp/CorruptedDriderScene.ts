...
export class CorruptedDriderScene extends BaseContent {
    ...
    private winDriderPCDickInSpiderCunt(): void {
        ...
        this.outx(
            `Compelled by your body's instincts, you draw back your [hips] to expose the bulk of your pussy-soaked shaft.  The spider-woman moans disappointedly, her voice filled with so much wanton desire that your ${this.player.cockHead(
                x,
        ...
        this.outx(
            `While you're distracted by the repeated contrast of tension and relief emanating from [eachcock], the drider leans up and kisses your neck, humming against your throat as you squirt the last of your orgasmic goop into her vagina.  You slump into her arms, spent by the effort of fucking her so fast and cumming so hard.  As you lie there, her lips sucking hard enough to leave hickeys on your neck with every crushing, passionate kiss, you feel the patterns of glossy fluid tingling on your [skin].  A jolt of fear runs up your spine, and you try to push away from her envenomed affections.  It doesn't work!  You can barely lift your arms, let alone pull out of the amorous arachnid's embrace!\n\n`,
            false,
        );
    ...
    private victoryVSDriderRideOviAnal(): void {
        ...
        if (this.player.hasCock())
            ...
            this.outx(
                `while your fingers tweak your [nipples] and your starved sphincter sucks at its slimy, squirming stuffing`,
            );
        this.outx(
    ...
    private loseVSDriderGetAnalledOvi(): void {
        ...
        this.outx(
            ` slapping against her slavering cunt.  She grabs on to your [hips], using you as leverage to pump her pole inside of you while you jerk against the ground, eyes closed tight while your cheek rubs against the cold dirt.\n\n`,
            false,
        );
        ...
        else this.outx(`chest, trickling between your [nipples]`);
        this.outx(
    ...
    private loseVSDriderAndVaginallyImpreggleOvi(): void {
        ...
        if (!this.player.isNaga()) {
            ...
            this.outx(`[legs] and pinning you in that prone, separated position`);
        } else
            this.outx(
    ...
    private loseVSDriderAndGetFuckedANDAnalImpreggegity(): void {
        ...
        if (this.player.lust > 99)
            this.outx(
                `Unable to resist the desire coursing through your body, you strip off your [armor] and start stroking [eachcock], displaying it in the hope that it will draw the drider's attention, while at the same time just trying to get yourself off and attain release.`,
            );
        else {
            this.outx(
                `You slump down, too beat up to mount an effective defense, let alone stay up on your [feet].  The drider skitters over to you and effortlessly peels you out of your [armor], exposing your `,
            );
        ...
        this.outx(
            `You look at her with fear, but your [hips] start to twitch against her, rubbing your ${this.player.cockHead(
                x,
    ...
    public driderPregVagBirth(): void {
        ...
        if (this.player.biggestTitSize() >= 2) {
            this.outx(
                `One drider girl cautiously makes her way over to you.  Her legs tickle your stomach as she climbs up to one of your [breast].  Grasping the flesh tightly in her tiny hands she begins to suckle at your [nipple].`,
            );
    ...
    private buttFuckADriderOhBaby(): void {
        ...
        this.outx(
            `Now that she's calmed down, you give her a hard shove, putting her on her drider-belly so you're not nearly thrown off her every other moment.  With that done, you put your hands on her human back, pushing her forward and exposing her human-like bubble-butt, seated just above where woman meets spider. Greedily, you pull her cheeks apart, revealing the tiny star of her puckered asshole.  You pull your ${this.cockDescript(
                x,
            )} out of your [armor], already hardening from the thought of you pounding her tight little backdoor.\n\n`,
            false,
        );
        ...
        this.outx(
            `Finally done, you pull out of the drider, collapsing on her spider-back with a contented sigh.  Completely insensate after the anal ravaging you just gave her, the drider poses no threat as you leisurely gather [eachcock] back into your [armor] and lower yourself off her cum-soaked abdomen.  You give her a final, playful ass slap as you dismount before heading back to camp.`,
        );
