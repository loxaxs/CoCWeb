...
export class Salon extends BaseContent implements TimeAwareInterface {
    ...
    private hairDresserGreeting(): void {
        ...
        this.outx("   \"<i>I apologize for my daughters,</i>\" she says as she presses herself against you.  \"<i>They're a bunch of brainless hussies for the most part.  My name is Lynnette, and welcome to my salon!  You want your hair cut or lengthened?  We've got you covered, and we don't ask for much - just a shot of cum.");
        if (this.player.cockTotal() == 0) {
            this.outx("  You look like you don't got any of your own, but we've got glory holes in the back if you need to get some.  Just don't swallow too much, ok?</i>\"\n\nShe shows you to the back of the cave, which is boarded-up.  There are about 20 holes in boards, and most are empty.  While you watch, a few new dicks slide in, and just as quickly the goblin's daughters commence sucking and fucking them.  There are only a few you could take a crack at - do you blow one (and if so which one)?");
        } else {
            this.outx(
            ...
            this.outx("In the very back of the salon you can see a boarded-up wall with holes cut in it, some of which are currently plugged by various monstrous penises.  Do you let the goblin blow you, or do you go suck your payment from one of them?");
        }
    ...
    private hairDresserRepeatGreeting(): void {
        ...
        // Standard repeats
            ...
            if (this.player.cockTotal() == 0) {
                this.outx("I see you still can't make payment for our services on your own.  No worries, the glory holes in the back are pretty popular with the demons and monsters, just go back there and catch some spooge and we'll see about helping with your hair, ok?</i>\"\n\n(There are a number of dicks in the glory hole, which do you want to deal with (if you're willing at all)?");
            } else {
                this.outx(
    ...
    private gloryholeMinotaur(): void {
        ...
        this.outx("your [chest] as cum rains down upon you. By the time his orgasm stops and his dick goes limp, your face and [chest] are covered in a thick layer of spooge.\n\n");
        this.outx(
    ...
    private goblinHairDresserFacefuck(): void {
        ...
        this.outx(".  She slips her tongue down your urethra, and arches her back, popping the straps on her dress and letting her oversized tits engulf your shaft.  Milk sputters and dribbles from the lactating goblin, lubricating her breasts and hands as she pleasures every inch of you.\n\n");
        this.outx("It's impossible to hold back while receiving such expertly given stimulation, and you blow your load, bulging her cheeks out like a squirrel's.");
        if (this.player.cumQ() >= 250)
            this.outx(" She can't hold it all and suddenly starts swallowing as runnels of it escape her nose and a wave of it rolls down her lips.");
        this.outx("  In time it ends, and she pops back, spitting most of the cum into a funnel.  It washes down a pipe and you have to wonder if there's some horny goblin girl at the other end with her cunt spread wide.");
    ...
    private dyeMenu(): void {
        this.spriteSelect(38);
        this.outx("", true);
        this.outx("Lynnette pulls open a cabinet in the corner, displaying a wide array of exotic hair-dyes.  Which kind do you want?");
        this.menu();
    ...
    private minotaurCumBukkakeInSalon(): void {
        ...
        this.player.minoCumAddiction(10);
        this.player.slimeFeed();
        this.outx("As the salon door swings closed behind you, a familiar, heavenly scent catches your nose and wicks into your brain, flooding you with need and molten-hot lust.  Lynnette saunters over with her lips slightly pursed and her body jiggling, but you brush her aside.  She's completely forgotten as you close in on the source of your olfactory bliss.  Your sigh dreamily while your pupils slowly dilate from the familiar chemicals pounding through your bloodstream");
        ...
        this.outx("You start moaning in drug-induced bliss, but your vocalized pleasure is interrupted by the squelching slurp of the softening shaft being pulled from your dick-puckered lips.  It drips a rope of cum over your mouth and chin as it pulls free from the wall, leaving behind one vacancy among the swarm of ready minotaur dicks.  You lick up your stud's leavings and purr in bliss, reaching through the hole to cup the departing minotaur's balls teasingly.  He grunts and walks out of your grip – sated for now.  You curl your fingers into a come-hither gesture, retract your arm through the sweat-lubricated glory-hole, and wait for one of the other minotaurs to come over.\n\n");

        this.outx("The beast who kept your left hand so busy repositions himself at the now-vacant opening, and you decide to reward him for moving so quickly.  You lick the last of the salty cream from your lips and muse that he isn't the only one getting a reward, but the monstrous cow-man doesn't need to know that.");
        if (this.player.biggestTitSize() >= 2) {
            ...
            if (this.player.biggestTitSize() < 6)
                this.outx("Even so, you can't quite get your breasts the entire way around him, so you make up for it by pressing it harder into you with your busy hands.  ");
            this.outx("Runnels of pre cover the shaft and squish wetly between your tits, turning your body into a slip-n-slide that reeks of hot, sticky minotaur sex.");
        } else {
            this.outx("You crush the member tightly against your chest, smearing your torso with the copious pre until you're like a hot, wet slip-n-slide of minotaur sex.  You make up for it by wrapping your arms around his prodigious thickness and squeeze him tightly with your hands, stroking him off with your whole body with enough tightness to make the poor mino' think he's in some poor adventurer's asshole.");
        }
        this.outx("\n\n");
        ...
        this.outx("you're giving out.  In such a position, you're given the perfect view to watch as your strokes draw forth large bubbles of pre, and before you can lose your high, you latch onto the minotaur's vulnerable urethra and suck, tonguing in wide circles around it since you can't open wide enough to accommodate his flare.  Of course, all the attention just makes him flare wider, not just at the tip, but through the whole shaft.  ");
        if (this.player.biggestTitSize() >= 2)
            this.outx(
        ...
        this.outx("You pull off and bounce faster, lost to your lust and the haze of sex-musk permeating the air, intent on seeing just how much this huge stud can spray onto you.\n\n");
        ...
        if (this.player.hasVagina())
            this.outx(" while the animal part of your brain hopes it makes you pregnant with an equally girthy son");
        this.outx(".\n\n");
        // ADD PREG CHECK
        // Preggers chance!
        this.player.knockUp(
        ...
        if (this.player.analCapacity() < 80) {
            this.outx("delighting in the drug-numbed pain of stretching yourself beyond your normal capacity.");
        } else if (this.player.analCapacity() < 140)
            this.outx("delighting in the feeling of perfect fullness.");
        else
            this.outx("delighting in realizing that you could take far larger than even this virile specimen!");
        // (buttchange here: 90)
        ...
        if (!this.player.hasCock())
            this.outx("drags through your body, touching sensitive nerves you didn't even know you had until you cum, shuddering and shaking like a wanton whore.");
        else
            this.outx(
    ...
    private minotaurSalonFollowUp(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00142] == 0) {
            ...
            // text goez here
            this.outx("Lynnette slaps your face, waking you from your stupor.  What?  Where are you?  You look around and realize you're strapped into a barber's chair and caked with white goop, but why?\n\n");
            this.outx("The goblin answers before you can vocalize your query, \"<i>Baby, you're so cum-hungry you make my daughters look like chaste virgins!  I haven't seen anyone go to town on minotaurs like that since my mother passed away, Marae guide her soul.  Normally we don't have that much use for the minotaurs outside of a bit of recreational drug-play, but you milked out so much cum that we can start selling it!  Isn't that great!?</i>\"\n\n");
            this.outx(
    ...
    private mudFacial(): void {
        ...
        this.outx("With that finished, the crowd of busty, green-skinned women disperses to leave you in peace.  Time drags on, but eventually the mud hardens and cracks.  As if on cue, tiny hands emerge with wet rags to scrub your face clean.  Once they've finished, you feel like a whole new you! (+10 femininity)");
    ...
    private sandFacial(): void {
        ...
        this.outx("After a while the goblin girls come back and clean the stuff from your face. (+10 masculinity)");
