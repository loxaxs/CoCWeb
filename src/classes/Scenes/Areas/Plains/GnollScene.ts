...
export class GnollScene extends BaseContent {
    ...
    public getRapedByGnoll(): void {
        ...
        if (!this.player.hasCock()) {
            if (this.player.hasVagina()) {
                this.outx(
                    `The gnoll looks a little disappointed at the void between your legs.  "<i>Aw, I was hoping for something substantial,</i>" she titters.  That doesn't stop her from hefting her engorged clit-dick and slapping its tip onto the entrance of your [vagina].  With one jittery lurch forward, she shoves her clit up inside you, her pubic mound mashing up against your [clit].`,
                );
        ...
        if (this.player.biggestTitSize() >= 3)
            this.outx(
                `  Your ${this.player.allBreastsDescript()} bounce up and down as the gnoll grinds her anatomy into yours, slick with sweat under the hot sun.  Your [nipples] tighten and flush as your whole body submits to the rough fuck administered by the hyena girl.`,
            );
        // (if cockTotal>0)
        if (this.player.cockTotal() > 0) {
            this.outx(
    ...
    private dickDownGnollClit(): void {
        ...
        if (this.player.balls > 0)
            this.outx(
                `  It doesn't take long before your [balls] begin twitching, pumping cum down the length of your encased cock.`,
            );
        this.outx(
        ...
        if (GnollScene.rand(2) == 0) {
            ...
            if (
                ...
                if (
                    ...
                    this.outx(
                        `  And the next, until all of your [cocks] are inside her wide-spread ass.`,
                    );
                this.outx("\n\n");
            }
            ...
            // Med CumQ):
                ...
                this.outx(
                    `Gripping her sides tightly, you let out a bellowing moan that echos through the grasslands, [eachcock] swelling noticeably as you pump thick ribbons of spunk into the gnoll's innards`,
                );
                if (this.player.cockTotal() > 1)
                    this.outx(
            ...
            // (High CumQ):
                ...
                this.outx(
                    `You bear down on the limber hyena girl with all your force, groaning through clenched teeth as [eachcock] distends with the pressure of your virile load.  Her puckered anus stretches around the swell of your seed, and she lets out a shuddering, laughing moan as her belly begins to distend with your thick jism.  The involuntary spasms of her rectum milk your ${this.cockDescript(
                        x,
            ...
            this.outx(
                `Satisfied, you leave the gnoll to her pleasures, gather your [armor], and head back to camp.`,
            );
        }
        this.player.orgasm();
        this.cleanupAfterCombat();
    ...
    private takeGnollClit(): void {
        ...
        this.outx(
            `When you can get your feet under yourself again, you stand up, letting the now-shrunken clitoris fall out of your [vagina] with a wet plop.  You leave her there on the sun-caked ground and head back to camp.`,
        );
        this.player.orgasm();
        this.cleanupAfterCombat();
    }
    ...
    private yoDawgHyenaBallz2(): void {
        this.outx("", true);
        this.outx(
            `Using the distraction, you roll onto your belly, crawling towards your [armor], hoping to use the distraction to make an escape.  Baring your [butt], however, proves to be a mistake, as the gnoll fixates on the wobbling orbs, lunging desperately.  She lands atop you, her paws pinning your head and shoulders to the ground as the warmth of her impatient shaft slides between your cheeks, her new scrotum slapping wetly against `,
        );
        if (this.player.balls > 0) this.outx(`your own [balls]`);
        else this.outx("your sweat-slick thighs");
        this.outx(
            `.  The amazon wastes no time, guiding her monstrous clit to your [asshole] with gasping pleasure, thrusting the barrel-like pseudo-cock deeply inside your nethers, drawing a cry of penetration from your lips.  The plush interior of your anus parts before her energized clitoris, her cunt flowing with warm lubrication so heavily that its deluge inundates your bowels like a flood of pre-cum.`,
        );
        ...
        this.outx(
            `Her bucking pauses for a split-second and you can feel her fuzzy balls throbbing against your [butt], the stimulation of her fucking filling them with fresh loads, eager to spill into your violated hole.  But, without a passage to let loose the torrent of her sperm with, the gnoll's balls merely swell with unspent passion, lewdly quivering against`,
        );
        if (this.player.balls > 0)
            this.outx(
