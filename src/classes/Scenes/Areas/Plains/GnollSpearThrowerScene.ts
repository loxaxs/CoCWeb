...
export class GnollSpearThrowerScene extends BaseContent {
    ...
    public gnoll2Encounter(): void {
        ...
        if (this.flags[kFLAGS.HAVE_ENCOUNTERED_GNOLL_PLAINS] == 0) {
            ...
            this.outx("Waves of long, dry grass spread before you in gentle, rolling hills.  Your mind begins to wander, staring at the featureless expanse as the waist-high grass rustles against your body.  It seems like there is nothing but peace to be found here below the expansive blue sky and the dry grass.\n\n");

            this.outx("The only warning you have is when your ears catch the barest of whispers, giving you time to jump to the side, just as a long wooden javelin whistles through the air where your head would have been.  You whirl around to see a massive hyena woman standing a few yards away.  The tall, muscular woman ");
            ...
            this.outx("the tan of her spotted pelt gleaming golden in the sun.  Your roaming eyes register that the softer tan of her belly covers her large breasts and slides down below her loincloth.\n\n");

            this.outx("A growl snaps your eyes up to the gnoll's face, seeing black lips pulled back from ivory fangs.  Dark, dominant eyes pierce you as the hyena slowly starts to circle you.  She sniffs at the air, getting your scent, before squaring off with you.  Powerful muscles ripple under her fur as she prepares to attack.  You have clearly trespassed on her lands and this feral lady intends to punish you for it.");
        }
        // <Subsequent Encounters>
        else {
            this.outx("You barely register the waves of long, dry grass that spread before you in gentle, rolling hills.  Your nerves grow taut as you stare at the featureless expanse as the waist-high grass rustles against your body, knowing you have strayed into Hyena territory.  It seems like there's nothing but peace to be found here, below the expansive blue sky and the dry grass, but you are all too aware that such things are deceptive.\n\n");

            this.outx("You strain your ears to catch the smallest sounds.  Something seems off about the sound of the grass waves.  You whirl around to see a massive hyena woman rising out of the grass, holding a javelin in her spotted paw.  The tall, muscular lady ");
    ...
    public hyenaSpearLossAnal(): void {
        ...
        if (this.player.isNaga()) {
            this.outx("Panting from your struggles, you feel the tip of your tail pulled back and stretched out.  Bleary, you crane your head back just in time to see the gnoll pull out a black javelin and thrust it down at the tip of your tail.  The end explodes into a ball of goo, pinning your tail to the ground and holding you taut.  You thrash weakly, unable to get enough leverage to break the javelin's hold, leaving you exposed and vulnerable.\n\n");
        }
        ...
        // <Paragraph for Non-Taurs>
            ...
            this.outx("Panting from your struggles, you look down in time to see the gnoll twine a second leather strap around your ankle, tying it to the base of one of the javelins.  You attempt to keep her from securing your second ankle when a spotted paw reaches up, ");
        ...
        // TAURS!
            ...
            this.outx("Panting from your struggles, you look down in time to see the amazon tie a length of leather cord around one hind ankle.  She stands up, tugging at the cord and demands that you lift your leg.  You refuse, preparing to deliver a devastating kick to her torso when she reaches one spotted paw forward, ");
            if (this.player.balls > 0)
                this.outx(`clamping onto your ${this.sackDescript()} and squeezing until `);
            else if (this.player.hasVagina())
                this.outx(`grabbing your ${this.clitDescript()} until `);
            else this.outx(`plunging into your ${this.assholeDescript()} and pinching until `);
            this.outx("you cry out and lift your leg.  She quickly ties the leg to the post, lifted off the ground, leaving you unable to kick or move easily.\n\n");
        }
        ...
        this.outx("  A soft whimper escapes your lips when something hard and damp slides firmly along your rump.  You can hear lust-filled panting from the hyena as she grinds her massive clit against your trapped form, letting you feel the warmth of her body.\n\n");
        ...
        this.outx("Coarse fur and a muscled form press against your trapped body.  Hot breath slides along your skin moments before dozens of sharp teeth clamp on the nape of your neck.  The gnoll's muzzle holds you still, sharp teeth almost breaking your skin.  Slowly, you feel her hips pull back, her shaft leaving behind a slick coating of her body's own lubrication.  Her hard cunt slides out of your passage until all but the barrel-like tip of her remains, leaving your body to feel suddenly empty.  You can feel her lips slide along you in a smirk as she notices how much your body has surrendered to her will before she violently slams forward, filling you suddenly with her womanhood.\n\n");

        this.outx("The gnoll begins to piston into you rough and fast, losing herself in the breeding, unconcerned with your own comfort.");
        // <Heroes with Penises>
        if (this.player.hasCock())
            this.outx("  Each time the shaft slides into you, a jolt of urgent pleasure shoots through you as her thrusts slam against your prostate.");
        // <Others>
        else
            this.outx("  Each lunge from the dominant hyena seems to be at a slightly different angle and strength, ensuring that your entrance is constantly stretched and pulled in new ways.");
        this.outx("  Time loses meaning as your world narrows down to the endless thrusts of the warrior sending waves of pleasure flowing through you, building into a fog of bliss that fills your mind.  Her grunts echo in the grassland as her strange shaft fills you again and again, claiming your body as her property.\n\n");

        this.outx("The sound of her powerful body slapping against your bound form echoes through the grassy hills.  The gnoll's muzzle finally vanishes from your neck, leaving behind a perfect imprint of her sharp teeth.  Her breath moans out along the sweat of your skin in time to the thrusting of her hips as she fills your now-willing body.  Clawed hands clamp tight around your waist, pulling your hips back in time with her powerful motions.\n\n");

        this.outx("A warm weight starts to grow deep within your abused core.  A soft, needy whimpering fills the air and it takes some time before you realize it is being dragged from your mouth each time the thick shaft plows into you.  Suddenly, pleasure crashes through your body and mind as orgasm suddenly explodes within you.  ");
        // <Male>
        if (this.player.hasCock())
            this.outx(
        ...
        this.outx("With a grunt, the hyena pulls away from your trapped form, filling the air with the scent of the hyena musk that now drips from your abused hole.  With one deft motion of her paw, the bindings on your hands suddenly slip free, ");
        // <All non neuters>
        ...
        this.outx("  As you slowly fade into unconsciousness from the orgasm, you see the hyena draw a finger along the tip of her cunt until the spotted fingers glisten with moisture.  Those fingers roughly rub the thick, potent fluid against your face, coating it with her scent and the knowledge of her victory.");
        // <For Slimes>
        if (this.player.lowerBody == LOWER_BODY_TYPE_GOO)
            this.outx("  Even as your eyes slide closed, you see the hyena kicking open the circle of dust.");
        this.outx("  The last thing you hear before blackness overtakes you is the barking laugh of the hyena as she leaves her newest conquest to sleep in the fields of grass.");
        this.player.orgasm();
        this.dynStats("sen", 2);
    ...
    public hyenaVictory(): void {
        ...
        this.outx(" to fight further.  One spotted paw holds tight to the shaft while the tawny warrior slowly falls to her knees, the will to fight completely gone.  Her head bows to you in submission as you slowly approach the defeated hyena.");
        let vagoo;
    ...
    private hyenaVictoryRapeFellatio(): void {
        ...
        this.outx("The gnoll's head presses forward quickly as her black lips part, filling her muzzle with your length. ");
        ...
        this.outx("With her warm nose pressing hard against your hips, the amazon begins to swallow rapidly, forcing the prison around your cock to ripple.  Her long tongue curls around your member, adding to the jolts of pleasure shooting through you.  Her tail starts to wag when she tastes your pre-cum ");
        ...
        if (this.player.cockTotal() == 1)
            this.outx("Even as the most incredible sensations flow through you from the feel of her muzzle, you see one of her spotted hands drop from her pendulous breast to grip her own shaft.  Her second hand follows, sliding two furred fingers into the tip of her strange shaft as she starts to move up and down the dark flesh in time to the suckling of her muzzle.  Her dark brown eyes slowly slide closed in bliss as she pleasures herself while servicing the shaft buried deep within her maw.\n\n");
        // <Two Cocks>
        ...
        if (this.player.totalCocks() > 2) {
            ...
            this.outx("free member.  Her powerful grips feel like a vice on the twin members as she begins to slide her paws along two of your shafts.  Moving in time to the rippling of her throat, the hands try hard to match the flood of sensations radiating from her muzzle.  Her own 'member' throbs, untouched, as she loses herself in trying to pleasure you.\n\n");
        }

        this.outx("Waves of pleasure radiate through you from the amazon's incredible skill and stamina.  It becomes hard to focus on anything but the lust flowing through your body and it takes some time to realize that the whimpering noise filling the air is coming from your own mouth.  ");
        // <Cock 0 is 7\" or greater>
        if (this.player.cocks[x].cockLength >= 7)
            this.outx(
        ...
        this.outx("The gnoll starts to growl, the deep sound vibrating through your very core.  The lips lock around your cock, starting to suckle hard and fast, pushing you over the edge.\n\n");
        ...
        if (this.player.cocks[x].cockLength >= 7) {
            ...
            this.outx("  You feel your knees weaken as her muzzle works harder and faster, trying to drain you of every drop.  Her paws wrap around your waist and powerful arms lift you and lay you on the ground as that talented muzzle continues to milk you dry.\n\n");
        }
        // <Cock 0 is less than 7\">
            ...
            this.outx("  You feel your knees weaken as her muzzle works harder and faster, trying to drain you of every drop.  He paws wrap around your waist and powerful arms lift you and lay you on the ground as that talented muzzle continues to milk you dry.\n\n");
        }
        this.outx(
    ...
    private victoryRapeHyenaCunnilingus(): void {
        ...
        this.outx("On impulse, you command the hyena to use that eager muzzle on you.  Instantly, her paws clutch you around the waist and lift, hefting you high into the air.  A girlish squeal escapes your lips as you find yourself dangling above the warrior.  The gnoll's powerful arms hold you steady as you squirm almost ten feet off the ground.  The amazon ignores all further commands as she lowers your vulnerable slit directly above her nose.\n\n");
        ...
        this.outx("You are so lost in the building pleasure that when the licking suddenly stops, a howl of need is torn from your lips.  You start to squirm, desperate for the tongue to return, when you feel yourself spun rapidly around before the hyena's warm nose presses lightly against your slit.  Looking down the length of your body, you see the twinkle in the dark brown eyes.  Her long pink tongue lolls out the front of her muzzle.  The amazon's hot breath slides over your dripping slit.\n\n");
