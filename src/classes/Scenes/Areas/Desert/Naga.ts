...
export class Naga extends Monster {
    ...
    protected nagaPoisonBiteAttack(): void {
        ...
        this.outx("The naga strikes with the speed of a cobra, sinking her fangs into your flesh!  ");
        if (this.player.findStatusAffect(StatusAffects.NagaVenom) < 0) {
            this.outx("The venom's effects are almost instantaneous; your vision begins to blur and it becomes increasingly harder to stand.");
            ...
            this.outx("The venom's effects intensify as your vision begins to blur and it becomes increasingly harder to stand.");
    ...
    protected nagaConstrict(): void {
        this.outx("The naga draws close and suddenly wraps herself around you, binding you in place! You can't help but feel strangely aroused by the sensation of her scales rubbing against your body. All you can do is struggle as she begins to squeeze tighter!");
    ...
    protected nagaTailWhip(): void {
        ...
        if (this.player.findPerk(PerkLib.Evade) && Naga.rand(6) == 0) {
            this.outx("You see her tail whipping toward you and evade it at the last second. You quickly roll back onto your feet.");
        } else if (
            ...
            this.outx("You see her tail whipping toward you and jump out of the way at the last second. You quickly roll back onto your feet.");
        } else {
            this.outx("Before you can even think, you feel a sharp pain at your side as the naga's tail slams into you and shoves you into the sands. You pick yourself up, wincing at the pain in your side.");
            let damage = 10;
