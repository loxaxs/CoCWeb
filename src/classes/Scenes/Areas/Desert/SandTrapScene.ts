...
export class SandTrapScene extends BaseContent {
    ...
    private dickwieldersLoseToSandTarps(): void {
        ...
        if (this.player.hasVagina())
            this.outx(
                `  Ignored entirely, your [vagina] quivers and orgasms in tandem, flexing and wetting fruitlessly against the dry water pressing against it.`,
            );
    ...
    public birfSandTarps(): void {
        ...
        // Female:
            ...
            this.outx(
                `  You roll your eyes to the sky and moan, your [vagina] moistening as you push out the egg.`,
            );
    ...
    private useSandTarpsHands(): void {
        ...
        if (this.player.gender == 1) {
            ...
            // Three cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in hard, eager concert with your [cock].  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as  one of its hands clutching your ass releases and snakes back around to take hold of your ${this.cockDescript(
                        2,
            ...
            // Four cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your three other, disregarded cocks bob in hard, eager concert with your [cock].  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as both of its hands clutching your ass release and snake back around to take hold of your ${this.cockDescript(
                        2,
            ...
            // More than four cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks bob in hard, eager concert with your [cock].  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as its two hands clutching your ass snake back around to take hold of your ${this.cockDescript(
                        2,
                    )} and ${this.cockDescript(
                        3,
        ...
        // Herm:
            ...
            // hree cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in eager concert with your [cock].  You gasp as the trap slows down momentarily to reach both hands clutching your ass back around to take hold of your ${this.cockDescript(
                        1,
                    )} and ${this.cockDescript(
                        2,
            ...
            // More than three cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks begin to harden in eager concert with your [cock].  You gasp as the trap slows down momentarily to reach both of its hands clutching your ass back around to take hold of your ${this.cockDescript(
                        1,
                    )} and ${this.cockDescript(
                        2,
                    )}.  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking three of your cocks whilst fingering you in rhythm.  You laugh into the sky with an almost hysterical edge at how mindbogglingly good getting a quadruple handjob feels, and the trap giggles slightly as well despite itself.  Hazily you wonder if it is too much to wish that this creature, with its excellent wrist action, had just one or two more hands to its name.`,
    ...
    private rideDatSandTarpLikeIts1999(): void {
        ...
        this.outx(
            `\n\n"<i>You like that, don't you, sand sissy?</i>"  It is breathing heavily but it still won't look into your face. "<i>Look me in the eye!</i>" As it finally does so you push your oil-covered fingers into its mouth and it moans around them as you swab its tongue and cheeks with its own grease.  You press your body against it, your ${this.allBreastsDescript()} pushing into its own flat chest; it is powerless to resist you as its own pheromones take effect upon it, and you slowly push it backwards onto the flat of its back on the sloping sand.  You sit your moist [vagina] at the base of its pseudo-cock and then slowly lead yourself back, luxuriating in pushing your [clit] up this oily slide.   It moans and shifts itself upwards needily, but you tut mockingly and stop your slow slide inches away from its tip.`,
        );
        this.outx('\n\n"<i>Ask for it.</i>"');
        this.outx(
    ...
    private nagaThreesomeWithSandTrap(): void {
        ...
        // Female:
            ...
            this.outx(
                `\n\nYou press your moistening [vagina] against the creature's lips.  Its eyes still far away, the sandtrap opens its mouth and pushes its soft tongue into your cleft.  It explores your labia and hole before turning its attention to your [clit], circling it with gentle pressure whilst giving it the occasional faintest of flicks.`,
            );
            // [Squirtr, jotun of flooding:
            if (this.player.wetness() < 4)
                this.outx(
                    `  Its gentle worship of your [vagina] soon has you streaming rivulets of girlcum from your oversexed hole, dribbling down the sandtrap's face as you eagerly press yourself down for more.`,
                );
            this.outx(
