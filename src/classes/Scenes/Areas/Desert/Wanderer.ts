...
export class Wanderer extends BaseContent {
    ...
    private wandererStayHuman(): void {
        ...
        this.outx(" is right, my soul is immortal and not to be sacrificed so lightly.  Why don't we stick to our original agreement another decade and mull it over then?</i>\"\n\n");
        this.outx(
    ...
    private wandererGoDemon(): void {
        ...
        this.outx("Marcus raises an eyebrow at the exchange, but smiles as his demonic lover returns to his side.  Lucia winks again, and huge wings explode from her back.  She grabs Marcus, who bleats in surprise, and lifts off, flying away with her prize to her lair.");
    ...
    private wandererDemonEpilogue(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.WandererDemon) >= 0) {
            ...
            if (this.player.statusAffectv1(StatusAffects.WandererDemon) == 0) {
                ...
                this.outx("She steps away and blows a kiss as her wings unfurl.  With a powerful downstroke she scatters sand everywhere, forcing you to throw an arm in front of your eyes.  When the debris settles, she's gone.\n\n");
                this.dynStats("lus", 5);
            ...
            // Second Encounter
                ...
                if (50 < this.player.spe + Wanderer.rand(60)) {
                    this.outx("You handily catch a small potion vial.  When you look up, she's gone.\n\n");
                ...
                // Drop it
                    ...
                    this.outx("You dive for the falling bottle, but miss, and it shatters into the sands, the fluids wicking away nearly instantaneously.");
                    this.doNext(this.camp.returnToCampUseOneHour);
                }
            }
        }
        ...
        if (this.player.findStatusAffect(StatusAffects.WandererHuman) >= 0) {
            ...
            if (this.player.statusAffectv1(StatusAffects.WandererHuman) == 0) {
                ...
                if (this.player.cor < 33)
                    ...
                    this.outx("You blush crimson as you swear you see Lucia look right at you and wink.");
                else
                    this.outx("You openly leer at the crude display, whistling lewdly at the blissful couple.  Marcus looks up and gives a cocky smile, while Lucia licks her lips and gives you a predatory grin.");
