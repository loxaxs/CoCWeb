    ...
    private walkingDesertStatBoost(): void {
        ...
        if (Desert.rand(2) == 0) {
            ...
            if (Desert.rand(2) == 0 && this.player.str < 50) {
                this.outx("The effort of struggling with the uncertain footing has made you stronger.");
                this.dynStats("str", 0.5);
            }
            // Toughness
            else if (this.player.tou < 50) {
                this.outx("The effort of struggling with the uncertain footing has made you tougher.");
