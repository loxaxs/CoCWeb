...
//  */
    ...
    private drinkFountainEndowment(): void {
        ...
        if (Exgartuan.rand(3) == 0 && this.player.totalCocks() > 0) {
            this.outx(
                `\n\nYour [cocks] feels tighter inside your ${
                    this.player.armorName
            ...
            // Medium corruption characters
                ...
                this.outx(
                    `Your orgasm spreads through the demon like a wave.  You briefly wonder if it's the demon causing this to feel so good, or your own corrupt desires.  The thoughts are scattered by the feeling of a fat gob of spooge splattering over your [face].  You blink your eyes clear in time to see the fat, pulsating tip of your ${this.cockDescript(
                        0,
                    )} hovering in front of your face.  Your urethra spreads wide, launching another spurt and splattering it into your [hair].\n\n`,
                    false,
                );
                this.outx(
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            // (Taunts Male Foes -enemy lust)
                ...
                switch (select) {
                    ...
                    case 2:
                        this.outx(
                            `Your [cock] squirms around, pushing your ${
                                this.player.armorName
    ...
    public exgartuanArmorShift(): void {
        ...
        if (this.player.armor == this.armors.BEEARMR) {
            ...
            this.outx(
                `Your leather armor shifts, pressing tightly against your upper [legs] and molding itself around your ${this.cockDescript(
                    0,
            ...
            this.outx(
                `You begin to clench your fists as your steel platemail heats up around your [legs] and crotch. Slowly it begins to press itself against your ${this.cockDescript(
                    0,
            ...
            this.outx(
                `You begin to feel your rubber outfit compressing itself against your upper [legs] and ${this.cockDescript(
                    0,
                ...
                // (Herms + Balls)
                    ...
                    this.outx(
                        ` skin of your outer lips is engorged and ready, but with your hands so focused on your ${this.cockDescript(
                            ...
                            0,
                        )} to feel.  The closest it gets to pleasure is the sensation of your [sack] slapping against it with the steady rhythm of your masturbation.  If only you had taken care of yourself earlier!  You might have had enough control over your rebellious tool to let a hand attend to your OTHER needs.\n\n`,
                        false,
                    );
                }
            }
    ...
    private exgartuanBulgeTortureII(): void {
        ...
        if (this.player.biggestTitSize() >= 2 && this.player.bRows() == 1)
            this.outx(
                `  Your quest begins squarely on your pair of [chest], your mitts feverishly groping and tugging away in the hope of finding any sanctuary from your encroaching lust.  Unable to extract any meaningful solace from your magnificent mounds, your sights set on your ${this.nippleDescript(
                    0,
                )}s.`,
            );
    ...
    private boobGartuanSURPRISE(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            this.outx(
                `Your warning turns to moaning as the imp's hands quickly latch onto your [chest], discarding the walking stick and golden idol to the hard floor.  "<i>I don't need any of your words of wisdom, ${
                    this.player.short
    ...
    private boobgartuanSurprise3(): void {
        ...
        // [if occurrence ≥8]
            ...
            this.outx(
                `Before another thought can cross your mind, your [chest] fly up and smack you in the gob! "<i>${
                    this.player.short
