...
//  */
                        ...
                        if (this.model.time.hours % 9 == 0) {
                            ...
                            if (Exgartuan.rand(3) == 0) {
                                ...
                                if (Exgartuan.rand(2) == 0)
                                    this.outx(
                                        `You feel warm and tingly, good all over.  Wait a second, your hands are playing with your [breast].  You yank your hands away, but it only makes Exgartuan laugh with demonic pleasure!`,
                                    );
                                else {
                                    this.outx(
                                        `Your hands knead and caress your [breast], eagerly touching every inch of soft flesh.  You gasp when you realize what you're doing and pull them away`,
                                    );
    ...
    private drinkFountainEndowment(): void {
        ...
        if (Exgartuan.rand(3) == 0 && this.player.biggestTitSize() > 1) {
            this.outx(
                `\n\nYour ${this.allBreastsDescript()} balloon, each growing about four bra-sizes larger... they feel so... jiggly and sensitive.  Even your nipples seem to grow with them!  Your [armor] feels tighter than ever!`,
                false,
            );
        ...
        if (Exgartuan.rand(4) == 0 && this.player.hasVagina()) {
            this.outx(
                `\n\nYour [clit] plumps up, visibly parting your lips even when you aren't turned on.  It probably `,
                false,
            );
    ...
    private exgartuanInfestTits(): void {
        this.outx(
            `\n\nYour ${this.allBreastsDescript()} jiggle as they grow MUCH larger, turning into obscene mounds that shake with every motion of your body.  All your [nipples] puff up with them, gaining volume to match their new, larger homes.  They feel hot and ache to be touched.`,
            false,
        );
        this.temp = this.player.breastRows.length;
        while (this.temp > 0) {
        ...
        this.outx(
            `\n\n"<i>Yes I am,</i>" mutters Exgartuan, spurting a trickle of milk from your [nipples] for emphasis, "<i>and you had better take me back to that lovely camp I can see in your memories and give me a nice long massage.</i>"`,
            false,
        );
        this.outx(
            "\n\nWell now... this was certainly unexpected.  Perhaps there's a way to be rid of this thing?",
    ...
    public exgartuanMasturbation(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            if (this.player.cor >= 30 && this.player.cor < 60)
                this.outx(
                    `You happily remove your [armor], eager to pleasure yourself.  Your possessed [cock] throbbs happily.\n\n`,
                    false,
                );
            ...
            // high corruption characters
                ...
                this.outx(
                    `Happily giving in to the desires of your inner demon, you grab hold of your [cock] with both hands, feeling its heavy mass slowly expanding inside your tight grip. It pulsates with dark powers and corrupted lusts, tingling pleasantly as it grows to its full, erect size.  You pet it gently, soothing the demon inside with expert touches that fill the both of you with explosions of pure delight.  Each of the hundreds of nodules covering its surface grow erect in a wave, filling up as you become more and more turned on.\n\n`,
                    false,
                );
                this.outx(
                ...
                if (this.player.biggestTitSize() >= 5)
                    this.outx(
                        `your hands smashing your ${this.allBreastsDescript()} around the [cock] and vigorously titfucking it.`,
                    );
                else
                    this.outx(
                        `your hands repositioning your [cock] so it lays against your chest.`,
                    );
                this.outx(
        ...
        // TITURBATION
            ...
            this.outx(
                `Both hands rise unbidden and begin to caress your [breast].  They slide over every sensitive inch of `,
            );
            if (
            ...
            this.outx(
                `, pausing to gently squeeze and caress any particularly sensitive spots.  Soft sighs escape your lips from the self-imposed pleasure-assault.  Your body relaxes totally, slouching down against a rock while you continue to happily play with your ${this.allBreastsDescript()}.  The entire time your hands never touch one of your [nipples], merely circling them from time to time, making you arch your back in need.\n\n`,
                false,
            );
            this.outx(
            ...
            this.outx(
                `At last, fingers wrap themselves about your [nipples], squeezing them gently and forcing happy gasps from your mouth.  `,
            );
            ...
            if (this.player.biggestLactation() > 1)
                this.outx(
                    `As you calm down you realize your [nipples] are dribbling streams of milk, and judging from the pools of whiteness in the soil, you turned into quite the little milk-sprinkler.  `,
                );
            this.outx(
    ...
    public exgartuanBored(): void {
        ...
        if (
            ...
            if (select == 0) {
                ...
                else this.outx(`in your [balls]?`);
                this.outx(
                    "  Well you'd better relieve me soon or I'll make sure your body finds someone who does!</i>\"",
                );
            } else if (select == 1) {
                this.outx(
                    `A tiny voice mutters, "<i>How can you live with so few orgasms?  We need some quality time, [name].  You've got a LOT of tension building up...</i>"`,
                );
            } else if (select == 2) {
                this.outx(
                    `You feel a stirring inside your [armor] as it rubs against the material.  A muffled voice says, "<i>Hey!  Don't forget me!  I need some air!</i>"`,
                );
            } else if (select == 3) {
                this.outx(
                ...
                this.outx(
                    `You feel your [cock] slowly expand and contract, air escaping its urethra and tickling your nether regions.  Did... did your dick just sigh?  Your demon is growing impatient.`,
                );
            else if (select == 5)
                this.outx(
                    `Your [armor] suddenly bulges, a stifled voice picking up along with it, "<i>There has to be a hole out there for me to fuck.  A mouth, a cunt... stop slacking off and get on it!</i>"`,
                );
            else if (select == 6) {
            ...
            switch (select) {
                case 0:
                    this.outx(
                        `You feel an ominous jiggling in your [breast] as the demon inside you stirs back to wakefulness.  The sound of a yawn being muffled by your [armor] confirms it.`,
                    );
                    break;
                case 1:
                    this.outx(
                ...
                case 3:
                    this.outx(
                        `Suddenly your [chest] feel as if they trying to force their way off your chest.  The strange motions are accompanied by some loud moaning, as if they are stretching awake.  Looks like the delightful peace and quiet has ended.`,
                    );
                    break;
                case 4:
                    this.outx(
                        `Your arms suddenly hug against your [chest] of their own accord, the squeeze filling you with a hint of warmth.  The demoness is awake and filling you with longing to be touched and teased.`,
                    );
                    break;
                case 5:
                    this.outx(
                        `Your [chest] fidget ominously, a muffled female voice piping up, "<i>No cloth, metal, latex, or gel can protect you from me, champion.  Give in and caress these cans!</i>"`,
                    );
                    break;
                case 6:
                    this.outx(
                        `The silent alone time you've been enjoying is coming to an end as the demoness dwelling within your bosom shifts in your [armor].  She wastes no time in stuffing you full of chest-focused temptations.`,
                    );
                    break;
                case 7:
                    this.outx(
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            // [FETISH CULTISTS TURNED ON BY DEMON-COCK]
                ...
                switch (select) {
                    ...
                    case 1:
                        this.outx(
                            `Openly touching herself, the fetish cultist's gaze never leaves your crotch, locked onto the outline of Exgartuan in your [armor].  What a slut.`,
                        );
                        break;
                    case 2:
                        this.outx(
            ...
            // (+Lust in combat) for girls
                ...
                switch (select) {
                    case 0:
                        ...
                        if (this.player.cor < 50)
                            this.outx(
                                `  You glance down at the sensitive bulge in your [armor] and sigh.  Damned demons.`,
                            );
                        break;
                    case 1:
                        this.outx(
                    ...
                    case 6:
                        this.outx(
                            `Pleasure begins to radiate through your being, suddenly.  You snap back to your senses in time to see your hands stroking the bulge in your [armor], answering to the whims of an unholy force.`,
                        );
                        break;
                    case 7:
                        this.outx(
                    ...
                    case 8:
                        this.outx(
                            `Tight loving assholes and gaping vaginas, slick long red tongues and breasts like fine china.  Succubi and the hot sexings they bring, these are a few of your favorite things!  ...Wait, what?  Was that musing your own?  And why are you absently stroking your [cock]?`,
                        );
                        break;
                    case 9:
                        this.outx(
            ...
            // (Taunts Male Foes -enemy lust)
                ...
                switch (select) {
                    case 0:
                        this.outx(
                            `Without any control over it, your hands undo your [armor] and reveal your [cock].  Somehow it launches into a tirade all its own, "<i>You call that a cock?  Seriously?  And do the girls actually like that?  I can't imagine why.  That's right bub, keep wilting, you've got nothing on me!</i>"`,
                        );
                        break;
                    case 1:
                        this.outx(
                    ...
                    case 2:
                        this.outx(
                            `Your [cock] squirms around, pushing your [armor] out of the way.  Exgartuan barks, "<i>Why are you bothering my host, fool?  Can't you see my magnificence?  You're nothing compared to me.  Go wank in shame and get out of our way.  We have cunts to fill.</i>"`,
                        );
                        break;
                    case 3:
                        this.outx(
                            `The waist of your [armor] expands as your [cock] flies skyward fully erect, "<i>Tremble in fear, peon! My ${Exgartuan.num2Text(
                    ...
                    case 5:
                        this.outx(
                            `Suddenly, your [armor] pitches an impossible tent, the colossal bulge pointing directly at the ${this.monster.a}${this.monster.short}.  You can only wince in discomfort as the back of your outfit pushes against you while a muffled voice taunts, "<i>How can something so insignificant remain so ANNOYING?  Your mere presence dulls the obvious radiance before you. DROP DEAD!</i>"`,
                        );
                        break;
                    case 6:
                        this.outx(
                            `Your [armor] unexpectedly opens itself of its own accord, prompting your [cock] to extend into the open air, "<i>All the chemicals, potions, and morsels in existence can't help that infinitesimal tool you possess.  The orifices of this world deserve better!  All you are accomplishing this day is their disappointment in delaying the inevitable.</i>"`,
                        );
                        break;
                    case 7:
                        this.outx(
    ...
    public exgartuanArmorShift(): void {
        ...
        if (this.player.armor == this.armors.BEEARMR) {
            ...
            this.outx(
                `The green gel-plate protecting your groin thins and presses tightly against you, molding around your [cock] in an incredibly lewd way.`,
            );
            ...
            this.outx(
                `The chainmail bikini of your indecent steel armor rearranges and bends its interlocking rings to best shape itself around your [cock], leaving very little else to the imagination.`,
            );
            this.player.modArmorName = "crotch-hugging practically indecent steel armor";
            changed = true;
        } else if (this.player.armor == this.armors.R_BDYST) {
            this.outx(
                `The thin, transparent material of your red bodysuit begins to firmly press against your groin, perfectly shaping to your [cock] and every last one of its nubs and nodules.`,
            );
            this.player.modArmorName = "crotch-hugging red, high-society bodysuit";
            changed = true;
        } else if (this.player.armor == this.armors.SSARMOR) {
            this.outx(
                `The fine silk that makes up your armor suddenly undoes itself around your crotch, exposing your [cock] to the open air. The thin strands in the air begin to re-weave themselves around your enormous member, forming a prominent new addition to your protection.`,
            );
            this.player.modArmorName = "crotch-hugging spider-silk armor";
            changed = true;
        } else if (this.player.armor == this.armors.S_SWMWR) {
            this.outx(
                `The miniscule piece of swimwear that doubles as a tent to your [cock] begins to grow and encapsulate it, molding itself perfectly to your manhood.`,
            );
            this.player.modArmorName = "crotch-hugging slutty swimwear";
            changed = true;
        } else if (this.player.armor == this.armors.FULLCHN) {
            this.outx(
                `You're taken by surprise as the binds of your chainmail begin to flatten and rearrange themselves, doing their best to match the curves of your [cock] and make its presence known.`,
            );
            this.player.modArmorName = "crotch-hugging full-body chainmail";
            changed = true;
        } else if (this.player.armor == this.armors.CHBIKNI) {
            this.outx(
                `Your chainmail bikini rearranges and bends its interlocking rings to best shape itself around your [cock], leaving very little else to the imagination.`,
            );
            this.player.modArmorName = "crotch-hugging revealing chainmail bikini";
            changed = true;
        } else if (this.player.armor == this.armors.FULLPLT) {
            this.outx(
                `You begin to clench your fists as your steel platemail heats up around your [legs] and crotch. Slowly it begins to press itself against your [cock] and match its every feature.`,
            );
            this.player.modArmorName = "crotch-hugging full platemail";
            changed = true;
        } else if (this.player.armor == this.armors.SCALEML) {
            this.outx(
                `The steel scales that make up your armor begin to flap wildly around your crotch. They bend and shift as they attempt to match the profile of your [cock].`,
            );
            this.player.modArmorName = "crotch-hugging scale-mail armor";
            changed = true;
        } else if (this.player.armor == this.armors.LTHRROB) {
            this.outx(
                `Your leather armor shifts, pressing tightly against your upper [legs] and molding itself around your [cock] to prominently display it through your robes.`,
            );
            ...
            this.outx(
                `You begin to feel your rubber outfit compressing itself against your upper [legs] and [cock], eliminating any pockets of air or wrinkles that may have existed before.`,
            );
            this.player.modArmorName = "crotch-hugging rubber fetish clothes";
            changed = true;
        } else if (this.player.armor == this.armors.ADVCLTH) {
            this.outx(
                `The layer beneath your tunic begins to compress against your [cock], highlighting every curve and nodule while lifting your package to be clearly visible beneath your outer layers.`,
            );
            this.player.modArmorName = "crotch-hugging green adventurer's clothes";
            changed = true;
        } else if (this.player.armor == this.armors.OVERALL) {
            this.outx(
                `The denim of your overalls begins to press tightly against your [cock], molding itself around your member and its every facet.`,
            );
            this.player.modArmorName = "crotch-hugging white shirt and overalls";
            changed = true;
        } else if (this.player.armor == this.armors.C_CLOTH) {
            this.outx(
                `Your clothing shifts, tightening up about your crotch until every curve and nodule of your [cock] is visible through the fabric.`,
            );
    ...
    public exgartuanLactationAdjustment(): void {
        ...
        if (this.player.biggestLactation() > 1) {
            ...
            if (Exgartuan.rand(2) == 0 || this.player.findStatusAffect(StatusAffects.Feeder) >= 0) {
                this.outx(
                    `Your nipples grow warm and sensitive, then start dripping milk into your [armor].  Exgartuan appears to be having some fun with you again...`,
                );
            ...
            // (Stops)
                ...
                this.outx(
                    `Your [nipples] tighten up.  What's that demon up to?  Realization dawns on you when you realize your ${this.allBreastsDescript()} no longer feel so 'full'.  Your lactation has stopped!`,
                );
        ...
        // (Not lactating)
            ...
            if (Exgartuan.rand(2) == 0) {
                this.outx(
                    `Your chest feels cold.  You touch your [armor] experimentally and discover a few drops of milk have leaked from your [nipples]!  The demon has made you start lactating!`,
                );
                this.player.boostLactation(this.player.breastRows.length);
            }
            // Nipple stuff
                ...
                if (Exgartuan.rand(2) == 0) {
                    this.outx(
                        `The inner surface of your [armor] arouses you as it rubs against your [nipples].  You think about it and realize they've never been like this before.  A quick check reveals each nipple has grown about a half inch longer.  Damn demons.`,
                    );
    ...
    public exgartuanBeeRape(): void {
        ...
        this.outx(
            `Walking forward with a bit of supernaturally-induced swagger, you close the remaining distance with your trembling victim, oblivious to the fact that your [armor] are rapidly disengaging themselves from your body and dropping to the forest floor.  She weakly protests, exposing her stinger, but the threat is clearly futile.  There's no way she'd touch you or your magnificent [cock] with such an inferior organ.\n\n`,
            false,
        );
        this.outx(
        ...
        this.outx(
            `"<i>You sure know your knots!   Speaking of knots, I got an idea...</i>" exclaims the demon inside your [cock].  You wonder at what the demon could have in mind this time as you finish spreading the bee-bitch's legs in preparation.  The scent wafting out from her genitals is unreal, making you simultaneously hungry and incredibly horny.  You pull up the ginormous flanged tip with both hands and rub it over her honey-slicked crotch, mixing your demonic pre-seed with her honey as you smear it all over her downy inner thighs.\n\n`,
            false,
        );
        this.outx(
        ...
        this.outx(
            `You pull out with a satisfied grunt, enjoying the wet 'schlick' sound your [cock] makes as it pulls free of the bee-girl's once-tight hole.  Where once there was a honey-coated slit now resides a gaping monster, drooling a gooey mixture of slime and your tainted demonic seed.  Well, maybe her queen will have an easier time packing her full of eggs.\n\n`,
            false,
        );
        this.outx(
    ...
    private exgartuanSleepSurprise(): void {
        ...
        if (this.player.cor <= 20 && this.player.findPerk(PerkLib.BulgeArmor) >= 0) {
            ...
            if (
                ...
                this.outx(
                    `  You remove your [armor] piece by piece, leaving only the magically-altered centerpiece that your favorite demon ever so generously "<i>gifted</i>" to you.\n\n`,
                    false,
                );
            // [else]
            else
                this.outx(
                    `  You glare at your [armor], its altered state so graciously bestowed upon you by the ever-thoughtful demon that resides in your crotch.\n\n`,
                    false,
                );
            ...
            if (this.player.cor < 33) {
                ...
                // (MED+COR, DONE A LOT:
                    ...
                    if (this.player.biggestTitSize() >= 2) {
                        this.outx(
                            `  Your biceps squeeze around your ${this.allBreastsDescript()}, mashing them into your [cock] and adding to the pleasure.`,
                        );
                        ...
                        if (this.player.hasFuckableNipples() || this.player.hasFuckableNipples()) {
                            this.outx(
                                ` from your [nipple] puddle in the bouncing cleavage and turn your chest into a slip-n'-slide for dicks.`,
                            );
                        }
                    }
                    this.outx("\n\n");
            ...
            if (this.player.gender == 3) {
                ...
                // (Herms + Balls)
                    ...
                    this.outx(
                        ` skin of your outer lips is engorged and ready, but with your hands so focused on your [cock], there's little for your [vagina] to feel.  The closest it gets to pleasure is the sensation of your [sack] slapping against it with the steady rhythm of your masturbation.  If only you had taken care of yourself earlier!  You might have had enough control over your rebellious tool to let a hand attend to your OTHER needs.\n\n`,
                        false,
                    );
                }
            }
            this.outx(
                `Spit foams around the tumescent intruder's girth, bubbling from the uncontrollable pistoning of Exgartuan's wrath at your [face].  The taut, bulging flesh of your own member is rammed so deeply into your own throat that you can feel the pre dripping into your stomach, but you want more.  `,
            );
            if (this.player.cor < 33)
                this.outx(
            ...
            this.outx(
                `  Liquid-hot pressure slides over the underside of your [cock], licking wetly at the pulsating, need-filled demon-prick.  Your rogue tongue's attentions have the desired effect, and the cries of your pleasure are muffled by your own thick flesh and its rapidly distending urethra.\n\n`,
                false,
            );
            ...
            if (this.temp > 500) {
                ...
                if (this.temp > 2500)
                    this.outx(
                        `  Back-pressure blasts your [cock] free from your imprisoning oral cavity along with a fountain of seed while you weakly try to cough out enough spooge to breathe.`,
                    );
            }
            this.outx("\n\n");
    ...
    private exgartuanBulgeTortureII(): void {
        ...
        if (
            ...
            this.outx(`your last remaining piece of [armor]`);
        // [else]
        else this.outx(`your [armor]`);
        this.outx(
        ...
        if (
            ...
            this.outx(
                `your [armor] feels as if it's become incredibly stiff, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.`,
            );
        ...
        if (
            ...
            this.outx(
                `your [armor] feels as if it's become incredibly dense, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  What's worse, the links that make up your armor have narrowed and sealed shut.`,
            );
        else
            this.outx(
                `your [armor] feels as if it were made from 6</i>" thick steel, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  You continue to run your hands across it, having trouble believing that the material has become so incredibly dense and rigid despite its appearance.`,
            );
        this.outx(
            `  A little more pushing, pulling, knocking, groping, and stroking confirms what you feared: your [cock] has been cordoned off from you`,
        );
        ...
        if (this.player.biggestTitSize() >= 2 && this.player.bRows() == 1)
            this.outx(
                `  Your quest begins squarely on your pair of [chest], your mitts feverishly groping and tugging away in the hope of finding any sanctuary from your encroaching lust.  Unable to extract any meaningful solace from your magnificent mounds, your sights set on your [nipples].`,
            );
        // [if ≥2 rows of breasts]
        else if (this.player.biggestTitSize() >= 2)
            this.outx(
                `  The ${this.allBreastsDescript()} lined down your chest should serve a proper conquest.  Your palms set off to work at once, manhandling as much titflesh as they can satisfy at once.  They dart from one row to the next, inside to out, anything to relieve your libido.  You don't appear to be settling down any, however, so you draw your focus on your top row of [nipples].`,
            );
        else
            this.outx(
                `  With little else to turn to, your [nipples] are your only guiding light to hopefully bringing you the peace you crave.`,
            );
        // [if nipplecunts]
        ...
        this.outx(
            `  Too preoccupied with whatever's going on down below, you can't seem to focus enough to get the job done right.  Your peer down your body at your [cock], still flaccid and on lockdown.  The most you can respond is with another deep sigh, retreating your attention to the canvas up above you.  You figure the best course of action from here is to just try and make it until morning when you can find some help.  Confessing shame to some third party seems a much better alternative to going any more rounds with this nonsense.  Your fists clench and you take some deep breaths, prepared to ride out the remainder of the night with your sanity intact.\n\n`,
            false,
        );
    ...
    private exgartuanBulgeTortureIII(): void {
        ...
        if (
            ...
            this.outx(
                `  As you stare in bewilderment, you can't even begin to fathom how it possibly seeped through the steel of your solid [armor]`,
            );
        // [if armorname IS EQUAL TO \"<i>crotch-hugging practically indecent steel armor</i>\" OR \"<i>crotch-hugging full-body chainmail</i>\" OR \"<i>crotch-hugging revealing chainmail bikini</i>\"]
        else if (
            this.player.armorName == "crotch-hugging practically indecent steel armor" ||
            ...
            this.outx(
                `  Your fixation on the drop draws to question just how it managed its way through the sealed chains of your [armor]`,
            );
        else
            this.outx(
        ...
        this.outx(
            `Your frantic breathing seems to be competing with your pounding heartbeat, acting as if it were emanating from within your skull.  Your hands cling to the dirt and scant pieces of grass below you, unable to stop shaking or heed any of your commands.  Your already obscured vision begins to darken, more and more of the vague blobs fading into darkness.  Your [legs] continue their numb strike against you while helping your [feet] dig helplessly into the ground.  ...You've run out of ideas, left with an insatiable hunger for sex, a body that refuses to do little more than convulse, and a mound of misfortune where your crotch resides.\n\n`,
            false,
        );
        ...
        // [if occurrence ≥10]
            ...
            this.outx(
                `"<i>I can keep this up much longer than you can, [armor].  As much as I enjoy watching you struggle to maintain some form of morality and moderation, I would much rather be exploring the world and its many orifices.  Some day you'll leave that fantasy realm you keep running to and join me in the real world.</i>"`,
            );
        // [if occurrence ≥12]
        else
            this.outx(
        ...
        if (this.player.biggestTitSize() > 1)
            this.outx(
                `  Your [chest] work just as hard, smothering Exgartuan in all of their jiggly glory.`,
            );
        this.outx(
    ...
    private exgartuanBulgeTortureIV(): void {
        ...
        this.outx(
            `  You pay one more glance to Exgartuan, the [cock] comfortably resting away in your outfit.\n\n`,
            false,
        );
    ...
    private boobGartuanSURPRISE(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            this.outx(
                `"<i>[name]!</i>" he shouts snidely, a sneer working its way across his face, "<i>How long has it been?</i>"\n\n`,
                false,
            );
            this.outx('"<i>', false);
            ...
            else this.outx("I was worried you'd forgotten about me, Nemus.  You never write,");
    ...
    private boobgartuanSurprise2(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            if (this.player.cor < 33)
                this.outx(
                    `Your [chest] brush against the imp's enormous scrotum, causing him to eventually tumble over from the sensation, blocking the impeding entourage of imps behind you.`,
                );
            // [if corruption ≥30 & <70]
            else if (this.player.cor < 66)
                this.outx(
    ...
    private boobgartuanSurprise3(): void {
        ...
        this.outx(
            `Thankfully you were more prepared this time, your reflexes heightened enough to keep you from slamming your noggin yet again.  You also felt just where the shove originated from: your [chest].  `,
        );
        // [if occurrence ==0]
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
            this.outx(
                `As you sit up and begin to piece the puzzle together, you're interrupted by a familiar voice, "<i>You have time to fuck everyone in Mareth silly, but can't be bothered to spend an instant of it with these magnificent mounds?</i>" You feel your [chest] jiggle as Exgartuan speaks, only to have them yank you forward, planting your face back in the ground.  "<i>I'll just have to make sure you'll never forget again.</i>"`,
            );
        // [if occurrence ≥1]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4) {
            this.outx(
                `It's Exgartuan again; you haven't fondled her in a while.  "<i>Rarin' for another round, eh, champion?</i>" your [chest] ask you, jiggling furiously for emphasis, "<i>I had hoped the previous lesson`,
            );
            // [if occurrence ≥2]
        ...
        // if occurrence ≥4
            ...
            this.outx(
                `</i>"ARE YOU DENSE, CHAMPION?</i>" Exgartuan shouts, your mammoth melons bouncing furiously on her every word, "<i>I will knock you SENSELESS until I clear some space in that vapid cesspool between your ears!</i>" You want to try and calm her down, but your [chest] promptly launch your face square into the dirt.  "<i>Don't go on thinking for another SECOND that you can ignore ME!</i>"`,
            );
        // [if occurrence ≥8]
        else
            this.outx(
                `Before another thought can cross your mind, your [chest] fly up and smack you in the gob! "<i>[name], it's that time again,</i>" the eager demoness teases you.  You think she's grown to enjoy the torture she puts you through.  "<i>If you insist on going day in and day out without spending quality time with these tits, then I'll just insist on instructing you otherwise.</i>" Your beautiful bosom launches forward, throwing your mug right back in the dirt.`,
            );
        this.outx(
        ...
        // [if occurrence ≥1]
            ...
            this.outx(
                `"<i>Ready for your final, eh, [name]?</i>" Exgartuan teases, a faint lustful waver in her voice contrasting against her dominating demeanor, "<i>Let's make this one to remember.</i>"`,
            );
        // [if occurrence ≥4]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
            this.outx(
        ...
        if (this.player.gender > 0) {
            this.outx(`  Your [hips] begin grinding together, moist with `);
            // [if cock >0]
        ...
        this.outx(
            `  You finally bear down and grasp onto... nothing?  <b>Your nipples are nowhere to be found!</b>  The passion is beginning to flatline as you confusedly grope around your [chest].  "<i>What's wrong, champion?</i>" Exgartuan asks knowingly, "<i>Is this too hard for you?</i>" The tips of your fingers comb around your areolas until you discover an inward bend in your [skin] where your nipples should be.  Apparently, Exgartuan isn't through having fun with you; the blasted seductress managed to suck your teats inward!  Before you can fathom just how she pulled it off without your knowledge, your humble howitzers start to tingle.  You feel an anxious quiver work its way up your spine before a familiar need begins to course through your being: the need to be milked!`,
        );
        // [if corruption <50]
        if (this.player.cor < 50)
            this.outx(
        ...
        if (this.player.biggestLactation() < 1 || this.player.lactationQ() == 0)
            this.outx(`  <b>Your [chest] have started to lactate profusely.</b>`);
        ...
        // [if occurrence ≥8]
            ...
            this.outx(
                `Well, this has been fun, [name].  I look forward to beating you senseless and enjoying the wonderful makeup massage should you forget to see to my means yet again.`,
            );
        this.outx('</i>"\n\n', false);

        this.outx(
            `Your [chest] begin to rumble and quake, filling you with a mix of anxiety, dread, and passion.  One moment later, an enormous force bursts forth against your hands; your nipples have popped back out, soaking and ready to - wait a second...`,
        );
        ...
        if (this.player.gender > 0) {
            ...
            this.outx(` already coating your [hips].`);
        }
        // else
        else this.outx(".");
        ...
        this.outx(
            `Your hands go to work on your nips, a tug here, a stroke there, your fingers exploring the ins and outs of your titantic teats.  You punch in just a scant number of moments before your faucets reach their crescendo, your hands holding on for all their worth as milk sprays out everywhere, your [chest] writhing with each squirt.  It's hard to make out just how much or how far your cream has gone in the dark, but judging by what seemed like an eon of excitement, you're confident that you've made your mark.  You know that Exgartuan has fallen into her slumber when your otherwise perky pompoms succumb to the laws of gravity and return to their original state, soreness seeping in after a night of tossing, tugging and teasing.`,
        );
        // [if corruption <50]
        if (this.player.cor < 50)
            this.outx(
    ...
    public exgartuanNagaStoleMyMasturbation(): void {
        ...
        // [if corruption ≥30 & <60]
            ...
            this.outx(
                `You happily remove your [armor], eager to pleasure yourself.  Your possessed cock pulses happily as you remove the last article.`,
            );
        // [if corruption ≥60 & <80]
        ...
        if (this.player.cor > 33 && this.player.cor < 66) {
            ...
            this.outx(
                `No, wait, it's pretty fucking clear you love the fucking; it's the fucking demon that you fucking can't tolerate.  You think.  Fuck.  You shake your head to try and clear your thoughts, focusing on what you came over here to do.  Your erect [cock] has already made its way out of your slithery slit`,
            );
            // [if cocks == 2]
            if (this.player.cockTotal() == 2)
        ...
        // [else]
            ...
            this.outx(
                `"<i>Isn't this great, [name]? With both of our sexual expertise combined, we'll own this land in no time, and enjoy the fuck out of any downtime."`,
            );
        this.outx(
        ...
        this.outx(
            ` load working its way up your [cock]... and stop.  You sit up in an involuntary attempt to release the pressure, only to be met by your coiled-up shaft bending to greet your face, its urethra spread wide open...\n\n`,
            false,
        );
