...
export class HelScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public loseToSalamander(): void {
        ...
        // Player Loss – Rape – Female
            ...
            this.outx(
                `Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your [chest].  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her cum-soaked tail from your [vagina] and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.`,
            );
        }
        // Player Loss – Rape – Genderless & Male >85 cockarea
            ...
            if (this.player.gender == 0)
                this.outx(
                    `"<i>Hmm, what do we have here,</i>" the salamander asks, yanking your [armor] off to reveal your genderless crotch.  "<i>Well, that's... Different.  Well, your loss, I suppose...</i>" she trails off, stepping up and pushing her cunt into your face.  "<i>Now lick, and maybe I'll think up a way to get you off, too</i>".\n\n`,
                    false,
                );
            ...
            this.outx(
                `You gasp as you feel a sudden pressure against the rim of your [asshole].  Your eyes widen, but your fiery lover only smiles and increases the pressure against your asshole until you force yourself to relax, admitting the tip of her tail into your ass.  Every few licks, you're forced to stop and gasp or shudder as her tail works its way into your [asshole], fucking you like a cock and a skilled finger at once, not pistoning in and out, but writhing within your depths like a tentacle.`,
            );
            ...
            this.outx(
                `Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your [chest].  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her tail from your [asshole] and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.`,
            );
        }
        this.player.orgasm();
        this.dynStats("sen", 1);
    ...
    public beatUpHelAndStealHerWalletFromHerVagina(): void {
        ...
        this.outx(
            `You tell her that, sure, you could blow off some steam.  Still grinning, she tosses off her skimpy scale bikini and flops down on her back, already starting to finger her cunt.  You follow suit, stripping off your [armor] and straddling her hips.  She reaches forward and grasps your ${this.cockDescript(
                x,
        ...
        if (this.player.hasVagina())
            this.outx(` while releasing her breasts to finger your [vagina]`);
        this.outx(
    ...
    public helBlowsYou(): void {
        ...
        this.outx(
            `You agree to her proposition, and tell her to get on her knees as you draw out your ${this.cockDescript(
                x,
            )} and slip out of your [armor].  She grins and drops to her knees, quickly discarding her scaled bikini as you stroke yourself to hardness.  You close the distance between you and the salamander is quick to take your cock into her mouth, lustily sucking it in as she starts to fondle her breasts enticingly.\n\n`,
            false,
        );
    ...
    public dpHel(): void {
        ...
        this.outx("", true);
        this.outx(
            `You tell her that, yes, you want to blow off some steam.  You start to undo your [armor], and quickly her eyes go wide.  "<i>You've got something extra, don't ya!</i>" she laughs, looking mighty impressed.  "<i>Well, I think we can take care of that ${this.cockDescript(
                y,
    ...
    public getLickedByHel(): void {
        ...
        if (this.player.hasCock()) {
            this.outx(` while [eachcock] shoots its load into her red hair`);
    ...
    public helTailPegging(): void {
        ...
        this.outx("", true);
        this.outx(
            `You agree to her proposition and, after a moment of thought, strip out of your [armor] and ask her if she could fuck you with that long, prehensile tail.  "<i>Oh, now that's an idea I can get behind!</i>"  She laughs at her own wit.  "<i>Well, go on then.  Get on your hands and knees, and spread those ass cheeks.</i>"\n\n`,
            false,
        );

        this.outx(
            `You do as she asks, getting on all fours and giving her a good views of your vulnerable [butt].  Looking over your shoulder, you can see her smile wolfishly as she brings her tail to bear, now doused of its previous flames, and gives its tip a little suckle, moistening it up as she straddles your hips to fuck you doggy style.  Her tail slips down from her mouth and winds between her legs like a cock as she lines herself up with your [asshole].\n\n`,
            false,
        );
        ...
        this.outx(
            `Firmly within your depths, she plants her smooth, scaled hands on your [butt] and starts to hammer your ass, quickly thrusting her tail in and out.  You gasp and moan like a whore, barely able to support your own weight as she fucks your ass hard and fast, threatening to tear your tender insides up with her rough fucking.\n\n`,
            false,
        );

        this.outx(
            `Eventually, you can take no more, and feel your climax coming on.  The salamander, sensing this from the fashion you're wringing her tail, gives your [butt] a hard slap and slams in as far as it can go.  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt`,
        );
        if (this.player.gender > 0) {
            this.outx(", with your ");
            if (this.player.hasCock()) {
        ...
        this.outx(
            `, writhing in pleasure as her tail slowly withdraws from your [asshole].\n\n`,
            false,
        );
    ...
    private nagaCoilsUpHel(): void {
        ...
        this.outx(
            `You get the idea in a hurry, and discard your [armor] as she disrobes, giving you a good view of her smooth snatch and her big, soft breasts.  The sight of her nude form causes your ${this.cockDescript(
                x,
        ...
        this.outx(
            `massive orgasm, you collapse onto your back and release your salamander lover from your grasp.  She crawls up to you and nuzzles into your [chest], wrapping her own tail around you in return.  Soon, you drift off into a calm, peaceful sleep.`,
        );
        // (reduce lust, increment Helgate flag by 1)
        this.player.orgasm();
        this.flags[kFLAGS.HEL_FUCK_COUNTER]++;
    ...
    private nagaCoilsUpAnalNaga(): void {
        ...
        this.outx(
            `You get an idea in a hurry, and quickly discard your [armor] as she does the same.  She drops to her hands and knees before you, and like a child, snatches at your tail.  Once in hand, she eagerly puts her mouth to it, sucking your tail's tip like a cock.  You shudder at the odd sensation, but when she raises her tail up toward you, you reciprocate the gesture, taking her extinguished tip into your mouth and slathering it with spittle.\n\n`,
            false,
        );

        this.outx(
            `Once both your tails are sufficiently lubricated, the salamander crawls behind you, and presses her back tightly to yours.  In an odd show of kindness, she even takes your hands in hers as her tail slithers between the cheeks of your [butt].  You return the favor, soon pressing the tip of your tail to her tight but relaxed asshole as hers begins to slip into your [asshole].  You gasp with the sensation of the hot, writhing tail-cock pushing inside you, fighting every inch to wring sensation out of it even as you push yours deep inside her, hard enough to make her take a sharp breath and knock her knees.`,
        );
        this.player.buttChange(40, true, true, false);
        this.outx("\n\n");

        this.outx(
            `She continues to force her way into you, wriggling her thickening tail further into your [asshole], stretching it wide as her tail gains in thickness.  Finally, though, she can get no more of herself into you, nor you into her.  "<i>Ready for a wild ride, lover?</i>" she asks, twisting her head so that she can plant a tender kiss on your shoulder.  You nod eagerly, and start to bounce.\n\n`,
            false,
        );
        ...
        this.outx(
            `When you come to your senses, you're lying on your back, panting and gasping for breath.  Slowly, you salamander lover drags herself to her feet, only to collapse on top of you a second later.  Seemingly content, she nuzzles into your [chest] and strokes your cheek.  No less than exhausted yourself, you soon drift off into a peaceful sleep.`,
        );
        // (reduce lust, increment Helgate flag by 1)
        this.player.orgasm();
        this.flags[kFLAGS.HEL_FUCK_COUNTER]++;
    ...
    private helVaginaTaur69(): void {
        ...
        this.outx(
            `You start trotting, letting the hands on your withers guide you this way and that across the wide open plains.  All the while, she whispers gentle encouragements into your ear, occasionally stopping to rub her tits tantalizingly into your back, letting her dangling tail flicker across your [vagina] and [butt].  Eventually, though, she sets her sights on a patch of particularly tall, green grass, almost up to your ears.  As soon as you arrive, she slips gracefully from your back and laughs aloud.  "<i>Oh, that was so much fun.  Thank you, friend.  I've never ridden a horse – a centaur – before you, but I think I could get used to it.  Oh!  Imagine, you and I, valiant adventurer and her trusty warhorse, wading into battle like – hey, I see that look on your face.  Don't laugh, dammit!</i>"\n\n`,
            false,
        );
        ...
        this.outx(
            `  You scream and buck, nearly throwing her from her harness.  Laughing maniacally, she forces more of her arm into your unsuspecting depths until she's up past her elbow in centaur cunt.  You gasp and buck and whinny, but anything that serves to dislodge her arm from your [vagina] only gives her ample opportunity to jam it right back in.\n\n`,
            false,
        );
        ...
        this.outx(
            `.  Getting a good grip on her hot, red tail, you start to fuck her hard, fast, and perhaps vengefully as she continues to assault your [vagina]`,
        );
        if (this.player.hasCock()) this.outx(" and swelling member");
        this.outx(".\n\n");

        this.outx(
            `It cannot go on forever.  You soon feel the tell-tale pressure of impending orgasm building behind your [vagina]`,
        );
    ...
    private helPossessionShitPoopCock(): void {
        ...
        if (this.player.hasFuckableNipples()) {
            this.outx(
                `Well, you can't let her have ALL the fun!  Still leaving the lower half of your body within the bunny-girl, you slip a pair of fingers into one of your hungry nipplecunts.  Grinning, you stretch your nipple-fuckhole out and bend forward, letting your chest-lips kiss the tip of your possessed bunny-cock.  You shudder as you press yourself down upon the bunny rod, taking the first few inches into your [chest] even as the salamander continues to titfuck the length of your column.  You settle into a rhythm with the salamander, rising and falling in unison as you coax the eggs out of the bunny and toward your nipplecunts.\n\n`,
                false,
            );

            this.outx(
                `Your eyes roll back in your head, your long tongue rolling out of your mouth as you give in utterly to the pleasure.  The first egg crests out of your distended bunny-cock, making you scream with orgasmic pleasure as it launches into your hard-cumming nipplecunt.  The top of your [chest] lurches upward with the impact, then again as eggs slam out of you and into your waiting tit-mouth.  Laughing, the reptilian woman yanks the cock out of your tit and squishes it between her own mounds, finishing your orgasm off as she hungrily licks the bunny-spooge out of your chest-holes, letting it pour onto herself as eggs crack against her chest.\n\n`,
                false,
            );
        }
    ...
    private receiveCorruptRimjobsFromHel(): void {
        ...
        this.outx("", true);
        this.outx(
            `The sight of the salamander berserker on her knees stirs the fire in your loins, and in moments you've stripped out of your [armor] and advanced upon her.  She looks up at you, gritting her teeth as if preparing to strike – you preempt her with a hard kick in the chest, knocking her on her back, then kneel down and straddle her, pinning her arms down underneath your knees as you bring your [asshole] to hover over her face.\n\n`,
            false,
        );
        ...
        if (this.player.hasVagina())
            this.outx(
                `  Her tongue begins to zero in on your [vagina], but you give her a quick penalty swat on the tits.  You've got other plans!`,
            );
        this.outx("\n\n");

        this.outx(
            `After a few moments of this, her long tongue traces its way along your [butt], causing small shudders of pleasure to rock through you, but she's only just getting to the main event.  You force yourself to relax your sphincter as her tongue flicks once, twice, thrice across your [asshole].  In a heartbeat, she's in!  You gasp as her long, slender tongue flicks and writhes within you, teasing and pleasuring the sensitive muscles of your ass as she works more and more of it in.\n\n`,
            false,
        );

        this.outx(
            `Firmly within your depths, she plants her smooth, scaled hands on your [butt] and starts to flick her tongue as fast as she can, withdrawing and ramming it back into your ass.  You gasp and moan like a whore`,
        );
        ...
        this.outx(
            `Eventually, you can take no more, and feel your climax coming on.  The salamander, possibly sensing this by the way you wring her tongue, gives your [butt] a hard slap and rams in as far as she can go!  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt, writhing in pleasure as her tongue slowly withdraws from your [asshole].\n\n`,
            false,
        );
    ...
    private fuckHerAss(): void {
        ...
        if (x < 0) x = 0;
        this.outx(
            `Well, damned if you're going to let a chance to fuck her good, hot ass slip by.  You quickly strip out of your [armor] and grab your ${this.cockDescript(
                x,
    ...
    private askHelAboutHer(): void {
        ...
        this.outx(
            `You laugh, and extend a hand to her. "<i>The name's [name].  Pleased to meet you.</i>"\n\n`,
            false,
        );

        this.outx(
            `"<i>I'm Helia.  Or Hel, if you'd like.  And the pleasure's mine, [name],</i>" she says, shaking your hand.\n\n`,
            false,
        );
    ...
    public salamanderXIsabellaPlainsIntro(): void {
        ...
        this.outx("", true);
        this.outx(
            `You make your way onto the vast expanse of Mareth's plainsland and soon find yourself submerged in the tall grass, wading through it like a sea of weeds.  After a few minutes of wandering, you hear what sounds like a surprised, throaty moo in the distance, followed shortly by the crack of steel on steel.  Knowing Isabella makes camp not far from here, you ready your [weapon] and make best haste toward the cow-girl's camp.\n\n`,
            false,
        );

        this.outx(
            `You burst into Isabella's camp, [weapon] raised high.  To your horror, the red-headed cow-girl is standing with her massive tower shield braced, eyeing down Hel the salamander.  The salamander stands with sword in hand, poised to strike!\n\n`,
            false,
        );
    ...
    private salamanderXIsabellaDiplomacy(): void {
        ...
        // (PC fails the Strength check)
            ...
            this.outx(
                `To your relief, after a few seconds you hear "<i>[name]!</i>" from both Isabella and Hel.  The two women momentarily stop their squabbling to help you; your head is soon resting upon Isabella's sizable cleavage while Hel ties a long length of plains grass over a cut in your sternum.\n\n`,
                false,
            );
        }
    ...
    private salamanderXIsabellaDiplomacy2(): void {
        ...
        this.outx(
            `Isabella makes an indignant huff and turns her nose up at the salamander.  "<i>Do not listen to zis little liar, [name].  I found it in ze hands of ze gnolls, and most certainly did not steal it.</i>"\n\n`,
            false,
        );

        this.outx(
            `"<i>Hey...  How does she know your name, [name]?</i>" Hel asks, crossing her arms over her sizable chest and frowning at you.\n\n`,
            false,
        );
        ...
        this.outx(
            `"<i>Yeah,</i>" Hel answers with a little scoff, "<i>And, I guess if you're [name]'s friend... you're probably all right.  Although I was winning, you impertinent bitch.</i>"\n\n`,
            false,
        );
    ...
    public followrIzzyxSallyThreesomePretext(): void {
        ...
        this.outx(
            `You raise your [weapon] and prepare to fight the shadowy villain... only to see Hel the salamander step forward, staring at you with wide eyes.\n\n`,
            false,
        );

        this.outx(
            `"<i>[name]!  What the fuck!?</i>" Hel demands, looking from you to the redheaded cow-girl.\n\n`,
            false,
        );
        ...
        this.outx(
            `"<i>[name]!</i>" they both shout, frustrated at their inability to close the distance with their opponent without going through you.\n\n`,
            false,
        );
        ...
        if (this.isabellaAccent())
            this.outx(
                `"<i>Do not listen to ze little liar, [name].  I found it in ze hands of ze gnolls, and most certainly did not steal it.</i>"\n\n`,
                false,
            );
        else
            this.outx(
                `"<i>Do not listen to the little liar, [name].  I found it in the hands of the gnolls, and most certainly did not steal it.</i>"\n\n`,
                false,
            );

        this.outx(
            `"<i>Yes you fucking well did!</i>" Hel snaps, waving her sword around.  "<i>[name], why the hell are you protecting that fat cow, huh?  Lemme at her!</i>"\n\n`,
            false,
        );
        ...
        this.outx(
            `"<i>Yeah,</i>" Hel answers with a little scoff, "<i>And, I guess if you're [name]'s friend... you're probably all right.</i>"\n\n`,
            false,
        );
    ...
    public isabellaXHelThreeSomeCampStart(): void {
        ...
        this.outx(
            `"<i>[name]... it is –moo– good to see youuuuu.</i>"  She trails off into a long, ecstatic moan as Hel continues to suckle from her massive teat, acknowledging your presence only with a little waggle of her tail and a wink.  `,
        );
        if (this.isabellaAccent())
            this.outx(
    ...
    private nomOnIzzyTitWithSallyMancer(): void {
        ...
        if (this.player.hasCock())
            this.outx(
                `, and your [armor] is tenting visibly, displaying your excitement as you take her soft, delightfully warm and full breast in hand`,
            );
        else
            this.outx(
    ...
    private stuffIzzyAndSalamanderWithDicks(): void {
        ...
        this.outx(
            `You stand up and start stripping out of your [armor].  ${this.SMultiCockDesc()} pops free as soon as your crotch is clear, already at full hardness thanks to the sight of Hel crawling atop Isabella, pressing her E-cups into the cow's milky teats and giving her a full kiss on the lips.  You stay back for a moment, watching the kiss, able to catch just a glimpse of Isabella's massive flat tongue entwining with Hel's long, slender one.\n\n`,
            false,
        );
        ...
        // (Player has 2-3 cocks)
            ...
            this.outx(
                `Grinning over Isabella's shoulder, Hel grabs the cow-girl's milky udders and takes one of her quad-nipples between her thumbs and forefingers.  "<i>Isabella, I think our dear [name] is getting pretty sweaty...</i>"\n\n`,
                false,
            );
    ...
    private izzySallyThreeSomeFollowup(): void {
        ...
        this.outx("", true);
        this.outx(
            `Now a sweat-and-cum soaked mess, the girls collapse onto their backs around you.  Sighing contentedly, Isabella rolls over and nuzzles her head on your chest; a moment later sees Hel doing the same, wrapping her warm tail around your [cock] lovingly.\n\n`,
            false,
        );
    ...
    private izzySallyThreeSomeVagoozlaz(): void {
        ...
        this.outx("", true);
        this.outx(
            `You quickly strip out of your [armor], already wet at the sight of the two busty redheads embracing and fondling each other as they await you.  When you're finally rid of interfering fabrics, you drop to your knees and insert yourself between the girls.  With a few carefully considered directions, you get the three of you into something of a triangle shape, with your head nestled between Hel's thighs and Isabella's tongue caressing your [vagina].\n\n`,
            false,
        );
        ...
        if (this.player.hasCock())
            this.outx(`, wrapping her warm tail around your [cock] lovingly`);
        this.outx(".\n\n");
    ...
    public heliaPlusFoxyFluffs(): void {
        ...
        if (this.flags[kFLAGS.HEL_FOXY_FOURSOME_WARNED] == 0) {
            ...
            this.outx(
                `Hel grins as you notice the sisters' extra hardware.  "<i>Miko, Mai, meet [name],</i>" she says, running one of her scaled hands along... Miko's?... thighs, eliciting a sensual moan from the fox-girl.  In response, Mai buries her face in your neck, her full lips brushing along your sensitive flesh.  Your skin tingles with delight at her light caresses as her rigid prick presses further into your stomach, leaving a little wet stain on your [armor].\n\n`,
                false,
            );
        ...
        // Fox Girls -- Repeat Intro
            ...
            this.outx(
                `Amused, Hel gives Miko's bountiful bosom a playful grope and says, "<i>My, my, [name], looking for a little foxy foursome?  Well, I think that can be arranged, what do you say, girls?</i>"`,
            );
    ...
    public foxyFluffsFoursomeAsMale(): void {
        ...
        if (x < 0) x = this.player.smallestCockIndex();
        this.outx(
            `You strip out of your [armor] and grab your ${this.cockDescript(
                x,
    ...
    public foxyFluffGirlsFuckSex(): void {
        ...
        if (this.player.hasFuckableNipples()) {
            this.outx(
                `Now that the girls are nice and wet, you pull them as close together as you can and bring your glistening, moist nipplecunts to bear.  You slip a pair of fingers into each of your [chest]'s waiting holes, beckoning the girls to penetrate you.  Though somewhat startled by your alien anatomy, a few encouraging words are enough to get the sisters off their feet and grabbing your shoulders for support.\n\n`,
                false,
            );

            this.outx(
                `They thrust in easily, sliding their twin doggy cocks into your tits until their knots press against your lips.  You shudder at the penetration, feeling the inhuman sensation of the two shafts sliding into your [chest].  As they start to fuck your tits, you feel Hel kneel down behind you, wrapping her scaled arms around your waist and slipping her tail between your legs.  You only have a second to brace for the coming attack before her tail slithers into your [vagina], forcing its way into your love tunnel until you can feel her sharp tip writhing and prodding against your womb.\n\n`,
                false,
            );
        ...
        this.outx(
            `The twins pick you and Hel up and toss you onto the bed, falling side by side on your backs.  The twins loom over you, with Mai stroking her knotty cock as it nears your waiting [vagina].  Seeing Miko flop her cock down on Hel's waiting cunt, you take the salamander by the hand and grit your teeth in anticipation.\n\n`,
            false,
        );
    ...
    private satisfyHelSoSheStopsMinoFucking(): void {
        ...
        // {PC has low libido}
            ...
            this.outx(
                `\n\nShe smiles at you, clawed hands clutching tightly to your [skinFurScales]. "<i>Don't worry about a thing, lover mine.  I'll be careful not to hurt you... too much.</i>"`,
            );
        }
        if (this.player.lust < 33) {
            this.dynStats("lus", 0.1);
