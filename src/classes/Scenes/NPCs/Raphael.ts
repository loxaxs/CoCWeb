...
export class Raphael extends NPCAwareContent implements TimeAwareInterface {
    ...
    private meetRaphael(): void {
        this.outx("", true);
        this.outx("You stir in your sleep, bothered by a noise. It's the familiar creaking of your camp's storage chest, as if you've just opened it up to fill it with freshly found loot. Groaning, you hog your blankets and twist. Nothing to worry about then. You soon drift back into a pleasant dream about all the spoils you've accumulated over the time here. Life is good.\n\n");

        this.outx("Suddenly, you sit up straight and something occurs to you. If you're sleeping, then who's opening the chest?\n\n");
    ...
    private meetRaphaelPtII(): void {
        this.outx("", true);
        this.outx("Suddenly, Raphael's features grow soft and surprised as he looks down upon you. You get the feeling he's eyeing you up and catching a peek at your cleavage, but you can't be sure.\n\n");
        ...
        this.outx("You can't help but smile a little at the amount of theatrical flourish.\n\n");
    ...
    private RaphaelFirstMeetingSLAP(): void {
        this.outx("", true);
        this.outx("With an offended scowl you throw a flat palm across his face. You make sure to catch his nose and sharp snout, sending him a clear message.\n\n");

        this.outx("It takes Raphael completely by surprise. The fox keeps his head in the wake of the blow for a good five seconds in disbelief, but tries once more when he recovers.\n\n");
        ...
        this.outx("This time you wrestle your hand from Raphael's hold and throw him the heavier back of your hand, sending him to fall on his back. You're actually getting angry at him. How dare he sneak into your camp, try to rob you and then seduce you! By the time it occurs to you to actually apprehend him, Raphael has already beaten a hasty retreat by hopping back up on the wall.\n\n");
        ...
        this.outx("You resolve to wash your hand. You're sure you've not seen the last of the russet rogue, but it will be time in coming before that happens with the severity of your rejection.");
    ...
    private RaphaelFirstMeetingSWOON(): void {
        this.outx("", true);
        this.outx("You snicker softly, shift your weight on one leg and blush a little. He's quite the charmer; almost good enough to forgive him for robbing you. The attention he showers you with doesn't leave you cold either.\n\n");
    ...
    private RaphaelFirstMeetingTALK(): void {
        ...
        this.outx("You squint your eyes at him, pulling on your arm to wrestle it from his hold. When you remark he stole from you and ask him to return your goods, Raphael simply throws you a vulpine smirk.\n\n");
    ...
    private RaphaelDress(): void {
        this.outx("", true);
        this.outx("A small pebble hits the ground near you, waking you up. When a second one hits, you're sure someone is trying to draw your attention.\n\n");

        this.outx("Rubbing your eyes, you pull yourself out of bed, wondering what's going on. Sticking your head through the front wall of your tent, you take a curious peek outside, but find no one around.\n\n");

        this.outx("The first thing you do is open your storage chest, to see if the Russet Rogue has robbed you again. This doesn't appear to be the case, and instantly, your eye is drawn to an addition instead of a subtraction from its contents. You seem to have gained a new outfit! Upon a carefully folded fabric of rose red color, a note is left below a gorgeous ruby pendant upon a golden setting and carried by a filigree chain. Curiously, you open the note and read it.\n\n");
        ...
        this.outx("You hold the ruby pendant to the light. It must be priceless. Its crimson shimmer is enough to make you forget to ask yourself where Raphael could have gotten it from. You wonder what he means by ownership. It very clearly is in your possession now.\n\n");

        this.outx("Soon enough you put it down and begin to inspect the equally lustrous garment he left you. You unfold it and marvel at the Bordeaux colored clothes.");
        // nxt page
    ...
    private RaphaelEncounterIIDressFollowup(): void {
        ...
        if (this.RaphaelLikes()) {
            ...
            this.outx("When you inspect the rest of his body, it's clear that Raphael is still the sly fox. Your ruby pendant hangs from his belt. He has once again stolen it from you after gifting it earlier, like it was some game. When he notices your interest, he flicks his tail over it, causing the necklace to disappear.\n\n");
        ...
        // ({If player does not meet the first encounter requirements:}
            ...
            if (this.player.tallness < 48)
                this.outx("Raphael squints like he has trouble seeing you from there, because of your dimunitive size. \"<i>I've dated goblins once... didn't work out.</i>\"\n\n");
            // ({If player has grown ANY cock and balls}
            ...
            this.outx("The fox looks dissapointed. \"<i>Beauty is in the eye of the beholder, but it certainly isn't gracing mine right now.  señorita... or what remains of you, please clean yourself up. Meanwhile, I just remembered: I have a sick mother to take care of. I hope you'll excuse me!</i>\" he mentions before hopping back of the wall and making a hasty retreat.\n\n");
    ...
    private RaphaelSelectDate(): void {
        this.outx("", true);
        this.outx("You smile bashfully, not expecting this sort of gesture from anyone in Mareth. You hardly care about the pendant and you nod at him.\n\n");
        ...
        this.outx("It almost feels like you're consenting when you reach for his soft, cushioned padded furry paw, after which he pulls you up and helps you over the wall.");
        // {Unlocks Picnic}
    ...
    private RaphaelChooseReject(): void {
        this.outx("", true);
        this.outx("You sigh at the fox and shake your head. You're not interested in him or his advances.\n\n");

        this.outx("He flicks his tail past his body again and within the blink of an aye, the glass of wine is exchanged for the stolen pendant.\n\n");
    ...
    private RaphaelChooseFrisk(): void {
        ...
        // ({Int or Spe between 24-36 and Cor is not higher than that}
            ...
            this.outx("Not outdone through wit, you notice how the fox is moving his tail about. The wileful rogue is using his fifth limb to move the pendant about his body! You quickly reach around and pat him across the back and flanks, but inspecting the tip of his tail leaves the pendant nowhere to be found. By then Raphael is moving his arms and legs to misplace it further. In a game of cat and mouse all through his red fur, you follow the movement from his lower back, to his feet and his thighs. The sly vulpine clearly enjoys leading you on your hunt across his skin and supple deerskin attire, as you graze over taut leather spanned across a contoured, masculine body. Raphael always appears one step ahead. That is, until the trail ends near his crotch.\n\n");

            // ({If player corruption is below 15}
            if (this.player.cor <= 15)
                this.outx("You have the stronge urge to grab hold of the oddly enlarged bulge between his legs and retrieve the necklace from within his pants, but the lewdness of the gesture keeps you from it.\n\n");
            // {If player corruption is at or higher than 15}
            else
                this.outx("With no intention to relent, you grab him by the oddly enlarged bulge in his tight leather pants and squeeze softly, discovering how several of his jewels are harder than others. He hid your gem amongst his own!\n\n");
        ...
        // {If player's corruption is higher than 19 and higher than Intelligence.}
            ...
            this.outx("You ask yourself the age old question if he's just happy to see you, but you suspect differently when you reach out for the firm lump and cup it.\n\n");
    ...
    private friskRejectChoice(): void {
        this.outx("", true);
        this.outx("You scoff, cross your arms and reject the offer by telling Raph your answer from across your shoulder, with your back still turned to him aloofly. Pleased with yourself, you add that he's nothing more than a carnie with an accent and that you won't be needing his help.\n\n");
        ...
        this.outx("You startle when you hear the fox bang against your chest. When you turn around, he's once again stealing from you!\n\n");
        ...
        this.outx("As Raphael bolts, he has a look of surprise on his face. He doesn't last long before his pants drop to his ankles and he falls flat on his face.\n\n");

        this.outx("He yelps when he loses hold of the bag, which drops to the ground. The fox uses both hands to protect his modesty by holding up his pantaloons, slipping over the spilt gems a few good times and flailing about, before finally making it to the wall with nothing to show for it.\n\n");
        ...
        this.outx("You laugh as he blushes, beating a sound retreat. You're sure this won't be the last you'll see of him however.");
        // {Game removal}
        this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 14;
        this.flags[kFLAGS.REJECTED_RAPHAEL] = 1;
        this.doNext(this.playerMenu);
    ...
    private friskFondleChoice(): void {
        this.outx("", true);
        this.outx("You gently massage the leathery package. It increases in size until a distinct shape of some length forms above it. When Raphael moves his hips forward appreciatively, you look up, throw him a smile and slip your hand into his pants. He's not wearing any underwear, you notice as you rummage about. Struggling to restrain yourself, you slip past the throbbing meat of his naked cock and dig around his jewels instead, removing the ruby from behind them.\n\n");
        ...
        this.outx("You deftly remove the sweat stained, fogged up stones and tug them away between your breasts.\n\n");
    ...
    private friskSqueezeChoice(): void {
        ...
        this.outx("Raphael shakes his head while a tear wells up in his eyes. When you roll his privates into the sharp edges, he finally lets out a cry loud enough to hear from miles away.\n\n");

        this.outx("You chuckle and look around you to see if anyone heard. When you look back to see him squirming between your fingers however, all you're holding onto is the ruby pendant. Raphael has pulled off an amazing switching trick and has escaped. Instead, he stands on top the wall panting and defiant.\n\n");
    ...
    private RaphaelPicnicEnd(): void {
        ...
        this.outx("He seems so hasty that you'd begin to question it, but your doubt is taken away as the fox takes the time to stare patiently at you from the forest's edge. \"<i>How could I resist, when you're dressed and made so gorgeously?</i>\" He smiles, referring to your elegant red suit.\n\n");

        if (this.flags[kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] == 0) {
            this.outx("A minute of silence follows and just when it has been long enough to reassure you, he throws you something and slips away and vanishes.\n\n");

            this.outx("You catch the object: he has returned the priceless ruby pendant. You recollect yourself and head back to camp.");
        } else {
            this.flags[kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] = 0;

            this.outx("A minute of silence follows and just when it has been long enough to reassure you, he makes his excuses and sets about heading back to... whatever it is the sly fox spends his days doing.\n\n");
    ...
    private RaphaelPicnicSkill(): void {
        ...
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 0) {
            ...
            this.outx("There's a moment of awkward silence as you realize the young man places more pride in his sword than you thought. However, Raphael recollects himself with a smile and chuckles at himself like he's been had by someone who just doesn't understand.\n\n");
        ...
        if (this.player.spe < 30 || this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 0) {
            this.outx("The two of you amble over to a mossy field. Raphael is up front and waving about his rapier playfully, grazing the tip through the flora and even slashing at a wasp. You can't seem to spot the insect flying around after he does that.\n\n");

            this.outx("When you reach the center of the field however, Raphael throws the weapon to the ground with temperament and tells you to prepare.\n\n");
        ...
        // {Fencing practice variables: Speed 30-39 Must play out at least once}
            ...
            this.outx("In the middle of the mossy field, you grab Raphael by his paw as he offers it. The other you instinctively put around his shoulder, when he does the same around your waist. This forces the both of you to hold each other close. A little closer than what you're normally comfortable with. Raphael doesn't seem to mind when you lean away from him however. He treats it as a game between you.\n\n");

            this.outx("When you ask him if he's sure that this is part of a dance. He chortles. \"<i>M'lady, it takes two to tango!</i>\"\n\n");
        ...
        // {Warning when you have 50 speed, played through all 3 variables and choose {Skill} at the opening picnic}
            ...
            this.outx("Regardless of the picnic's splendor, you are quickly drawn to Raphael's rapier again, having gained real feelings for the weapons during your previous sessions with it.  The fox chuckles.  <i>\"My fair fae; she is a woman of taste.  She knows what she wants.\"</i>\n\n");

            this.outx("The weapon is lying between you.  You stare at it, Raphael stares at you.\n\n");

            this.outx('<i>"Would you like to own it?"</i> he suddenly asks you.\n\n', false);

            this.outx("You look up and smile, cautious about the offer.  You've built up a good rapport with the fox, but there's something mischievous about him, that still makes you playfully hesitant to completely trust him.  You ask him what you'd have to do for it.\n\n");
    ...
    private fenceRaphaelSexilyPtII(): void {
        this.outx("", true);
        this.outx("You're a little embarrassed at how easily the fox outdid you.  When you look up and stare him in the eyes however, Raphael is possessing of fantastic sportsmanship.\n\n");
        ...
        this.outx("You stammer and are not so sure of that yourself, but the confidence carried in his voice quiets all self-doubt.  Maybe you were good.  Perhaps you could have beaten him in any other way, but just not yet with his weapon of choice.\n\n");
    ...
    private postRaphaelCoitus(): void {
        ...
        this.outx("When you wake up on a bed of soft moss, Raphael has disappeared completely.\n\n");

        // ({When player had reached the SPE fencing apex}
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 4) {
            this.outx("The only thing left behind is his rapier, sticking out of the moss.  He's bound it with his red sash around the length like a ribbon, as though he has now gifted it to you.  Perhaps it is his way of congratulating you.\n\n");
        ...
        if (this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
            this.outx("However, you realize he's left you with more than just pleasant memories of sitting with him around the picnic.  Realizing how skillfully you declined him and how deftly you led him around, you realize you may have mastered his art of keeping another's attention and leading them around with cunning and acting.  This misdirection could have great applications in battle.\n\n");
        ...
        this.outx("You return to camp, having cleaned up the picnic and taking the rations that were left with you.  You can't help but wonder if you'll ever see him again though.\n\n");
    ...
    private declinePuttingOutForRogues(): void {
        ...
        this.outx("The horny fox frowns.  It's like raising an invincible shield between you.  He reaches out towards your face and body, but he cannot touch anymore.\n\n");

        this.outx("Some of the magic of the moment is still there in the fine young man leaning over your aroused body.  He could still take you right there and right now and you know you'd probably enjoy it too.  However, it would be unseemly.  It would be to rape an equal and to Raphael, that would deprive him too of the dignity he tries so hard to maintain.  You can tell it from his face; the agonized quandary.\n\n");

        this.outx("When he gets off your body, you've won.  You've caught Raphael in his own game.  You've led him around.  He'd probably do anything for it, but cannot obtain it.\n\n");
        ...
        this.outx("You smile, a bit sorry for the way you broke him, but you try to convince him that he shouldn't mope.  The two of you had fun.  It's getting late and you occupy yourself with cleaning up the picnic.\n\n");
        ...
        // ({When player had reached the SPE fencing apex}
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 4) {
            this.outx("The only thing left behind is his rapier, sticking out of the moss. He's bound it with his red sash around the length like a ribbon, like he has now gifted it to you. Perhaps it is his way of congratulating you.\n\n");
            // [Weapon: Rapier. Speed, instead of strength, influences the damage rating. Never as strong as the heavier weapons or sword, but works great with speed & evasion, encouraged by the rapier.])
            this.inventory.takeItem(this.weapons.RRAPIER, this.playerMenu);
        }
        // ({When player has reached the INT Conversation apex}
        if (this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
            this.outx("You realize he's left you with more than just pleasant memories of sitting with him around the picnic, though. Realizing how skillfully you declined him and how deftly you led him around, you realize you may have mastered his art of keeping another's attention and leading them around with cunning and acting. This misdirection could have great applications in battle.\n\n");
            // [Optional Perk: Misdirection. Intelligence adds to the chance to evade. Turns you into a true rogue together with the bodysuit.])
            this.player.createPerk(PerkLib.Misdirection, 0, 0, 0, 0);
        }

        this.outx("You return to camp, having cleaned up the picnic and taking the rations that were left with you.  You can't help but wonder if you'll ever see him again.\n\n");
    ...
    private RaphaelPicnicChooseThieving(newl = true): void {
        ...
        // {Picnic Thieving 30-39 Int. Must play out at least once.}
            ...
            this.outx("When you ask him what he means, Raphael merely winks.  <i>\"You've come this far, I'm sure you'll figure it out. A proper rogue knows it by heart.\"</i>\n\n");
            this.dynStats("str", -1, "tou", -1, "int", 3, "sen", 1, "lus", 40);
        ...
        // {Int Thieving Apex Warning: When the PC's intelligence is at 50 or higher.}
            ...
            this.outx("You realize that he's preparing for the long haul.  You might not get off quite as easily as earlier, should you decide to flirt with him again.\n\n");

            this.outx("It occurs to you to change the subject to that of the rapier at his side but you are equally drawn to engaging the fox and satisfying your... curiosity.\n\n");
    ...
    private thieveryEnding(): void {
        ...
        this.outx("A brooch that can only be described as priceless decorates the soft silk sash.  ");
        // ({When player has not reached the apex of fencing lessons/Optional: and also has less than 60 speed}
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] != 4)
            this.outx("You try to reach for the magnificent ornament hanging off his hips, but as the fox continues to move, you lack the nimbleness to remove it.\n\n");
        // ({When player has also reached the apex of fencing lessons
        else
            this.outx("You reach and fondle the magnificent ornament hanging off his hips. With a few nimble flicks of your fingers, you manage to get it off.\n\n");
        ...
        this.outx("You're enjoying yourself and so is Raphael, for as long as you keep the illusion up he might manage to woo his way into your pants.  He's so fragile right now.  You're almost literally holding the horny fox's desires and pride in the palm of your hand.  You are in complete control.\n\n");
    ...
    private RaphaelThieverySmex(): void {
        this.outx("", true);
        this.outx("You need no words.  You place your hand on the back of Raphael's neck and pull his lisping tongue closer to your ears.  After that, you lose yourself to the weight of a man atop you as the fox starts tending to your quivering body.\n\n");
        ...
        this.outx("With a victorious glint, the fox takes the sash from his hips and, tying either end around your knees, brings your legs towards your chest. He holds them there without any effort on the part of either of you, by putting his chest down on the cloth tied between them and mounting you again, lying on top of you. More deep thrusts follow, this time deep enough for the tip to titilate even your cervix, while the slender knot at his base parts the sensitive entrance a little wider with every bottoming bump into you.\n\n");

        this.outx("It is how you spend the rest of that morning, filled a thousands times over and constantly driven past the edge of orgasmic bliss by the master fencer's trained thrusts. His civilized smile has long since given way to the mean smirk of a sexual victor, driving his prey to the edge of madness.");
    ...
    private quiksilverFawkesEndGame(): void {
        ...
        if (this.flags[kFLAGS.REJECTED_RAPHAEL] == 1) {
            this.outx("You're immediately confused and you ask him what's going on, but the fox is out of breath.  What's more, a similar howl now calls out from the opposite direction too!  Whatever these sounds are or this fog is, they have the camp surrounded!\n\n");
        }
        // ({If player had an INT or SPE ending with him earlier}
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00149] == 1) {
            this.outx("You're a bit miffed at the fox.  You haven't heard from him for more than a week after he slept with you, and now he only shows up because he's looking for help.  The fox however, is out of breath.  What's more; a similar howl now calls out from the opposite direction too!  Whatever these sounds are or this fog is, they have the camp surrounded!\n\n");
        }
        ...
        this.outx("You don't have the chance to respond before the sounds of snapping branches and rustling leaves near camp.  Raphael jumps up and dives into the barrel you keep in camp for the storage of water, hiding himself and leaving you to face the oncoming threats by yourself.\n\n");

        this.outx("In the hazy distance, you spot a massive shadow rushing through the mist and it dissapears before you get a good look.  An eerie silence follows and you sharpen your eyes and hearing to the danger.  When you look up, your heart sinks as the massive shape has jumped up and now descends on you from above.  It happens so fast that you barely realize what's going on.  Before you know it, you're sent sliding across the floor with the dark shape on top of you, pinning you down to the ground with its weight.\n\n");
        ...
        this.outx("It removes itself from atop your body.  After having the breath knocked out of you, you take a moment to recover it and finally manage to get back up and meet the two monsters of the mist.");
    ...
    private QuiksilverFawkesPtII(): void {
        ...
        this.outx("Your heart jumps as Hati manages to discover a pile of Raphael's clothes, near the barrel.  It's irrefutable proof.  Raphael must have put them there to throw the wolves off.  Hati gives you a look of dissapointment.  <i>\"He's nude. They must have slept together.\"</i>");
        // ({If player is wearing red bodysuit}
        if (this.player.armorName == "red, high-society bodysuit")
            this.outx("  Suddenly, his eyes and ears perk.  <i>\"Isn't that the stolen clothing of the widow Camembert that she's wearing? You know, before she mysteriously dropped the charges after a nightly visit from the fox? Should we confiscate it anyway?\"</i>");
        this.outx("\n\n");
    ...
    private coverForRaphael(): void {
        this.outx("", true);
        this.outx("You stare back into the wolf's yellow eyes, keep a stiff back and answer him.  <i>\"I'm not seeing him right now.\"</i>\n\n");

        // ({Player corruption below 30}
        if (this.player.cor < 30)
            this.outx("You instantly feel bad for lying to the wolf. More so because he doesn't get troubled, disappointed or vexed.  He seems to instantly believe you... or at least, he wants to believe you, even though being a detective probably keeps him cynical.  You'll only be adding to that cynicism if he discovers your lie.\n\n");
        ...
        // ({If cor is below 30}
        if (this.player.cor < 30)
            this.outx("  You slowly shake your head, tortured by the trusting twinkle in the wolf's soft yellow eyes.");
        this.outx("\n\n");
        ...
        this.outx("Skoll picks up Raphael's clothes.  The two brothers then get on all four of their limbs and speed off into the fog.  Fierce, dangerous beasts they are.\n\n");
        // ~~~ Next page ~~~
    ...
    private coverForRaphaelII(): void {
        ...
        this.outx("It doesn't take more than a minute for Raphael to make use of the wolves' departure.  Not even bothering to climb out with dignity, he tips the barrel over as he rushes out of the water.  Like a drowned cat, he climbs out coughing and gasping for air on all fours.\n\n");

        this.outx("He hasn't lost his ways however.  The first words out of him are as suave and composed as ever.\n\n");
        ...
        this.outx("You're upset towards him for asking you to lie to law enforcement, but Raphael's current state keeps you from being too furious.  He's not so bushy anymore.  His soaked hair falls flat against his body and causes him to lose quite a bit of his imposing physique. Strands of it run across his face. You spend a little time yelling at him, though.\n\n");
        ...
        this.outx("You blink as he fades off into the mist and you're left to absorb the morning's events by yourself.  For a minute you're concerned with the wolves, but at least you've managed to keep Raphael as a friend.  Though, you are curious what he means by 'orphanage'.");
        // Concludify things
    ...
    private betrayRaphael(): void {
        ...
        this.outx("The other spends a little longer regarding you, wagging his tail playfully and smiling a friendly smile at you.  He then looks back and sees his brother heading in the wrong way.  <i>\"We're not heading back to Tel'Adre right away?\"</i>  His voice is almost as low as his brother's.\n\n");
        ...
        this.outx("Hati throws you one more amicable glance before turning, getting on all fours, and running off.\n\n");

        this.outx("You blink as he fades and you're left to reflect on these morning's events by yourself.  For a minute you're concerned for the fox, but the wolves don't seem like the types to harm him... much.  You are curious what they plan to do with him and what his 'sentence' might be, though.");
