...
export class FollowerInteractions extends NPCAwareContent {
    ...
    public amilyMeetsPureJojo(): void {
        ...
        this.outx(
            `Amily sighs and hugs him again, "<i>You're a pansy. You know that Jojo?  But I'm glad [name] reunited us so that we could meet again.</i>"\n\n`,
            false,
        );
    ...
    public jojoOffersRathazulMeditation(): void {
        ...
        this.outx(
            `Jojo is at Rathazul's lab.  The smaller, white mouse is asking the elderly rodent if he would like to meditate.  Rathazul considers for a moment and agrees, "<i>I'll have to try it when I have some time.  A little reflection would do my old soul some good.  However we cannot now; [name] has need of me.</i>"\n\n`,
            false,
        );
    ...
    private marbleIsPissyAndYourTooDumbToTalk(): void {
        ...
        if (this.player.findPerk(PerkLib.MarblesMilk) >= 0) {
            ...
            this.outx(
                `Marble moves protectively in front of you and turns to Amily.  "<i>This [race] is mine!  ${this.player.mf(
                    "He",
                    "She",
    ...
    private beAPimpMarbleLovesIt(): void {
        ...
        if (this.player.findPerk(PerkLib.MarblesMilk) >= 0) {
            this.outx(
                `Marble blinks before saying "<i>[name], try again, I know you're better than that.</i>"  You blink in response and wonder yourself what possessed you to say that.\n\n`,
                false,
            );
    ...
    public askAboutAmily(): void {
        ...
        // before Urta goes on duty at 1400:
            ...
            this.outx(
                `This is met with a chittering squeal you distinctly recognize as Amily's.  "<i>Oooohhh... I see why [name] - yeah, gimme all you got! - fell for you!</i>"\n\n`,
                false,
            );
    ...
    private endThisMadness(): void {
        ...
        if (FollowerInteractions.rand(2) == 0) {
            this.outx(
                `"<i>[name], I did this for you!  I loved you so much I worked to see what you liked in Urta!</i>" cries Amily.  Her face blushes, not in shame, but in anger as her temper flares.  She actually says, "<i>Everything, all of this, it was me wanting things to be perfect for YOU!  FOR US!  You... you... asshole!</i>"\n\n`,
                false,
            );
            this.outx(
    ...
    private beADickToAmily(): void {
        ...
        this.outx(
            `"<i>F-fuck you, [name],</i>" she finally rejoins.  "<i>You did the same damn thing.</i>"\n\n`,
            false,
        );
    ...
    public amilyUrtaSex(): void {
        ...
        this.outx(
            `With a gesture, the two of you set off.  As soon as you pass through the gates, you head towards the Wet Bitch.  Sure enough, Urta is at her usual table, and she smiles in delight to see you.  "<i>[name], Amily, hello!</i>"  You take seats at the same table, as she `,
        );
        if (!this.urtaLove())
