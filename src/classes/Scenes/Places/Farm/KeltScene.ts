...
"KeltOff" - Turns off Kelt */
    ...
    private keltFirstTime(): void {
        this.outx("As you approach Whitney's farm, you notice a figure in the pastures, way in the distance.  It seems to be someone riding a horse, to your surprise... possibly even Whitney herself.  You hadn't expected to find real horses in this forsaken realm.  If you could somehow trade for one, it would be a real help.  Energized by the idea, you hop the fence, approaching the distant figure.\r\r");
        this.outx("As you get closer, however, the figure comes into view.  The rider is not Whitney, but rather a muscular man.  And the horse has no head... where its head should be is... with a start, you realize that this is no horse and rider.  The figure is a large, male centaur!\r\r");
        this.outx("Wariness growing, you slow down.  But it is too late... the centaur has seen you.  With a snort, he gallops closer, imposingly tall.  You drop into a fighting stance, ready if he should attack you, and the centaur draws to a halt a few feet away.\r\rHe looks scornfully at you, and laughs, ");
        this.outx("\"<i>Don't be stupid.  You'd never even get close to me.  If I wanted to kill you, you would have been dead a long time ago.  My name is Kelt.</i>\"\r\r");
        this.outx("He touches a longbow that is strung around his chest.  The size of the bow is enough to convince you.  If he can draw back a bow that thick, he would surely have enough power to hit you from almost across the field.  A weapon like that could be very useful in fending off some of the monsters in this land.  The centaur notices you looking, and grins arrogantly.\r\r");
        this.outx("\"<i>Like my bow?  As well you should.  This is a real warrior's weapon!  If you want to learn someday, visit me again.  Maybe if you're not too stupid, you will be able to learn something.  I won't cross my fingers.</i>\"\r\r");
        this.outx("He laughs again derisively, and trots off.  You bristle slightly... he is irritatingly arrogant.  But if he can teach you to use a weapon like that, it may be worth putting up with his company...");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    // Naked Requirement
    private keltRequiresNakedness(): void {
        this.outx("Once more, you encounter Kelt the centaur at Whitney's farm.  You approach him to ask for another archery lesson, but Kelt is already scowling at you as you draw near.\r\r");
        this.outx(
        ...
        this.outx("He slaps a hand on his bare chest proudly, and you realize that he means for you to strip down naked.  When you protest, his eyes narrow with irritation, and his sneer becomes more cruel.\r\r");
        this.outx("\"<i>Didn't know you were a coward, too.  That's fine... go fuck off, then.  You can't handle it, then go back to your camp and braid your hair, or something.  If you wait long enough, I'm sure a nice minotaur will come along to make you his bitch.  'Bout all you're good for, right?</i>\"\r\r");
    ...
    private keltEagerlyGetNaked(): void {
        ...
        this.spriteSelect(35);
        this.outx("", true);
        this.outx("You have no problem stripping down naked in front of Kelt, even enjoying the process a little bit.  Judging by his leer, Kelt is enjoying it too.  He seems aroused by his power over you more than anything else... and you find yourself admitting that you're a little aroused by it as well.\r\r");
        this.outx(
        ...
        if (this.player.gender == 1 && this.player.biggestTitSize() < 1)
            ...
            if (this.player.biggestTitSize() == 0)
                this.outx("\"<i>Oops!  Could have sworn I'd find a pair of tits on you.  That's okay... I'm sure you'll hit puberty some day!</i>\"\r\r");
            // (Too small, A to DD:
            ...
            // (Big, Watermelon and beyond:
                ...
                this.outx("\"<i>Oooh, doesn't that look yummy?  Be honest... you wanna learn to shoot?  You'll be slapping yourself in the tits with every shot!  Heh... I bet that's the way you like it too!  Time to change your profession, slut.  Wet nurse and milk cow... they're just about all you're suited for!</i>\"\r\r");
        }
        this.outx("Despite his harsh comments, you can see the lust in Kelt's eyes, and are more than a little turned on by his derisive laughter.  His critique only becomes more lewd when you continue.  As you remove the lower half of your clothes, stripping completely naked, he eyes your ass and lets out a crude hoot of scornful delight, ");
        ...
        // (Medium, Large to Heavy:
            ...
            this.outx("\"<i>Hey, nice little cushion you got back here!  Do you get that from sitting around all day?  Nah, can't be that.  I'm sure you get more than a workout on this baby... of course, cock is no substitute for a little exercise, you know!</i>\"\r\r");
        ...
        this.outx("He slaps your ass with his open palm, getting in a good grope while he's at it.  His animalistic musk is in your nostrils, making you feel dizzy and more than a little aroused.  He grins widely, then walks around to your front, ");
        // (No Cock:
        if (this.player.totalCocks() == 0)
            this.outx("\"<i>Well, aren't you a pretty little thing, all together.  You and I will get along real nice, that's for sure!</i>\"\r\r");
        else {
            // (Any Cock:
            this.outx(
            ...
            if (this.player.cocks[0].cockType == CockTypesEnum.HUMAN)
                this.outx("\"<i>Heh.  Just sporting the normal model, huh?  You know there's a phrase around here... hung like a human!  Trust me... it's not a compliment.  ");
            // (Dog Cock:
            if (this.player.cocks[0].cockType == CockTypesEnum.DOG)
                this.outx("\"<i>Oh, lookie here!  We got ourselves a little doggie dong!  Well, cock or not, you'll always be a bitch to me, mutt.  ");
            // (Horse Cock:
            if (this.player.cocks[0].cockType == CockTypesEnum.HORSE)
                this.outx("\"<i>Now that's just sad.  Getting a little envious of me, huh?  Had to go out and get a nice horsecock all your own?  Should have asked.  I'd have given you a taste of mine!  ");
            // (Tentacle Cock or other weirdness
            if (this.player.cocks[0].cockType.Index >= 3)
                this.outx("\"<i>Hah!  I'll bite... what the fuck are you supposed to be?  That a cock, or just an ugly, misplaced tail?  HA!  ");
            ...
            // (Medium Size, 11-20 inches:
                ...
                this.outx("\"Still, at least you've got a decent sized cock.  You know, for a colt.  Maybe you'll get lucky, and the real women will take pity on you!</i>\"\r\r");
        ...
        this.outx("He looks you over one last time, and sneers condescendingly.  \"<i>Well, it ain't much as far as heroes go.  But it's better than nothing.  Fine, I'll teach ya some more.  But I don't want to see those damn clothes again.  You'll learn the way I tell you to learn, got it?</i>\"\r\r");
        this.outx("You nod, almost grateful for the excuse to go naked.  From the way Kelt is eyeing your ass, you think he'll enjoy it too.\r\r");
    ...
    private keltReluctantlyGetNaked(): void {
        ...
        this.spriteSelect(35);
        this.outx("", true);
        this.outx("You are uncomfortable with the idea of being naked in front of this crude, cruel taskmaster.  But he is good at what he does, and if this is the only way to convince him to teach you, then you'll just have to get it over with.  You agree to his terms reluctantly, and begin to strip off your clothes.\r\r");
        this.outx(
        ...
        this.outx("He looks you over one last time, and sneers condescendingly.  \"<i>Well, it ain't much as far as heroes go.  But it's better than nothing.  Fine, I'll teach ya some more.  But when I tell you to strip, you do it a little faster next time... or I might not be so generous.</i>\"\r\r");
        this.outx("You nod, a little irritated at his callous nature.  You're not entirely sure you want to be naked in front of this crude centaur... but for now, at least, he'll teach you a little more.  Though the way he eyes your ass does make you feel a little uncomfortable.\r\r");
        // (+7 Submissive)
    ...
    private keltRequiresBlowjobs(): void {
        ...
        this.outx("Crossing the field of Whitney's farm, your heart begins to beat a little bit faster as you spy Kelt the centaur off in the distance.  You can't help but admire his powerful flanks and his proud stature as he runs freely.  Perhaps a little pleased with yourself, you also take a good look at his dangling equipment, sheathed yet sizable.  The sight is entrancing.\r\r");
        this.outx("A grin crosses your face, despite yourself.  Kelt can be insufferable sometimes.  Most times.  Okay, at all times.  But there is something about him that makes you feel... right, somehow.  Sure he insults you... but he is so strong, so powerful.  So masculine, for lack of a better word.  Infuriating, arrogant, and utterly in control.  Somehow, the combination makes you feel weak at the knees.\r\r");
        this.outx('"<i>Enjoying the sights, are we?</i>"\r\r', false);
        this.outx("You blink, startled.  While you were thinking, Kelt approached you, and you were staring directly at his crotch.  He leers down at you with an arrogant grin.  Flushed, you stammer out that you're here for more archery lessons.  He snorts, clearly amused.\r\r");
        this.outx("\"<i>Yeah, I'll bet.  When they talk about firing shafts, whore, they're talking about arrows.  Bet you would prefer the other kind though, huh?</i>\"\r\r");
        this.outx("He paces around you, in an almost predatory fashion.  His thick flanks brush up against you, and the smell of him is so potent you feel a little dizzy.  Heady and musky, the scent is like a keen aphrodisiac, cutting straight to your core.  You whimper a little, and Kelt raises an eyebrow.  Is it you, or does he almost look satisfied?\r\r");
        this.outx("\"<i>Well, I think you've had enough freebies.  Maybe I don't wanna teach you anymore.  After all... what do I get from it?  I spend all day teaching a moron how not to shoot [him]self in the foot, and I got nothing to show for it.  I think it's about time you put down a little payment.</i>\"\r\r");
        this.outx("You nod automatically, fumbling for the pouch you store gems in.  Kelt casually backhands you as you do so, knocking you to the ground.  Your cheek burns hotly, and your head has cleared a little from the pain.  Kelt is sneering down at you, but there is something darkly pleased in his expression.\r\r");
        this.outx("\"<i>I don't want your fucking money.  What am I gonna buy... hentai comics and scholar tea?  Fuck off.  You want to learn more about archery?  Then it's about time you showed some gratitude.</i>\"\r\r");
        this.outx("He pushes you over with ease, toppling you facedown into the mud.  Sputtering, you try to rise, only to find that Kelt has moved so that he stands above you, hooves on either side of your head.  Wiping slime from your face, you realize why.  Beneath the barrel of his stomach, his massive cock is slowly dropping from his sheath, growing larger by the second.\r\r");
        this.outx("You can't help but stare at the engorged head, flaring out from the tip of the mottled shaft.  Above you, Kelt snorts, sounding more like an impatient horse than a person, and moves forward slightly; his half-erect member presses against your cheek.  You let out a startled yelp as the hot, damp flare presses against your face, staining your cheek with a thick dollop of precum.  Kelt grunts again, more urgently.\r\r");
        this.outx(
        ...
        this.outx("You swallow hard.  You don't have to take this!  Kelt is an arrogant, abusive, well-hung, enticing, delicious... you shake your head, thoughts clouded.  The cock grows larger and thicker by the second, and the musk of it delights your senses.  Part of you reasons that one little blowjob won't hurt... right?");
        this.outx("\r\rDo you submit?");
    ...
    private keltBlowjobRequirementNever(newl = true): void {
        ...
        this.outx("You struggle, trying to hold onto your fragmented thoughts. Something about Kelt's scent, or presence, is overwhelming.  The temptation to give in is almost overpowering, but you set your teeth, close your eyes, and furiously try to ignore your hammering heart.\r\r");
        this.outx("Kelt's feet move almost uncertainly, hooves pawing at the ground and resetting themselves.  He almost seems confused for a moment, hips bucking forward experimentally.  When there is no further sensation, his confusion begins to be replaced by anger.\r\r");
        this.outx("He spends a few moments cursing you, swollen cock still sometimes pumping forward as though expecting you to latch on at any moment. The centaur is obviously unused to rejection.  The temptation bites harder than ever as his cruel words shame you.  Wouldn't it be easier to just give in?  To give this powerful male what he wants, so he'll like you again?  The cock hovers teasingly within reach, just waiting to give you a glorious taste... but you fight the alien urge, and keep your mouth shut.\r\r");
        this.outx("You have just a moment to react, as the tone suddenly shifts.  Kelt, who has been stomping and cussing angrily, has decided on a new target.  Training remembered, you roll to the side just as Kelt rears and brings his front two hooves down where your head was moments earlier.\r\r");
        this.outx("Kelt moves towards you, eyes blazing, and you drop into a crouched stance automatically.  Even so, you are overwhelmed by another blow to the face as Kelt furiously lashes out at you.  You scramble to defend yourself, but the attack, such as it was, is over as soon as it began.  The abusive centaur is already moving away, frustration clear with every step.\r\r");
        this.outx(
    ...
    private keltBlowjobRequirementShamefully(newl = true): void {
        ...
        this.outx("\"<i>Here's the rule.  You want archery lessons?  Fine.  I'll keep teaching you, stupid bitch that you are.  But when I say so, you kneel and take your turn.  If I have to teach an ugly slut like you, the least you can do is choke one down.  Lesson's over.  See you tomorrow, bitch.</i>\"\r\r");
        this.outx("He leaves, obviously quite pleased with himself, as you lie, exhausted, in a small pool of his cum.  The smell of it clings to you, even after you push yourself upright and begin hobbling back to camp, arms clutched around your swollen stomach.  Part of you is humiliated, and never wants to see Kelt again.  The other part?  Well, the other part is anxiously hoping that he'll be feeling horny enough again next time to give you another chance to suck his cock.\r\r");
        this.outx("It may be unhealthy, to keep going back to him.  Of course, you could always say no, right?  He is a good teacher.  And... and would it be so bad to suck him off a few more times?  That wouldn't be so bad... would it?\r\r");
    ...
    private keltBlowjobRequirementEagerly(newl = true): void {
        ...
        this.outx("It is like someone answered your prayers.  You eagerly agree, babbling your thanks to Kelt as you are faced with the massive cock, growing harder and harder.  He snorts scornfully.\r\r");
        this.outx(
    ...
    private keltMainEncounter(): void {
        this.spriteSelect(35);
        this.outx("Once more, you encounter Kelt the centaur at Whitney's farm.  He smirks at you, and asks if the fool has come once more to learn from the master.\r\r");
        // (Submissive 0-30:
        if (this.player.statusAffectv2(StatusAffects.Kelt) <= 30)
            this.outx("You grind your teeth in irritation, but swallow your pride enough to ask him for help.  ");
        // (Submissive 30-70:
        else if (this.player.statusAffectv2(StatusAffects.Kelt) <= 70)
            this.outx("You nod reluctantly, and Kelt grins.  He may be arrogant, but he is rather good.  ");
        // (Submissive 70-100:
        else this.outx("You nod enthusiastically, almost begging him to teach you.  ");

        // (Before Naked Requirement)
        if (this.player.statusAffectv3(StatusAffects.Kelt) <= 3) {
            this.outx("Kelt seems to find the idea of training a human almost comical, but suggests that if you want to follow him around for a while, he has no problem with it.  Though his attitude is annoying, you resolve to learn what you can.\r\r");
        }
    ...
    private keltMainEncounterAfterNakedReq(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.NakedOn) >= 0) {
            this.outx("He nods, smirking slightly, and gestures at your clothes impatiently.  With some pleasure, you strip down before him, discarding your clothes with a little flair.  Kelt is grinning by the end, openly admiring your body, and you feel a little more aroused for obeying his dominant command.\r\r");
            // (+5 Submissive)
        ...
        // (Naked Off)
            ...
            if (KeltScene.rand(10) <= 5) {
                this.outx("Kelt looks down your body scornfully, and claims he is unwilling to teach you unless you are willing to learn naked again.  ");
                ...
                // (Otherwise:
                    ...
                    this.outx("\r\rYou're not certain you want to practice naked again... particularly with the way Kelt is looking at you, his arrogant smirk plastered on his face.  Do you agree to his terms?");
                    // (Yes[+5 Submissive]
                    //  No[Never event])
            ...
            // (Otherwise:
                ...
                this.outx("Kelt looks at your clothes sourly once more, and mocks you for what he calls 'human sensitivity'.  He does not, however, directly tell you to take them off.\r\r");
                // (Corruption 60+, or Submissive 60+:
                if (
                    (this.player.cor + this.player.lib + this.player.lust >= 180 &&
                        this.player.inte < 40) ||
                    ...
                    this.outx("This time, though, the idea turns you on a little.  You ask Kelt if he would prefer to see you naked, and begin stripping down in front of him.  He seems surprised but obviously enjoys the show, and you are incredibly aroused by his attention.  Part of you reasons that if training naked is better, maybe you should just strip down right away, each time?  The thought is more than a little stimulating.");
                    if (
                        (this.player.cor + this.player.lib + this.player.lust >= 220 &&
                            this.player.inte < 40) ||
                        this.player.statusAffectv2(StatusAffects.Kelt) >= 75
                    ) {
                        this.outx("  <b>You cast a seductive smile Kelt's way and decide you should always strip before practice</b>.");
                        this.player.createStatusAffect(StatusAffects.NakedOn, 0, 0, 0, 0);
                    }
                    this.outx("\r\r");
                    this.dynStats("lus", Math.floor(this.player.lib / 10) + 5);
                ...
                // (Otherwise:
                    ...
                    this.outx("You ignore his barbed comments as best as you can, and soon enough, he leaves the matter alone, instead critiquing your archery skills.\r\r");
            }
        }
        this.keltMainEncounter2();
    }
    ...
    private keltMainEncounter2(): void {
        ...
        if (this.player.hasKeyItem("Bow") < 0) {
            ...
            this.outx("Despite his mocking description, the bow he gives you really is a decent weapon.  You take it up and start towards the practice field, Kelt following behind.\r\r");
            if (this.player.hasKeyItem("Bow") < 0) this.player.createKeyItem("Bow", 0, 0, 0, 0);
        }
        // (Bow equipped)
        else {
            this.outx("Kelt sneers as he looks at your bow, \"<i>You're still using that rotten old thing?  Well, it will do.  We'll just have to shoot for the close targets.</i>\"\r\r");
            this.outx("Together, the two of you head off to the practice field.\r\r");
        }
    ...
    private keltMainEncounter3(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.NakedOn) < 0) {
            ...
            if (this.temp == 3) {
                if (this.player.race() != "centaur")
                    ...
                    this.outx("\"<i>As a centaur, I'd recommend suicide.  Really, it's that or man the fuck up.</i>\"\r\r");
            }
        ...
        // NAKERS
            ...
            if (this.player.inHeat && this.player.gender > 1) {
                ...
                this.outx("You lean over to pluck the arrow from the haystack, and feel a sharp blow to the back of your head, knocking you over and sending your consciousness spinning.  Dizzily, you realize Kelt is standing over you, tossing aside the bow he just used to crack you in the head.  Between his horse legs, a massive manhood is dropping from his sheath, flanked by testes the size of softballs.  A lewd grin is on his face.\r\r");
                this.outx("\"<i>Did you think I wouldn't notice, slut?  You reek like a mare in heat.  I could smell it on you the moment you arrived.  Fortunately, I know just what to do with a fertile bitch.  Let's put a baby centaur in that tight pussy of yours.</i>\"\r\r");
                this.outx("Kelt's forelegs rear up just enough to plant them around your shoulders, his massive weight bearing down on you.  The bale of hay lifts you just high enough to line up with his fat erection, which presses between your asscheeks even now.\r\r");
                // (Submissive, 0-30:
                if (this.player.statusAffectv2(StatusAffects.Kelt) <= 30)
                    this.outx("You struggle as best as you can, but Kelt weighs a good deal more than you do.  As his thrusting hips anxiously press his cock to your nether-lips, you realize this is going to happen, whether you want it to or not.  The thought fills you with an undeniable shiver of pleasure.\r\r");
                // (Submissive, 30-70:
                else if (this.player.statusAffectv2(StatusAffects.Kelt) <= 70)
                    this.outx("You put forth a token effort to escape, but it is obvious from the beginning that there is no way to get out from under the heavy weight of the centaur.  Besides, the desire running through you is palpable... in a way, you want this to happen.  So much so that as Kelt is thrusting, trying to line up his cock, you raise your hips to help him out, silently longing for penetration.\r\r");
                // (Submissive, 70-100:
                else
                    this.outx("The masculine scent of him is overpowering, desperate.  Your body wants nothing more than to submit to Kelt's ferocious desires, and your mind agrees.  Eagerly, you thrust your hips up, reaching back with one hand to guide his cock to your wet pussy.  Kelt snorts his approval, and you feel a shivering tremor of lust run through you.\r\r");

                this.outx("The centaur's cock has truly equine proportions, being easily two and a half feet long and over three inches thick.  ");
                // (Vagina, Small:
                if (this.player.vaginalCapacity() <= 16)
                    this.outx("The fit seems impossible, but Kelt could care less about your comfort, and shoves the flared head into you without hesitation.  You let out a scream, feeling like you are being torn apart by his cock as it rudely presses against your insides, spreading you wide open.  Kelt thrusts with growing frustration, but can fit no more than half his cock inside of you, despite his best efforts.  Every twitch makes you cry out as your tight pussy squeezes and milks that massive organ.\r\r");
                // (Vagina, Medium:
            ...
            // (Naked, 60% Chance)
            if (temporary <= 2) {
                this.outx("The lesson proceeds as normal, with you taking shots while Kelt arrogantly critiques your style, tossing out colorful and creative insults whenever possible.  He has no shame about mocking your body as much as he laughs at your archery, and makes several crude comments about what it might be good for.");
                // (Submissive, 0-30:
                if (this.player.statusAffectv2(StatusAffects.Kelt) <= 30)
                    this.outx("You try to ignore the foul remarks, telling yourself that this is simply the way he is.  It does not help, though, that at times you feel Kelt's eyes wandering across you lustfully.  At least some of his comments are not mockeries, but suggestions.  The entire experience makes you feel a little more uncomfortable around the abusive centaur.");
                // (Submissive, 30-70:
                else if (this.player.statusAffectv2(StatusAffects.Kelt) <= 70)
                    this.outx("Despite yourself, some of his cruder comments make you blush.  By now, you're getting used to the oft times depraved sexuality of the demon world... but it is a little humiliating to subject yourself to this kind of treatment... and, to your shame, sometimes it's a little arousing.  Though Kelt is insulting, cruel, and crude, you also notice real lust in some of his glances.  By the end of the lesson, you are flushed with arousal as well as exertion.");
                // (Submissive, 70-100:
                else
                    this.outx("Of course, Kelt's words only distract you even more from hitting the target.  Not because you are angry... but because you are aroused.  Somehow, his lewd comments and crude jibes make you shiver with anticipation.  He's just so powerful, so masculine.  Kelt seems well aware of the effect he has on you, and once reaches out to slap your ass heartily.  By the end of the training, you feel intensely horny.");
            ...
            if (temporary == 3) {
                ...
                this.outx("Indignantly, you cover your breasts with your hands, telling him to be serious.  He laughs again, more cruelly this time.\r\r");
                this.outx("\"<i>I am being serious.  Women aren't warriors.  And those with tits do not become warriors.  I just think it's funny. You, begging me to teach you, while you have those udders hanging off your chest!</i>\"\r\r");
                this.outx(
                ...
                // (Medium Size, E-HHH:
                    ...
                    this.outx("\"<i>Just look at these mommy melons!  You want to be an archer?  I'm amazed you don't slap yourself in the tits with every shot!  Easy target to grab onto.  But hey, I bet you like it that way.  Like it when people grope these fat titties of yours?</i>\"\r\r");
            ...
            if (temporary == 4) {
                ...
                this.outx("He lifts up with his fingers, painfully raising you off the ground with his great strength.  You squirm, aroused despite yourself by this sudden intrusion, and Kelt growls, lowering you to the ground and releasing your hair.  Moments later, your bow is in your hand... though Kelt has still not removed his fingers.\r\r");
                this.outx("\"<i>Okay.  Now that our little bitch is getting an assfuck, maybe she'll be satisfied enough to hit the fucking target.  Now shoot... and don't you dare fuck this up again.</i>\"\r\r");
                this.outx("Groaning, distracted and unnerved, you hurriedly line up the shot as best as you can.  Kelt's fingers flex, forcing you to stand up straighter.  Your arm shakes as you take aim, and you can feel Kelt's hot breath on your hair, and then the arrow is flying!  Ten meters... five... bullseye!\r\r");
                this.outx("With a snort, Kelt shoves you to the ground, removing his fingers as he does so.  Wincing, you sit up with the centaur staring down at you snidely.\r\r");
                this.outx("\"<i>Lesson's over for now.  Next time it's my cock, slut.</i>\"\r\r");
                this.outx("He walks away without another word, taking some of your dignity with him.");
                // (+5 Submissive)
    ...
    private keltMainEncounterPostBlowjob(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.BlowjobOn) >= 0) {
            ...
            if (
                ...
                this.outx("It is almost too much to wait for your meeting with Kelt today.  His familiar musk enflames your senses, making you ache with need.  You try to wriggle your ass enticingly for Kelt as the two of you walk, eager to start in on the usual blowjob.  Even you don't usually hunger after it this much, but a need for Kelt's cock fills you to the core.  You long for nothing more than to service your mighty stud.\r\r");
                this.outx("To your surprise, Kelt leads you not towards the practice field, but towards a small barn, near the edge of the field.  When you meekly ask why he's taken you here, his brow clouds and he lashes out, striking you with casual violence.  ");
                this.outx(
                    '"<i>Bitch!  I said get in there.  Do I need to repeat myself, you stupid whore?"</i>\r\r',
                    false
                );
                this.outx("Scrambling to your feet and babbling apologies, you hastily open the door to the barn, entering immediately.  Before you is a thin, upraised table, with straps in it, like saddle stirrups.  Your heart leaps excitedly, and Kelt laughs a little to himself as he tells you to get on, facedown.  You hasten to comply.\r\r");
                this.outx("Lying on the rough table with your feet in the stirrups, your ass is suspended at just the right height.  Kelt moves with obvious hunger, running his finger along your nethers.");
                // (Penis:
                if (this.player.totalCocks() > 0)
                    this.outx(
                ...
                this.outx("\r\r\"<i>Oh?  Like that, do you?  Well, we're not here for what you like.  You're here to satisfy me, slut.  And I know what I'm after.</i>\"\r\r");
                this.outx(
                ...
                this.outx("\r\r");
                this.outx("You can't help it... at the thought of being used as his worthless fucktoy, you suffer a mild orgasm of your own, crying out your submission to this powerful creature.");
                // (Penis:
                if (this.player.totalCocks() > 0)
                    this.outx(
                ...
                // (Vagina:
                if (this.player.hasVagina())
                    this.outx("  Your poor, neglected pussy quivers with delight, convulsing without even being touched.  Thick juices run freely down your leg, dripping off to splatter the hay below you as you moan like a bitch in heat.");
                // (Genderless:
                if (this.player.gender == 0)
                    this.outx("  Never before has a complete lack of genitalia been so frustrating... or pleasurable.  Not being able to physically cum, the explosions of climax simply rack up within your body... waves of cascading pleasure with no release and no mercy.");
                this.outx("\r\rIf anything, your orgasm only seems to spur Kelt on, causing him to push deeper and faster.  The idea of fitting his massive, nearly three-foot cock into your bowels seems ludicrous, but the aggressive centaur obviously has no intention of taking 'no' for an answer.  With each powerful thrust of his hips, he sinks more cock deep within your ass, filling you, stretching you, ripping you open with still more to come.  It is almost a terrible relief when you feel his massive testicles colide with your ass, buried at last to the hilt. Even in victory, Kelt is snide.  ");
                if (this.player.looseness(false) < 3)
                    this.outx("\"<i>Fuck!  About time!  Sure got a tight little ass back here, but don't worry, slut.  We'll stretch it out in no time. I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\r\r");
                ...
                this.outx("The torrent of jizz is pumped into you lewdly, Kelt's heavy testicles blasting burst after burst into your bowels, filling your belly with hot centaur cum.  He doesn't relent until well after your ass has been filled to the point of making you sick... at one point you cough up a mouthful of his cum, only to weakly try to swallow it back down.  It is your master's cum... it belongs inside you.\r\r");
                this.outx("When Kelt pulls out, he leaves behind your ravaged asshole, spread wide and filled with cum.  You whimper as he withdraws, but are unable to move, unable to think.  You dimly hear him laughing at you again, and taste his cum once more as he dips a finger into your gaping asshole and presses it to your lips.\r\r");
                this.outx("\"<i>Now stay there for a while, bitch.  Let it get good and stuck up there.  Come back tomorrow, and maybe, if you're lucky, I'll fuck you again.  You do, after all, make a pretty good cumdump.</i>\"\r\r");
                this.outx("It's some hours later before you rouse yourself, clenching your ass as best as you can to keep the tide inside.  Despite your efforts, a steady trail oozes down your leg, marking your path as you slowly, happily trudge back to your camp.");
                this.doNext(this.camp.returnToCampUseTwoHours);
                this.player.slimeFeed();
                // (+10 Submissiveness)
                if (this.player.buttChange(70, true)) this.outx("\r\r");
                this.player.addStatusValue(StatusAffects.Kelt, 2, 10);
                this.player.orgasm();
                this.dynStats("cor", 1);
                return;
            ...
            // (Otherwise)
                ...
                this.outx("You hardly remember the rest of the training.  You're far too distracted by the fullness of your belly, and the thought of maybe getting a little more.  Kelt seems almost bored by the end, despite your attempts to entice him during the lesson, and leaves soon afterwards, to your chagrin.");
                this.player.slimeFeed();
                // (+5 Submissiveness)
                this.player.addStatusValue(StatusAffects.Kelt, 2, 5);
        ...
        // (Blowjob Requirement Off, 40% Chance)
            ...
            this.outx("You move towards the practice field, trying to ignore the way Kelt openly and hungrily eyes your naked body.  He has become more and more open about his lust for you.  Despite yourself, you can't help but enjoy his attentions.\r\r");
            this.outx("Once at the field, you move to draw an arrow and begin practice, when Kelt roughly pushes you down to your knees.\r\r");
            this.outx("\"<i>Not today, bitch.  I think it's time you gave a little back.  So be a good little whore, and get to work on my cock.  I'm gonna bust a nut in that pretty little mouth before I do any more teaching.</i>\"\r\r");
            this.outx("A shiver of desire and a tremor of fear run through you.  You had hoped to avoid this requirement.  A hunger lies within you... the thought of once more slurping down centaur cum is all but irresistible.  But you fear that with each time, you are losing yourself more and more...\r\r");
            // (Submissiveness +80, or Corruption +80)
            if (
                this.player.cor + this.player.lib + this.player.lust >= 220 &&
                this.player.statusAffectv2(StatusAffects.Kelt) >= 80
            ) {
                this.outx("You try to resist the need.  You honestly try.  But this time, there is just no stopping it.  Your desire for Kelt to cum within you again is so great, you fall to your knees immediately before him, waiting hungrily for your treat.  A part of you wonders why you ever resisted in the first place... in fact, why not suck him off before every lesson?  Surely that would make him like you more...\r\r");
                this.doNext(this.keltSubmitGivingBJ);
                return;
            }
            // Otherwise)
            else {
                this.outx("Despite the need, despite the desire, you are still in control of yourself enough to make a choice.  Do you submit to the centaur's will, and your own hunger?  Or will you somehow find the strength to walk away?");
                // Submit
                //
                // Resist!
                this.simpleChoices(
    ...
    private keltResistGivingBJ(): void {
        this.spriteSelect(35);
        this.outx("", true);
        this.outx("Summoning what remains of your fragmented willpower, you resist the need, apologizing to Kelt and turning to walk away.  It hurts to do so, aching within your chest with an almost physical need to go back; to apologize and kneel before him worshipfully.\r\r");
        this.outx("To your surprise, however, Kelt does not seem particularly bothered.  In fact, he laughs as you leave.\r\r");
        this.outx(
    ...
    private keltSubmitGivingBJ(): void {
        ...
        this.player.slimeFeed();
        this.outx("", true);
        this.outx("\"<i>There we go.  Who's a good little whore?  Who's a hungry little slut?  Okay, bitch... time to fill that belly of yours.  Open wide.</i>\"\r\r");
        this.outx("Reluctantly, with shame burning in your cheeks and desire ravaging your mind, you lower yourself before him and do just that.\r\r");
    ...
    private keltCentaurBadEnd(): void {
        ...
        if (this.player.gender == 1) {
            ...
            this.outx("Roughly he seizes hold of your crotch, making you whinny slightly.  Whether from pain or pleasure, however, is harder to tell.  You feel strange, conflicting emotions... primarily a need to be with Kelt, to pleasure Kelt, to fuck Kelt... the urgency surprises you.  Even more surprising is the fact that your cock is entirely flaccid.\r\r");
            this.outx(
                '"<i>Well, I\'ve got no use for males, slut.  Fortunately, you still have something I can use in the meantime.</i>"\r\r',
                false
            );
            this.outx("His legs rear suddenly, wrapping around the barrel of your body. You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ");
            this.outx("<b>... It was for him to fuck you!</b>\r\r");
        ...
        if (this.player.gender == 0) {
            ...
            this.outx("Roughly he shoves a couple of fingers into your asshole, making you whinny slightly.  Whether from pain or pleasure, however, is harder to tell.  You feel strange, conflicting emotions... primarily a need to be with Kelt, to pleasure Kelt, to fuck Kelt... the urgency surprises you.  But how... and with what?\r\r");
            this.outx("\"<i>Well, man or woman, it doesn't matter to me.  You're still only good for one thing.  Time to give you a purpose, slut.</i>\"\r\r");
            this.outx("His legs rear suddenly, wrapping around the barrel of your body.  You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ");
            this.outx("<b>... It was for him to fuck you!</b>\r\r");
            this.outx("Kelt does not hesitate in aserting his dominance, and immediately pushes his shaft towards your ass, inserting it with ease.  You let out an almost feral cry of pleasure, and Kelt laughs nastily as he gets a better grip and sinks his erection in deeper, humping away at your hindquarters needfully.  His human hands wrap around you, taking hold of your chin and forcing you to turn enough to face him as he savors your wincing moans.\r\r");
            this.outx(
        ...
        if (this.player.gender >= 2) {
            ...
            if (this.player.gender == 3) {
                ...
                this.outx("It isn't, of course.  Not at all... you are entirely flaccid, and Kelt knows it.  He grasps the base of your cock roughly, giving it a few experimental tugs, laughing derisively as he does so.  There is no reaction... save that your cunt gets a little wetter.\r\r");
                this.outx('"<i>Well, no matter.  This here is what I came for.</i>"\r\r', false);
            }
            // (Both)
            this.outx("Crudely, Kelt pushes three fingers into your exposed pussy, making you whinny slightly.  He laughs to himself, then pushes four fingers in... then his whole fist.  You whimper and moan, unable to tell yourself to walk away.  He pumps his hand experimentally for a moment, taking pleasure in how easily he disarms you.  Horny and needful, you couldn't stop him if you tried.\r\r");
            this.outx("\"<i>Aww... we sure got a pretty little filly here, don't we?  Still, a filly isn't really happy unless she's being fucked.  Unless her stomach is full of foals for her master.  And since you've gone to the trouble of preparing yourself for me, bitch... I guess I'll just have to do the job.</i>\"\r\r");
            this.outx("His legs rear suddenly, wrapping around the barrel of your body.  You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Your vagina drools anxiously, ready for him, ready to be seeded with his foals.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!");
            this.outx("<b>... It was for him to fuck you!</b>\r\r");
    ...
    private keltBadEndEpilogue(): void {
        ...
        this.outx("The heroine paled, and turned around to face the male, berating herself for letting him sneak up on her.  Brandishing her sword, she tried to step backwards, wary of an attack.  The centaur eyed her sword amusedly, then broke out into a nasty laugh, ");
        this.outx(
        ...
        this.outx("He waved confidently at the mare, still nursing her young with a rapturous look on her face.  Cum slowly oozed out of her pussy, pooling on the ground beneath her, and the heroine felt a little envious for a moment.  Most horses had harems, the virile male satisfying many women at once.  How many times a day was this mare fucked?\r\r");
        this.outx(
    ...
    private keltResistance(): void {
        ...
        this.outx(" as Kelt's insults go too far.  You've had just about enough of his disingenuous assertions!\r\r");
        this.outx("An idea on how to put him in his place slowly forms in the back of your mind, though you're sure pulling it off would humiliate the puffed-up centaur into never his showing his face around the farm again.  Do you do it?");
    ...
    private fuckKeltsShitUp(): void {
        ...
        if (
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cocks[0].cockLength <= 10) {
                    if (this.player.balls > 0)
                        ...
                        this.outx("Your genital slit bumps into his chin as your cock finds the back of his throat. ");
                    this.outx("He is now entirely engaged with your length, moving his head back and forth as his tongue slathers it with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, moving his head in rhythm with your own movements.\r\r");
            ...
            // If Female:
                ...
                this.outx("You feel a mighty groan and Kelt's cock begin to pulse urgently against your tail.  Quickly and expertly, you wrap the end around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cunt.\r\r");
            ...
            // If Genderless:
                ...
                this.outx("You feel a mighty groan reverberate through you and Kelt's cock begin to pulse urgently against your tail.  Quickly and expertly, you wrap the end around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your ass.\r\r");
        ...
        // Standard anti-kelt scene
            ...
            if (this.player.tallness < 50 || this.player.totalCocks() == 0) {
                if (this.player.tallness < 50)
                    this.outx("Realizing you're too short to dominate him properly, you come up with another plan.  ");
                this.outx(
            ...
            if (this.player.gender == 0) {
                ...
                if (this.player.cocks[0].cockLength < 10)
                    ...
                    this.outx("taking the entire thing deep into his throat.  Apparently centaurs lack a gag-reflex, and you can see his throat stretched around you as you're brought to ");
                else
                    this.outx("taking as much as he can deep into his throat.  Even though his entire neck is distorted by your massive member, his throat simply isn't long enough to take any more.  You writhe as the throat-fucking brings you to ");
                this.outx("an explosive orgasm.  You deposit your cream directly into his belly, making him burp when you pull out, dripping on the centaur's abused lips.\r\r");
            }
            this.outx(
            ...
            this.outx("You redress before the comatose centaur gets a chance to come to his senses, and wonder if he'll recover enough of his pride to face you again.");
        }
        this.player.orgasm();
