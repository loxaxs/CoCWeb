...
export class Marae extends AbstractBoatContent implements TimeAwareInterface {
    ...
    public encounterMarae(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) < 0) {
            ...
            if (this.player.findStatusAffect(StatusAffects.MetMarae) < 0) {
                ...
                // Explain the dungeon scenario
                    ...
                    this.outx("You take a step back, amazed to find such a creature, apparently uncorrupted.  ");
                    if (this.player.lib + this.player.cor > 80)
                        this.outx("Your eyes can't help but take note of the tree-woman's shapely breasts, and wonder if they feel like tits or wood.  ");
                    this.outx("Feeling a bit confused, you introduce yourself and ask her who she is.\n\n");
                    this.outx(
                    ...
                    if (this.player.lib + this.player.cor > 80) {
                        this.outx("You could leave, but the desire to feel her breast will not go away.  What do you do?");
                        this.simpleChoices(
                            "Boob",
                            this.grabHerBoob,
                            "",
            ...
            // Second meeting
                ...
                this.outx("You approach Marae's tree, watching the goddess flow out of the tree's bark as if it was made of liquid.   Just as before, she appears as the top half of a woman, naked from the waist up, with her back merging into the tree's trunk.\n\n");
                if (this.player.cor > 66) {
                    this.outx(
        ...
        // Dungeon inoperable
            ...
            if (this.player.findStatusAffect(StatusAffects.FactoryOverload) < 0) {
                this.outx("Marae smiles broadly at you, and steps free from her tree.  The lithe plant-goddess gives you a warm hug and a kiss on the cheek.\n\n");
                this.outx(
    ...
    private maraeBadEnd(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.MetCorruptMarae) < 0)
            this.outx("The goddess flows out of the tree, stepping away from it as a living woman, curvy and nude.\n\n");
        this.outx("She approaches you, her breasts swinging pendulously and dripping sap.   Mesmerized by her swaying mammaries, you watch until she mashes you into them with an enormous hug.  A hand traces down your chest to your groin");
        if (this.player.gender == 0) this.outx(" where it pauses in momentary confusion");
        this.outx(".  She giggles and presses your face into her one of her verdant nipples.  You open your mouth to accept the purplish-green bud, licking and suckling it, encouraging her sweet sap to flow into your hungry mouth.  She gushes fluids and pulls you tightly against her tits, crushing you with soft flesh.\n\n");

        this.outx("The sap inside you makes your throat and belly tingle warmly, as if you had taken a strong drink.   Her milk-sap flows so quickly that you have to gulp it down to keep up.  Tiny burps escape your mouth every now and then as you work to gulp down the tainted treat.  You feel happy and secure, nestled in the bosom of a lust goddess.  ");
        if (this.player.statusAffectv3(StatusAffects.Marble) > 0)
            this.outx("Any thought or need to drink Marble's milk vanishes from your mind and body.  ");
        this.outx("Foggy euphoria seems to float into your mind, making it difficult to think of anything but emptying the nipple in front of you.   You feel the last few drops splash on your tongue before unnatural strength breaks the seal, yanking you away and forcing a fresh dripping tit into your lips.\n\n");
    ...
    private maraeStealLethicite(): void {
        ...
        if (
            ...
            this.outx("You dart to the side, diving into a roll that brings you up behind the tree.  You evade the gauntlet of grabbing tentacles that hang from the branches, snatch the large gem in both arms and run for the beach.  You do not hear the sounds of pursuit, only a disappointed sigh.");
        ...
        // (FAIL)
            ...
            this.outx("The tentacles lower you to the ground, but do not release you from their tight embrace.\n\n");
            this.outx(
            ...
            if (this.player.gender == 1 || (this.player.gender == 3 && Marae.rand(2) == 1)) {
                this.outx("She extends a hand expectantly, watching with detached concentration while a tentacle lowers from the tree into her palm.   Hips swaying sexually, she advances, peeling back the tentacle's outer layer.  It opens up to reveal a wet, gummy mouth.  She giggles and bumps the opening against your ");
    ...
    public level2MaraeEncounter(): void {
        ...
        this.outx(", a familiar island resolves itself in the center of the lake.  There's a familiar tree perched atop it, though the wriggling tentacles' silhouette against the sky are a cruel reminder that this island will no longer be the peaceful haven it once was.  ");
        ...
        this.outx("Squirming roots are crawling over the boat's underside.  They dig into every crease and crevice, binding the vessel tightly in place.  Just as you start to ponder swimming for the shore, the boat shifts, ");
        if (this.player.spe < 50) this.outx("dropping you flat on your ass");
        else
            this.outx("nearly dropping you flat on your ass before you catch yourself and sit down");
        this.outx(
        ...
        // (Left Like a Bitch)
            ...
            this.outx("Well, look who came back!  I thought you were too afraid of a good time to come up here and fuck around with little ol' Marae.   I was actually going to let you row away if you were too scared to come here.  No, don't even glance back now, I've changed my mind.</i>");
        }
        this.outx('"\n\n', false);

        this.outx("Featureless white irises glare at you from the goddess' lust-lidded eyes.  She commands you, \"<i>Come here.  It's time for a ");
        if (
            this.player.findPerk(PerkLib.MaraesGiftFertility) >= 0 ||
            this.player.findPerk(PerkLib.MaraesGiftStud) >= 0
        )
        ...
        // Can fly?  Choice to run
            ...
            this.outx("You don't think she's counted on your wings.  If you tried to fly you could probably get out of the reach of her tentacles in short order.");
            this.simpleChoices(
                "Stay",
                this.MaraeIIStageII,
                "",
    ...
    private MaraeIIStageII(): void {
        ...
        if (this.player.gender == 2) {
            ...
            this.outx(", you don't manage a single backwards step before the warm bulge is rubbing ");
            ...
            this.outx("  Both are dripping and giving tiny squirts of sweet pleasure that simultaneously dull the mind and reinforce your worship of this sexually-charged deity.\n\n");

            this.outx("Marae grunts and pulls on ");
            if (this.player.horns > 0) this.outx("your horns");
            else this.outx(`your ${this.hairDescript()}`);
            this.outx(", shoving her thick clit-cock deep inside your throat.  You reflexively swallow down the bulging fuck-meat and ");
        ...
        // Marae uses a tree-tentacle to 'milk' male PC's.  Oral or Vajayjay? Not sure.
            ...
            this.outx("You grunt and pump your hips, shameless as you give in to the squeezing, textured tentacle");
            ...
            this.outx(", but it's quickly devoured by Marae's tree-based tentacle-beast without a sound.  ");
            if (this.player.cumQ() > 500) {
                this.outx("The thick bulges of spooge actually distort the vines");
                if (this.player.cockTotal() > 1) this.outx("s");
                this.outx(", letting you get the barest glimpse of white through the over-stretched tentacle-tube");
                if (this.player.cockTotal() > 1) this.outx("s");
                this.outx(".  ");
            }
            this.outx(
        ...
        // [Hermz]  Marae grows vinecawks for DP under her flowercunt and sexes.
            ...
            this.outx("The goop from inside you never seems to end, and you pump Marae's belly up with it until she looks a little pregnant.  ");
            if (this.player.cumQ() < 500)
                this.outx("The orgasm is so much more massive than normal, and you wonder if her magic enhanced it.  ");
            if (this.player.cumQ() > 1000)
                this.outx("She's actually surprised when you keep fountaining more seed into her.  Her nipples start to squirt out the excess seed, but you keep cumming until she's squirted enough to soak herself with your jism.  ");
            this.outx("The goddess' tentacles never let up during it all, and you have a belly that matches Marae's perfectly.\n\n");

            this.outx("You slide out and slump over, utterly exhausted by the breeding session.  The goddess pulls her tentacles from your abused openings, marveling at the outflow of plant-spunk while you relax and pass out.  You feel her fold your hands around your belly to cradle the pregnant bulge, and then you're snoring contentedly.\n\n");
        }
        // ONWARD TO NUMBER 3
    ...
    private MaraePt2RoundIIIPrizes(): void {
        ...
        if (this.player.gender == 1) {
            ...
            if (this.player.findPerk(PerkLib.MaraesGiftStud) >= 0)
                this.outx("Well, I see my gift is working out quite well for you, isn't it?  That's excellent.  It was an incomplete gift given by an incomplete goddess, but now that I've gotten my hands on you again, I was able to fix it.  You'll build up cum three times as fast as before, no more waiting for days just to build up a huge load for all the horny girls out there!</i>\"  ");
            // (NON STUD)
            else
                this.outx("You might be a little sore.  I did some work to make sure you'll be a perfect breeding stud for me.  No tiny cum-shots for you!  You'll squirt out enough to knock up anyone, and I even touched up your seed so it'll get through most contraceptives.  Aren't I the nicest?</i>\"  ");
            // (CONTINUED)
            this.outx("Her speech is broken by pauses for her to lick up the goo and swallow it, but still perfectly intelligible.  The entire time she was speaking, you were trapped in orgasm, milked by her tree with unthinking intensity.\n\n");
        ...
        // [HERMS]
            ...
            if (
                ...
                this.outx("The entire time she was speaking, you were trapped in orgasm, milked by her tree with unthinking intensity.\n\n");
            ...
            // (HAZ STUD)
                ...
                this.outx("I can't believe I didn't think of this last time!  I made you such a great stud that I didn't think to make you just as good at popping out your own kids!  Well I went ahead and fixed that while you were sleeping.  Your womb is nice and fertile, and you'll pop out kids a LOT quicker than before.  We'll be repopulating everything in Mareth in no time!  Just be sure to knock up the girls and let the boys fuck your pussy, okay?</i>\"  ");
    ...
    private MaraeIIFlyAway(): void {
        this.spriteSelect(40);
        this.outx("", true);
        this.outx("You launch into the air and beat your wings, taking to the skies.  The tentacle-tree lashes at you, but comes up short.  You've escaped!  Something large whooshes by, and you glance up to see your boat sailing past you.  She must have hurled it at you!  It lands with a splash near the mooring, somehow surviving the impact.  You dive down and drag it back to the dock before you return to camp.  That was close!");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
}
