...
export class Lottie extends TelAdreAbstractContent {
    ...
    private fuckElleInsteadOfThatFatSlutFirstTime(): void {
        ...
        if (this.player.cockTotal() > 1) {
            ...
            else this.outx("s throb, spilling out their essence along the floor and onto Lottie.");
        }
        this.outx(
    ...
    public lottieRepeatWalkies(): void {
        ...
        else this.outx("Heyyy, do I shmell bacon?  I fucking love bacon!  BACON BACON BACON!");
        this.outx(
