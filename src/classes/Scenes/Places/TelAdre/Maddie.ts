...
export class Maddie extends TelAdreAbstractContent {
    ...
    public procMaddieOneIntro(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00240] == 0) {
            ...
            this.outx(" you. It releases your shoulder and starts walking towards an 'employees only' door.  Do you follow?\n\n");
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00240] = 1;
        }
        // (REPEAT)
        else {
            this.outx("You walk into the bakery and a burly, hair-covered arm grabs your shoulder.  The familiar voice of a minotaur barks, \"<i>You.  You can help.  Come.</i>\"  You turn, but he's already walking towards an 'employees only' door.  Do you follow?");
        }
    ...
    private followMinotaurIntoBackroom(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00241] == 0) {
            ...
            this.outx("You get a chance to look over his work station, noting the many bowls of batter, hundreds of massive eclairs, and the largest onahole you've ever seen.  ");
            if (this.player.findPerk(PerkLib.MinotaurCumAddict) >= 0)
                this.outx("You lick your lips when you realize you're meeting the source of the 'special' éclairs.");
            else
                this.outx("You blush when you realize what he must be using for cream filling.");
            // [Give Them] [Leave]
            if (
    ...
    private sneakAwayFromMaddie(): void {
        this.outx("", true);
        this.outx("You get out before he can find you again.  Whatever he's making is nothing you ever want to taste.");
        // (No more mino chef)
    ...
    private talkToMaddie(): void {
        ...
        if (this.player.hasCock())
            this.outx("is like, all out of icing mix!  So I'm going to borrow a few cups from you, 'kay?");
        else
            this.outx("gave me so much icing mix, and you like, would look soooo much better with some vanil- van... yummy frosting!");
        ...
        if (this.player.hasCock()) {
            ...
            this.outx(", running a sponge-soft hand over the love-muscle.  You rock your hips, trying to squirm away.  Maddie laughs, breathily chortling while her well-rounded breasts slide to either side of you and pin you to the wall.\n\n");
            ...
            if (this.player.cor < 33)
                this.outx("You muster as much authority as you can in such a compromising position and explain to Maddie that what comes out of there is NOT icing.");
            ...
            if (this.player.cockTotal() == 1)
                ...
                this.outx(" while her skin absorbs the generous donation of your other member");
                if (this.player.cockTotal() > 2) this.outx("s");
                this.outx(".");
            }
            this.outx("  When the jizz-guzzling pastry-girl pulls back at last to free your empty member, it's coated from top to bottom in gooey blue jelly, though it's tinged white in places.  The milked-out member slowly softens");
            if (this.player.cockTotal() > 1) {
                if (this.player.cockTotal() == 2) this.outx(" along with your other penis");
                else this.outx(" along with your other dicks");
            }
            this.outx(".  Satisfied, your body goes limp and sags against the wall while your face leans on the cupcake-girl's departing breast.\n\n");
        ...
        // (FEMALE/Genderpoots)
            ...
            if (this.player.thickness < 60) this.outx(", you're looking awful thin");
                ...
                this.outx(", you look like you're carved from stone.  A little softness would do you good");
            else
                this.outx(", you look like you'd better eat to keep up your gorgeous figure");
            this.outx(".  Mmm, don't let it like, spill or nothing!  I'm making this icing special and yummy so you'll feel super good and stop struggling an' stuff.</i>\"  Her voice is as candy-sweet as the milk you're guzzling.  The sound of messy slurps and noisy, gulping swallows fills the air of the small back room.\n\n");

            this.outx("The weighty breast and its spongy nipple retreat, popping from your questing lips.  You whine weakly in disappointment at the sudden disappearance of your treat, licking and smearing the white cream over your already icing-smeared mouth.  Maddie grabs her other tit with a two handed grip and struggles with the wobbling mass while she aims her unused nipple your way.  The areola heaves, bulging out like an overfilled balloon.  The nipple wiggles in place from the pressure, stretching out around the sides until it looks ready to rupture.  Creamy confection beads at the tip, slowly forming a fat, sticky drop that hangs down and threatens to fall to the floor.  Before it falls, the nipple pulses one last time and opens up a flow of icing.  It's like watching a dam burst – awe-inspiring for the first few seconds until the torrent of fluid begins to drown you.\n\n");

            this.outx("You rock back as the gushing stream impacts your solar plexus, splattering the frosty white stuff into a spray of rain.  Goop rains and explodes all around, and Maddie just giggles and moans while she guides the flow over every inch of your form, drenching you in sugary sweetness.  You swallow nearly as much as you spit and sputter.  After a few moments you just kind of open wide and sigh, hoping she'll hold it in your mouth and hit you with enough force to pump it into your gurgling gut.\n\n");
