...
export class Maddie extends TelAdreAbstractContent {
    ...
    private followMinotaurIntoBackroom(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00241] == 0) {
            ...
            else this.outx("You blush when you realize what he must be using for cream filling.");
            // [Give Them] [Leave]
            if (
    ...
    private talkToMaddie(): void {
        ...
        // (FEMALE/Genderpoots)
            ...
            else this.outx(", you look like you'd better eat to keep up your gorgeous figure");
            this.outx(
