...
export class Scylla extends TelAdreAbstractContent {
    ...
    public talkToScylla(): void {
        ...
        if (!this.player.hasCock() || this.player.longestCockLength() < 12) {
            if (this.flags[kFLAGS.SCYLLA_SMALLCOCK_INTRO] == 0) {
                ...
                this.outx("The nun has apparently given up on coffee and instead sit in silent prayer, her eyes closed to the temptations around her. You give an introduction another attempt, but she remains oblivious. Rude.\n\n");
            }
        ...
        this.outx("She's clearly addicted to semen, and if you don't help her she'll probably disappear with someone else forever.  Then again - whatever has tainted her might have an effect on you.  Do you help her quench her thirst?");
    ...
    public scyllaRoundII(): void {
        ...
        this.outx("Despite the tone of the letter, it's clear she wrote it hours ago. Now, her chest bounces with every shallow breath, the seams at her thighs are tearing from how quickly she rubs her legs together, and the drool from her gagged mouth drips steadily into a little, warm stream that pools in her cleavage. She tries to speak, but the bone ring turns her soft, nervous voice into wanton gurgles. Her pudgy lips struggle to form words, but all they manage are needy, sucking motions. On the verge of frustrated tears, she lays her head against your chest and wraps her fingers around yours, clenching your hand.\n\n");
    ...
    private scyllaRoundIIPartII(): void {
        ...
        this.outx("... something's wrong. Still on the verge of cumming, you find yourself unable to. With shaking hands, you pull Scylla's bloated lips apart and remember the gag her horns made around her mouth. You realize that while it was easy entry to the back of her throat earlier, now that your dick is swollen to bursting, the horns are acting as a cock-ring, keeping you from cumming.  ");
        if (this.player.hasKnot(0))
            this.outx("Frustrated, you try to pull back, but your bloated knot is far too large for her tight mouth, keeping the two of you hooked together.  ");
        else
            this.outx("Trying to pull the ring off, you find that your swollen head is too full to pull back through her esophagus and out of her stomach.  ");
    ...
    public scyllaRoundThreeCUM(): void {
        ...
        if (this.player.hasKeyItem("Opal Ring") < 0 || this.flags[kFLAGS.FED_SCYLLA_TODAY] == 1) {
            ...
            this.outx("After seeing that display, you've got a few questions for her. What would you like to discuss?");
        ...
        // Special for cum pumps
            ...
            this.outx("You step into the Wet Bitch and step up to the bar, taking a moment to relax and unwind.  After enjoying yourself for a while, you glance around and notice that Scylla, your ever-thirsty nun is nowhere to be found.  Deciding to go look for her, you head upstairs and toward the maiden's regular lodgings.  She appears to be at home, but unaware that her door is ajar, giving you a chance to look in on her.\r\r");

            this.outx("Scylla is inside, daintily smoothing the wrinkles from her too-tight velvet black habit.  Her belly is swollen almost to bursting and she absently strokes it with one hand while her other wipes a slimy glob of cum from the side of her mouth with an alabaster pinkie.  She slides the finger into her mouth and sucks it hard enough to bring a blush to her cheeks, sighing in savory delight.  In her other hand, she's clutching a massive, freshly emptied candy-colored condom that glistens as though licked clean.  As you're about to knock on the door and greet her, you hear a loud growling sound and your instincts drop you to a wary crouch, looking for the creature that must've snuck through Tel'Adre's gates.  A gurgle and rumble follow and you realize that it's Scylla's tummy that's making those monstrous noises.  Before your eyes, her stomach quivers and pulses, flesh roiling and twitching violently under the apparently elastic robe.  Then, with a deep draining slurp, her belly contracts, sinking inward until it is flat and smooth.  It seems the nun just digested a few gallons of cum in a matter of seconds.\r\r");
            this.outx(
    ...
    private scyllaIIIBellyChat(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx("Off-handedly, you ask how her thirst has been. She seemed to be, ahem, retaining a lot of fluid when you last left her, but now...\n\n");
        ...
        this.outx("The nun shakes her head. \"<i>But it hasn't been the same lately. The thirst comes back almost immediately. I can't keep it in my body long enough before digestion kicks in.</i>\"\n\n");

        this.outx("You look at her closer and you think you can guess where all the extra protein has been going lately.  Her always lustrous hair is practically alive, sparkling twinkles of light reflecting off her long, jet curls. Her skin looks even softer than before, flush and creamy with an ageless smoothness. A thin but sturdy layer of muscle has taken definition under her buxom flesh, making her back straighter and her lean arms more graceful.\n\n");

        this.outx("Knowing you're unlikely to discover any more on that topic, you turn the subject to her breathing...");
    ...
    private scyllaPtVFirstTime(): void {
        ...
        this.outx("You spot Scylla across the common room of the Wet Bitch, but she seems preoccupied. The nun is fetching a tray of assorted drinks and shots from the bar, which strikes you as strange since you haven't seen her order anything here that wasn't drowned in milk and cream. You slink back into the crowd and keep a curious eye on her. After marshalling the drinks, she hefts the tray and very carefully takes it upstairs.  She bumps one of the doors open with her plump butt and walks inside, before giving the door another rump bump to close it.  You quickly creep forward and hook a finger into the frame, keeping the door open an inch.\n\n");

        this.outx("Peering through the crack, you see the nun place the drinks on a modest table and take a seat, folding her hands neatly under her gargantuan chest with a prim, little smile. Joining her around the table are two other women, of considerably smaller stature. One, a goblin girl, slouches in her chair with one leg hung over an armrest, propping her head on her palm as she picks at her teeth with a small wooden stick. Her expression is one of intense boredom and she regards her hostess with a contemptuous glance before she grabs a mug of ale and chugs it. She's dressed modestly for a goblin, in oiled leather plates that conceal most of her green skin. She has no helm, however, to cover her bright red, braided hair or her tiny, pug nose. There's no sign of the usual assortment of potions and drugs most goblins seem to carry.\n\n");

        this.outx("You almost don't notice the third girl until what you'd assumed to be a very finely crafted salt shaker moves across the table. It's a fairy, robed in crystal that sparkles on her pale skin like morning dew. Her movements, however, are leaden, her gossamer wings drag limply behind her. She stumbles to a shot glass, and with one hand rubbing her temple, she leans down to takes a drink from a glass larger than her head. She groans and plops down, rubbing her eyes regretfully.\n\n");

        this.outx("Scylla's soft enthusiasm seems unfazed by her companions' dour attitudes. She takes a creamy liquor and sips it before starting. \"<i>I'm so very glad everyone could make it today. I am excited to begin, but perhaps it would be best to do some introductions? If it's all right with everyone, I will go first.  My name is Scylla and I am a nun in the service of the gods. I grew up very far away, but I live in Tel'Adre now, between my missionary expeditions.</i>\" She nods at the fairy and smiles so wide that she actually squeaks.\n\n");

        this.outx("The fairy shakes her head slowly and rubs a spot between her eyes. \"<i>Not so loud. My name's... ugh... Pastie. I'm from the forest and I really need to be sleeping off this hangover,</i>\" she mutters, her voice thin and high, like wind across reeds.\n\n");

        this.outx("Scylla turns her gaze to the goblin, who snorts and begins chewing on her toothpick. \"<i>What's it matter what my name is, I'm always just gonna be one of 'Tamani's daughters,' the dumb slut.</i>\" Her small, pointed nose makes the goblin's voice nasally and her habit of talking through sharp teeth gives her a coarse accent.\n\n");

        this.outx("The nun puts a hand over her bulbous lips. \"<i>Oh dear, please don't speak of your mother that way! I am sure she loves you very much. We care deeply about you here; this is a safe place.  Won't you please share your name with the group?</i>\" She leans forward, her eyelids fluttering hopefully.\n\n");

        this.outx("\"<i>Bleh, enough with tha 'sisterhood' crap,</i>\" the goblin responds, waving a hand dismissively in front of Scylla's face. \"<i>Fine, ya fat tub, I'm Abylon. But call me Abby or I'm outta here.</i>\" She kicks the air with her suspended leg and grabs another beer.");
    ...
    private scyllaPtVRepeat(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx("Scylla's at the bar, filling up another large tray of drinks. Judging by how many she's got, you assume she's giving the addiction counseling meeting another shot. The nun is murmuring to herself, possibly rehearsing a sermon or maybe just working up the strength to be the pillar the other girls need. She heads upstairs and you ponder what to do as you watch her go. Will you join them?\n\n");
        // [Share][Take Advantage][Leave]
        this.simpleChoices(
            "Share",
            this.scyllaPtVShare,
    ...
    private scyllaPtVTakeAdvantage(): void {
        ...
        if (this.player.balls > 0) {
            ...
            this.outx("\"<i>Like fuck yer goin' first,</i>\" Abby shoots back, her grip on your base so painful now that you hiss through your teeth. The goblin grabs a beer bottle and smashes it on the table, brandishing it at Scylla. \"<i>Go ahead, cunt, put those bimbo cock-sucking lips on my baby-daddy's dick. See what happens.</i>\" The jagged glass is perilously close to your shaft, and you don't dare to move while the two have a tug of war with your junk. Maybe this wasn't the best idea you've ever had.\n\n");
            this.outx(
                `Pastie finally figures out what's going on through her stupor and flies between the three of you, settling atop your ${this.cockDescript(
                    x
                )}, tiny stiletto heels digging into soft flesh like pins. "<i>Don't fight, you two, this thing's gross,</i>" she argues. Pouting, she stomps her foot down and the heel punches into your cockhead, drawing a scream from you that only makes Scylla and Abby tug all the harder.\n\n`,
    ...
    private scyllaPtVNoDiscussion(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx("You fail to come up with a suitable explanation for your presence and politely excuse yourself.  AWKWARD!");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private scyllaPtVMilkV(): void {
        ...
        this.outx("Feeling pretty pleased with yourself, you add a skip to your step, belly jiggling all the way back to camp.");
        // [Corruption Down]
        this.dynStats("lus", -1);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private scyllaPtVSexIV(): void {
        ...
        this.outx("When the four of you are ready to leave, Scylla gives you a big hug and thanks you for coming. Pastie, barely able to keep her overinflated form aloft, gives you a drunk kiss on the nose before slowly flying away. Even Abby gives you a friendly smack on the ass, rubbing her own tender rump gingerly. While your travels have guaranteed you'll always - and frequently - need a release, you don't think you're as much a slave to it as you used to be.");
        // [Libido Down]
        this.dynStats("lib", -1);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private addictionScyllaTakeAdvantageDicksBonusAndEpilogue(): void {
        ...
        if (select == 6) {
            ...
            if (this.player.balls > 0)
                ...
                this.outx("An unfamiliar tingling starts at the base of your shaft and rushes to your tip in another second, sending cold chills through your frame. You can feel the bulbous protrusions of your infernal fuck-pole rippling inside Scylla's esophagus as she clenches down, muscles like a fist tightening on your prick. It almost feels like she's squeezing your flesh to its twitching core, milking your creamy center. The bumpy protrusions deforming the nun's neck flatten and deflate before your eyes and a spine-twisting rapture erupts from the tip of your cock. It's all you can do to grip the girl's curling horns to brace yourself from falling over. A sensation of teeth-clenching pleasure erupts from your abdomen like no orgasm you've ever experienced, making you rock back on your heels and slam the nun's face against your groin. Scylla's expression shifts from mindless joy to suffocating ecstasy , her eyes rolling up in her head, body vibrating with a rolling orgasm, tiny hacking gasps escaping her throat as your climax pours hot, liquid relief into her belly.\n\n");
    ...
    private Scylla6NoMilkGetHelp(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx("You fill your lungs and scream for help as loudly as you can. The cats around Scylla hiss and leap to their feet, trying to find you, cursing. A tall, black-furred girl tries to flee down the alleyway, but the damage is done. The clattering rush of the city guard surrounds the group from both directions and the cats find themselves trapped. A few try to bolt between the guards, but a well-placed centaur kick knocks one into an unconscious slump and the others quail from the guards in a scared huddle.\n\n");
    ...
    private Scylla6NoMilkSubmitIII(): void {
        ...
        if (this.player.balls > 0) {
            ...
            this.outx("Your spot in the middle of the nun-and-cat sandwich is too much, however, and your thighs slap against Scylla's face with each thrust the cat-morph makes. She must be able to feel the cum churning in your groin because her throat milks your shaft, her tongue and lips coaxing your swollen pecker as her stomach sucks on your head like a fertile womb, hungry for your seed to the point of hysteria. You finally cum and your body clenches down, muscles tight as your strength deserts you. Your body is putty as the blobs of cum are forced past the suckling lips tightly wrapped against your groin and up the nun's gulping throat, fighting past the intense pressure of her neck. When they get up into her chest, you can feel the bulbs of spunk rushing toward your cockhead with urgent desire and Scylla's stomach rumbles in anticipation. Just as the first dollop bursts free, the herm behind you slaps your ass and gives you one last thrust before cumming herself. Her balloon of flesh flares lewdly and hot jizz pours into your body, painting your womb white with the kitty's dog-seed. The sensation is invigorating and you feel renewed strength as you buck against Scylla's face, fucking her stomach with your cock, even as it squirts its first load into her suspended body. You flex your vaginal walls as best you can, ass clenching, milking the black cat for every drop as she collapses against your back, breast slick with sweat and weakly panting as the orgasm takes its toll, her soft balls straining to make the most of what feels like a long-delayed fucking.\n\n");
            // HORSE COCK –
            if (this.player.cocks[0].cockType == CockTypesEnum.HORSE)
