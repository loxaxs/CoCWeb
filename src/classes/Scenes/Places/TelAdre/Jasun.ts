...
export class Jasun extends TelAdreAbstractContent {
    ...
    private meetJasun(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00179] == 0) {
            ...
            if (this.player.gender <= 1) {
                ...
                this.outx("You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.");
        ...
        // Met Jasun but not boned!
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00181] == 0) {
                this.outx("While you look around the changing room, one of the gym's other patron asks you if you're looking for Jasun.  Seeing your confusion, they describe the hunky shark guy you met before.  You nod and smile, happy to have learned his name.\n\n");
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00181]++;
            }
            // If you're a dude.
            if (this.player.gender <= 1) {
                this.outx("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
                this.outx(
        ...
        // Repeat
            ...
            if (this.player.gender <= 1) {
                ...
                this.outx("You doubt he'd have the nerve to murder someone here, but it's clear that so long as you lack a vagina Jasun will have no interest in you.  What a waste.");
                this.doNext(this.camp.returnToCampUseOneHour);
                return;
            }
            // IF YOU FAIL TO MEET ANY OF HIS CRITERIA NOW
    ...
    private jasunSecks(): void {
        ...
        // Repeat
            ...
            this.outx("When you wake back up, you find that your bikini is next to you and that everything else seems to be fine. You put your bikini back on and look around, unable to see Jasun anywhere. You walk toward the gym's exit and reminisce of your experience today, ready for whatever your next escapade will bring.");
        }
