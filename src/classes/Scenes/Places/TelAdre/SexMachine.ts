    ...
    private useTheSexMachine(): void {
        ...
        // [If you decide to mess with the machine, female:]
            ...
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_FEMALE] == 0) {
                ...
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
                        `  It slips a fourth cock between your [chest], using two arms to press them together and fuck your tits as well, splashing a burst of mysterious cum on your face with every thrust.`,
                    );
                this.outx("\n\n");
            ...
            // [Female repeat scene]
                ...
                this.outx(
                    `The cool air makes your nipples stand out, and you notice a pleasant surprise: the cocks slipping between your ass-cheeks and thighs are made of a soft, but firm, latex.  They warm as they leak cum on your [asshole] and labia. You blush, willingly opening your mouth for the cock in front of you.  Sucking it in to taste the heady seed, you close your eyes, enjoying the ride as your labia softly part, wet and ready for the intruding member.\n\n`,
                    false,
                );

                this.outx(
                    `You moan lustfully as the members slip into your [vagina] and [asshole], filling you deeply.`,
                );
                this.player.cuntChange(30, true, true, false);
                this.player.buttChange(30, true, true, false);
        ...
        // [Sexless]
            ...
            // [Sexless Repeat]
                ...
                this.outx(
                    `You shrug it off, slipping, as directed, into the various straps and buckles to secure yourself to the machine, and once more it lifts you into the air. You feel a firm pressure against your [asshole] once again, teasing you with a surprise: you feel a flexible latex head probing your asscheeks, leaking cum all over them!\n\n`,
                    false,
                );
        ...
        // [Hermaphrodite]
            ...
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_HERM] == 0) {
                ...
                this.player.buttChange(30, true, true, false);
                this.outx(
                    `  You moan lustfully, your girly juices beginning to flow down your thighs as the cock begins to thrust deep inside of you.  The metallic sleeve on your member thrusts down around you, even as the machine penetrates your [vagina]. It's almost as if you were fucking your own cunt!\n\n`,
                    false,
                );
                ...
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
                        `  Well, not every part of you, but that is rapidly fixed as a final cock rubs against your [chest], starting to stimulate your chest as well.`,
                    );
                this.outx("\n\n");
