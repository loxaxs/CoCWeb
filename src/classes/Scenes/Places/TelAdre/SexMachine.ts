...
export class SexMachine extends TelAdreAbstractContent {
    ...
    private leaveShowers(): void {
        this.outx("", true);
        this.outx("You shake your head.  You've had enough of a workout for the day, and you remember you're in a land where curiosity almost certainly kills (well, more thoroughly rapes) the cat.  You leave the room and continue to search for the showers, eventually finding them and heading back to camp.");
    ...
    private useTheSexMachine(): void {
        ...
        if (this.player.gender == 1) {
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_MALE] == 0) {
                ...
                this.outx("Shaking your head as the machine forcibly pleasures you, you quickly realize that with each drop of cum your cock has drained from it, the phallus against your anus gets a little more moist. It's using your own pre-cum to lube your asshole!\n\n");

                this.outx("It doesn't take long for the phallus to slip past your anal ring, filling your anus with firm strokes while you let out muffled moans.");
                ...
                this.outx("The phallus in your anus begins to rub firmly against your prostate, as if it was locating it and locking onto it. Within moments you cry out in orgasmic pleasure, ");
            ...
            // [Male repeat scene]
                ...
                this.outx("You get a sly smirk on your face. If you're going to get a full body workout, you need to work out -every- muscle in your body, and there's only one machine that can do that.\n\n");

                this.outx("Walking down the back halls of the gym, it doesn't take you long to find the back room with the odd machine once more, looking much as it did prior. The room is silent and empty, the machine sitting with its screen turned off until once again, you sit on the padded bench, and the screen flickers to life. It displays your measurements as if it can somehow tell who you are, and asks you in a very polite manner to place your limbs into the safety straps.\n\n");
        ...
        // [If you decide to mess with the machine, female:]
            ...
            // [Female repeat scene]
                ...
                if (this.player.biggestTitSize() >= 2)
                    this.outx(", and it doesn't take long for the machine to slip a cock between your breasts as well, starting to tit fuck you as it rotates you in your restraints to optimize your position");
                else
                    this.outx(" while the machine rotates you in place to optimized your positioning.");
                this.outx(".\n\n");

                this.outx("You moan with your legs lifted high above your head, leaving you surprised as to how flexible you truly are; the positioning of your legs forces your ass and vagina to clamp down on the members, making you feel every ridge and nub as they piston in and out of your wet fuck holes. Once more, the cock in your mouth cums first, pumping globs of hot semen down your throat, filling your stomach while you begin to climax, panting and gasping for air even as you swallow all you can. The latex pricks fucking your other holes bounce you as your girlcum runs down your thighs, and shortly after they cum deep inside you, pumping you full of their mysterious seed.\n\n");

                this.outx("You pant as you are let down onto the padded bench, rubbing your swollen stomach while cum leaks out of both of your holes. You smile from the afterglow of your climax, truly exhausted, and <b>really</b> needing that shower now.\n\n");
            }
        ...
        // [Sexless]
            ...
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_EUNUCH] == 0) {
                ...
                this.outx("You gasp with each bounce, your ass finally lubed enough that each gentle jostle forces you to sink another half-inch down on the thick phallic member. With a groan you finally bottom out, your anus stretched around the thick member.  ");
                this.player.buttChange(30, true, false, true);
                this.outx("The machine forces you forwards, onto your hands and knees, the thick cock beginning to slip in and out of your ass, pounding away with fervor to the sound of your exhausted moans. Each thrust seems to get closer and closer to a pleasurable spot, as if homing in on it slowly.\n\n");

                this.outx("It doesn't take long for every thrust of the thick metal cock to ram that pleasant spot, pushing you closer and closer to your climax. You close your eyes as they roll back in your head, moaning loudly as you orgasm, the cock erupting inside of you, filling your rectum with thick spurts of cum.\n\n");

                this.outx("Slowly, the machine pulls out of your asshole, releasing the straps and leaving you unceremoniously on the padded bench, facedown with your gaped anus hanging the air, leaking cum.\n\n");

                this.outx("After you collect yourself and your gear, you quietly slip out of the room, the machine quiet and inactive now. However, you can't help but feel like you were being watched...");
            }
            // [Sexless Repeat]
            else {
                this.outx("You walk down the halls after your brisk workout, once more headed for that quiet back room with that wonderful piece of exercise equipment. You smile as you slip in the door, looking around a moment to make sure you're alone in the room.\n\n");

                this.outx("You casually strip yourself naked, saving the machine the effort, and sit on the padded bench. It whirrs to life, blinking a few statistics on the screen, including what seems to be measurements of your rectum and anus. Why would it need those?\n\n");
                ...
                this.outx("You turn your head, look back, and gasp. You expected to see a latex cock molesting your backdoor, but instead see a latex tentacle brushing cum against your anus. What is this machine planning to do?!\n\n");
        ...
        // [Hermaphrodite]
            ...
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_HERM] == 0) {
                ...
                this.outx("It's almost impossible to stay focused on any one stimulation at once, your mind flowing effortlessly between your asshole as the cock lubes it up, your cock as it's milked slowly, your throat as it's slowly fucked by another cock, and your pussy as it grows wet, slowly allowing inch after inch of the invading phallus to penetrate your walls and stretch you wide open.");
                this.player.cuntChange(30, true, true, false);
                this.player.buttChange(30, true, true, false);
                this.outx(
                ...
                this.outx("You moan around the cock in your mouth, tasting the heady and thick cum it gives you, letting it trickle down the back of your throat slowly as it bucks in your mouth, leaving you helpless to call for help as every part of you is fucked.");
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
                ...
                this.outx("It doesn't take long, the pressure on your prostate from the cock in your ass, your dick being stroked and milked, and your cunt being fucked pushes you over the edge. The sudden outlet of sexual fluids is impressive. Your ass, throat, and cunt are all filled with cum at the same time.");
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
                        `  The cock on your chest pumps cum onto your ${this.chestDesc()}, as y`
                    );
                else this.outx("  Y");
                this.outx("our cock is milked of all its cum by the tube that was gently slipped into the tip of it when you were too lost in your own lusts to notice. You pant as the device gently sets you down onto the padded bench, the screen seeming to save some varied information about you.\n\n");
                ...
                this.outx("She snatches the keg from the stand in front of you, and without another word, disappears once more into the locked back room. You stare, blinking in confusion, deciding perhaps it's best you finally get that shower you wanted in the first place.");
            }
            // [Hermaphrodite repeat scene]
            else {
                this.outx("You wipe yourself off with a towel after your extended workout, stretching languidly as you walk down the hallway towards the showers. You stop short, pausing, wondering if perhaps your workout isn't truly over yet. You smirk and turn down the hall, going away from the showers towards the back rooms for one last good session.\n\n");
